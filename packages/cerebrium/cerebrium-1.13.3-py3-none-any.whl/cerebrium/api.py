...
def upload_cortex_files(
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with zipfile.ZipFile(zip_path, "w") as zip_file:
            ...
            if requirements:
                utils.requirements_to_file(requirements, os.path.join(temp_dir, "requirements.txt"))
                zip_file.write(os.path.join(temp_dir, "requirements.txt"), arcname="requirements.txt")
            if pkglist:
                utils.requirements_to_file(pkglist, os.path.join(temp_dir, "pkglist.txt"))
                zip_file.write(os.path.join(temp_dir, "pkglist.txt"), arcname="pkglist.txt")
            if conda_pkglist:
                utils.requirements_to_file(conda_pkglist, os.path.join(temp_dir, "conda_pkglist.txt"))
                zip_file.write(os.path.join(temp_dir, "conda_pkglist.txt"), arcname="conda_pkglist.txt")
