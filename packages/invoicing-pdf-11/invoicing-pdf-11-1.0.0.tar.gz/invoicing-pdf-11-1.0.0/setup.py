...
setup(
    name='invoicing-pdf-11',  # * Your package will have this name
    packages=['invoicing'],  # * Name the package again
    version='1.0.0',  # * To be increased every time your change
    # your library
    ...
    author='Dipesh Sah',  # Your name
    author_email='tranquil3477@gmail.com',  # Your email
    url='https://example.com',
    # Homepage of your library (e.g. GitHub or your website)
    keywords=['invoice', 'excel', 'pdf'],  # Keywords users can search on
    # pypi.org
