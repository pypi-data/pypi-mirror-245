...
from ...models.put_item_procedure_item_id_process_attributes_put_response_put_item_procedure_item_id_processattributes_put import (
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/Procedure/{item_id}/ProcessAttributes/".format(client.base_url, item_id=item_id)
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = (
            PutItemProcedureItemIdProcessAttributesPutResponsePutItemProcedureItemIdProcessattributesPut.from_dict(
                response.json()
            )
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, HTTPValidationError, PutItemProcedureItemIdProcessAttributesPutResponsePutItemProcedureItemIdProcessattributesPut]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PutItemProcedureItemIdProcessAttributesPutResponsePutItemProcedureItemIdProcessattributesPut]
    """
