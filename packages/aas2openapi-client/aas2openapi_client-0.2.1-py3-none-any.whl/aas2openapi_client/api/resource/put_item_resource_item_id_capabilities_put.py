...
from ...models.put_item_resource_item_id_capabilities_put_response_put_item_resource_item_id_capabilities_put import (
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    Union[Any, HTTPValidationError, PutItemResourceItemIdCapabilitiesPutResponsePutItemResourceItemIdCapabilitiesPut]
]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PutItemResourceItemIdCapabilitiesPutResponsePutItemResourceItemIdCapabilitiesPut.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, HTTPValidationError, PutItemResourceItemIdCapabilitiesPutResponsePutItemResourceItemIdCapabilitiesPut]]
    """
