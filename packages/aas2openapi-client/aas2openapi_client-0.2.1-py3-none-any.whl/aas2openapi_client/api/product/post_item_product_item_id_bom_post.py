...
from ...models.post_item_product_item_id_bom_post_response_post_item_product_item_id_bom_post import (
...
) -> Optional[Union[Any, HTTPValidationError, PostItemProductItemIdBOMPostResponsePostItemProductItemIdBomPost]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostItemProductItemIdBOMPostResponsePostItemProductItemIdBomPost.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, PostItemProductItemIdBOMPostResponsePostItemProductItemIdBomPost]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PostItemProductItemIdBOMPostResponsePostItemProductItemIdBomPost]
    """
