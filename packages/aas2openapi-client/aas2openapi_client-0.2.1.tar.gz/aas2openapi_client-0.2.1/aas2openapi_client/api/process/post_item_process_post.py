...
from ...models.post_item_process_post_response_post_item_process_post import (
...
def _get_kwargs(
    *,
    ...
    url = "{}/Process/".format(client.base_url)
...
) -> Optional[Union[Any, HTTPValidationError, PostItemProcessPostResponsePostItemProcessPost]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostItemProcessPostResponsePostItemProcessPost.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, PostItemProcessPostResponsePostItemProcessPost]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PostItemProcessPostResponsePostItemProcessPost]
    """
