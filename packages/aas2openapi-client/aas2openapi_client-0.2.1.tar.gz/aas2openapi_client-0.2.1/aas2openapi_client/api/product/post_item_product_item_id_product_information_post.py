...
from ...models.post_item_product_item_id_product_information_post_response_post_item_product_item_id_productinformation_post import (
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = (
            PostItemProductItemIdProductInformationPostResponsePostItemProductItemIdProductinformationPost.from_dict(
                response.json()
            )
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, HTTPValidationError, PostItemProductItemIdProductInformationPostResponsePostItemProductItemIdProductinformationPost]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PostItemProductItemIdProductInformationPostResponsePostItemProductItemIdProductinformationPost]
    """
