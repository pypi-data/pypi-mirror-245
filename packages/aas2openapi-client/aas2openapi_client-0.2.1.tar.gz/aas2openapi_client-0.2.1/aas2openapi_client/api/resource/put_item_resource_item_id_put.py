...
from ...models.put_item_resource_item_id_put_response_put_item_resource_item_id_put import (
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/Resource/{item_id}".format(client.base_url, item_id=item_id)
...
) -> Optional[Union[Any, HTTPValidationError, PutItemResourceItemIdPutResponsePutItemResourceItemIdPut]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PutItemResourceItemIdPutResponsePutItemResourceItemIdPut.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, PutItemResourceItemIdPutResponsePutItemResourceItemIdPut]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PutItemResourceItemIdPutResponsePutItemResourceItemIdPut]
    """
