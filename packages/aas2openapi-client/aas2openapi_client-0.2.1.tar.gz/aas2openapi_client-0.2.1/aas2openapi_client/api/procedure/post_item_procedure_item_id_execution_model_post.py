...
from ...models.post_item_procedure_item_id_execution_model_post_response_post_item_procedure_item_id_executionmodel_post import (
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = (
            PostItemProcedureItemIdExecutionModelPostResponsePostItemProcedureItemIdExecutionmodelPost.from_dict(
                response.json()
            )
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[Any, HTTPValidationError, PostItemProcedureItemIdExecutionModelPostResponsePostItemProcedureItemIdExecutionmodelPost]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PostItemProcedureItemIdExecutionModelPostResponsePostItemProcedureItemIdExecutionmodelPost]
    """
