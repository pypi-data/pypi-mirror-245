...
from ...models.post_item_procedure_post_response_post_item_procedure_post import (
...
def _get_kwargs(
    *,
    ...
    url = "{}/Procedure/".format(client.base_url)
...
) -> Optional[Union[Any, HTTPValidationError, PostItemProcedurePostResponsePostItemProcedurePost]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PostItemProcedurePostResponsePostItemProcedurePost.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, PostItemProcedurePostResponsePostItemProcedurePost]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, PostItemProcedurePostResponsePostItemProcedurePost]
    """
