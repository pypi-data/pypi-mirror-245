...
from automation_test_no_submodules import rest
from automation_test_no_submodules.api_response import ApiResponse, AsyncApiResponse
from automation_test_no_submodules.rest import AsyncResponseWrapper, ResponseWrapper
from automation_test_no_submodules.configuration import Configuration
from automation_test_no_submodules.exceptions import ApiTypeError, ApiValueError, MissingRequiredParametersError
from automation_test_no_submodules.request_after_hook import request_after_hook
from automation_test_no_submodules.request_before_url_hook import request_before_url_hook
from automation_test_no_submodules.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'Konfig/1.0.2/python'
