...
def insert_from_csv(file_name: str, table: str, delimiter=',', header=True, columns: Collection[str] = None, encoding='utf-8'):
    """
...
def insert_from_json(file_name: str, table: str, encoding='utf-8'):
    """
    ...
    if isinstance(data, dict):
        ...
        return batch_insert(table, data)
    else:
        logger.info("Exec func 'sqlexec.%s' \n\t Table: '%s' insert 0 rows." % ('insert_from_json', table ))
        return 0
