...
class TableExec:
    ...
    def insert_from_csv(self, file_name: str, delimiter=',', header=True, columns: Tuple[str] = None, encoding='utf-8'):
        ...
        """
        return self.executor.insert_from_csv(file_name, self.table, delimiter, header, columns, encoding=encoding)
    ...
    def insert_from_json(self, file_name: str, encoding='utf-8'):
        ...
        """
        return self.executor.insert_from_json(file_name, self.table, encoding=encoding)
