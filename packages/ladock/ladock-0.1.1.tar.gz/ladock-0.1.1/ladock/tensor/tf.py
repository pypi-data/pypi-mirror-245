...
def save_log(output_dir, basename, execution_time, mode, activity, columns_to_remove,
             ...
             ephocs, optimizer, X_features, csv_file, dense_units):
    ...
    with open(log_output_path, 'w') as log_file:
        ...
        log_file.write(f'File data input: {csv_file}\n')
...
def generate_model(df, output_dir, lismode, act_log, act_plot, transformX, transformY, scalerX, scalerY, ephocs, dense_units, batch_size, columns_to_remove, all_features, activity, model_dir_name, csv_file):
    modes = lismode.split(', ')
    basename = model_dir_name
        ...
        try:
            ...
            if df.empty:
                ...
                if X_features.empty:
                    ...
                    save_log(output_dir, basename, execution_time, mode, activity, columns_to_remove,
                             act_log, act_plot, transformX, transformY, scalerX, scalerY,
                             X_test, X_train, r2_test, mae_test, r2_train, mae_train,
                             model_output_path, output_plot_file_path, output_loss_plot_path,
                             ephocs, optimizer, X_features, csv_file, dense_units)
