...
def process_reference(receptor_pdb, reference_pdb, output_model_dir, csv_path, size_x, size_y, size_z, num_modes, exhaustiveness, cpu, mgl_directory, max_workers):    
    ...
    return pdbqt_output, x_center, y_center, z_center, size_x, size_y, size_z
...
def process_smi(smi_file, receptor_pdb, output_model_dir, csv_path, mgl_directory, max_workers):
    ...
    smi_content = [line for line in smi_content if "smiles" not in line.lower()]
...
def main():
    ...
    for model_dir in model_dirs:
        ...
        if receptor_pdb and reference_pdb:
            ...
            pdbqt_output, x_center, y_center, z_center, size_x, size_y, size_z = process_reference(receptor_pdb, reference_pdb, output_model_dir, csv_path, size_x, size_y, size_z, num_modes, exhaustiveness, cpu, mgl_directory, max_workers)
            ...
            sort_and_add_number(csv_path, "docking_score")
