...
async def post_volume_backup(req: VolumeBackupPost,
        x_auth_token=Header(None), token_pack=None):
    return await VolumeBackup(token_pack).rh_post(req.dict())
...
async def post_volume_backup_action(id: str,
        ...
        x_auth_token=Header(None), token_pack=None):
    return await VolumeBackup(token_pack).rh_post_action(id, req.dict())
...
async def put_volume_backup(id: str,
        req: VolumeBackupPut,
        x_auth_token=Header(None), token_pack=None):
    return await VolumeBackup(token_pack).rh_put(id, req.dict())
...
async def post_volume_backup_snapshot(id: str,
        ...
        x_auth_token=Header(None), token_pack=None):
    return await VolumeBackup(token_pack).rh_post_snapshot(id, req.dict())
...
async def post_instance_snapshot(req: InstanceSnapshotPost,
        x_auth_token=Header(None), token_pack=None):
    return await InstanceSnapshot(token_pack).rh_post(req.dict())
...
async def post_instance_backup(req: InstanceBackupPost,
        x_auth_token=Header(None), token_pack=None):
    return await InstanceBackup(token_pack).rh_post(req.dict())
...
async def post_instance_backup_action(id: str,
        ...
        x_auth_token=Header(None), token_pack=None):
    return await InstanceBackup(token_pack).rh_post_action(id, req.dict())
...
async def put_instance_backup(id: str,
        ...
        x_auth_token=Header(None), token_pack=None):
    return await InstanceBackup(token_pack).rh_put(id, req.dict())
