...
async def post_backup_plan(req: BackupPlanPost,
        x_auth_token=Header(None), token_pack=None):
    return await BackupPlan(token_pack).rh_post(req.dict())
...
async def post_backup_plan_action(id: str,
        req: PostAction,
        x_auth_token=Header(None), token_pack=None):
    return await BackupPlan(token_pack).rh_post_action(id, req.dict())
...
async def post_backup_plan_resource(id: str,
        ...
        x_auth_token=Header(None), token_pack=None):
    return await BackupPlan(token_pack).rh_post_res(id, req.dict())
...
async def post_snapshot_plan(req: SnapshotPlanPost,
        x_auth_token=Header(None), token_pack=None):
    return await SnapshotPlan(token_pack).rh_post(req.dict())
...
async def post_snapshot_plan_action(id: str,
        req: PostAction,
        x_auth_token=Header(None), token_pack=None):
    return await SnapshotPlan(token_pack).rh_post_action(id, req.dict())
...
async def post_snapshot_plan_resource(id: str,
        req: PlanResourcePost,
        x_auth_token=Header(None), token_pack=None):
    return await SnapshotPlan(token_pack).rh_post_res(id, req.dict())
