...
@router_monitor.post("/cluster/{id}/interface")
async def post_monitor_cluster_interface(req: Request, id: str):
    fwd_path = f"/monitor/cluster/{id}/interface"
    return await api.op_api(req, "post", "cms-monitor", fwd_path)


@router_monitor.delete("/cluster/{id}/interface/{interface_id}")
async def delete_monitor_cluster_interface(req: Request, id: str,
        interface_id: str):
    fwd_path = f"/monitor/cluster/{id}/interface/{interface_id}"
    return await api.op_api(req, "delete", "cms-monitor", fwd_path)
