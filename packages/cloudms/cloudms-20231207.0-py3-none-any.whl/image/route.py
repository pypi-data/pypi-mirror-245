...
async def post_image(req: ImagePost, x_auth_token=Header(None),
        token_pack=None):
    return await Image(token_pack).rh_post(req.dict())
...
async def post_image_action(id: str,
        req: ImageAction,
        x_auth_token=Header(None), token_pack=None):
    return await Image(token_pack).rh_post_action(id, req.dict())
...
async def put_image(id: str,
        req: ImagePut,
        x_auth_token=Header(None), token_pack=None):
    return await Image(token_pack).rh_put(id, req.dict())
