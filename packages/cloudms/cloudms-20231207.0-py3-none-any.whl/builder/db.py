...
table_map = {
    ...
    "nfs_directory": Table("nfs_directory", metadata,
        Column("id", String(36), primary_key=True),
        Column("name", String(128)),
        Column("size", Integer),
    ...
    "k8s_cluster": Table("k8s_cluster", metadata,
        ...
        Column("api_addr", String(16)),
        Column("api_addr_auto", Boolean, default=True),
        Column("ingress_addr", String(16)),
        Column("ingress_addr_auto", Boolean, default=True),
        Column("node_subnet_addr", String(20)),
        Column("pod_addr_block", String(20)),
        Column("service_addr_block", String(20)),
