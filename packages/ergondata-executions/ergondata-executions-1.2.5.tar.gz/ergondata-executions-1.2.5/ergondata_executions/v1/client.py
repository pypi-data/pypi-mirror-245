...
from ergondata_executions.controllers.auth.interfaces import AuthTaskExecRequestPayload
...
def task_execution(
    auth: AuthTaskExecRequestPayload,
    config: APIConfig
):
    ...
    def wrapper(wrapped, instance, args, kwargs):
        ...
        ergon = ErgonClient(api_client)
        ergon.create_task_execution(task_id=auth.task_id)
