...
setup(
  ...
  version = '1.2.0.0',      # Start with a small number and increase it with every change you make
  ...
  author = 'Olaoluwa Ajisola',                   # Type in your name
  author_email = 'ajisolaolaoluwa@gmail.com',      # Type in your E-Mail
