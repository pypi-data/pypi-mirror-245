...
# %% auto 0
__all__ = ['has_mps', 'devchain', 'try2dev', 'asdev', 'dtypechain', 'try2dtype', 'mpsdtype', 'to', 'ten2cpu', 'ten2mps',
           'ten2cuda', 'tenchain', 'try2ten', 'asten']
...
# %% ../nbs/07_tens.ipynb 10
#| export


# %% ../nbs/07_tens.ipynb 12
try: import torch
except ImportError: ...

# %% ../nbs/07_tens.ipynb 14
try: import pytorch_lightning as pl
except ImportError: ...

# %% ../nbs/07_tens.ipynb 16
...
def to(
    ...
    memory_format: torch.memory_format = torch.preserve_format) -> Tensor: ...
@overload
def to(
