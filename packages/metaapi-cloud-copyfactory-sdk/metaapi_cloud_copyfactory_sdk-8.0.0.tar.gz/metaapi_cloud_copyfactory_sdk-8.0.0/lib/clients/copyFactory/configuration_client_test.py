...
class TestGetStrategiesWithInfiniteScrollPagination:
    """Test ConfigurationClient.get_strategies_with_infinite_scroll_pagination."""
    ...
    async def test_retrieve_strategies_from_api(self):
        ...
        strategies = await copy_factory_client.get_strategies_with_infinite_scroll_pagination(
        ...
        domain_client.request_copyfactory.assert_called_with(
            {
                ...
                'method': 'GET',
                'headers': {'auth-token': token, 'api-version': '1'},
                'params': {'includeRemoved': True, 'limit': 100, 'offset': 200},
            },
            True,
        )
    ...
    async def test_not_retrieve_strategies_with_account_token(self):
        ...
        copy_factory_client = ConfigurationClient(domain_client)
        try:
            await copy_factory_client.get_strategies_with_infinite_scroll_pagination()
            pytest.fail()
        except Exception as err:
            assert (
                err.__str__()
                == 'You can not invoke get_strategies method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )


class TestGetStrategiesWithClassicPagination:
    """Test ConfigurationClient.get_strategies_with_classic_pagination."""
    ...
    async def test_retrieve_strategies_from_api(self):
        ...
        domain_client.request_copyfactory = AsyncMock(return_value=expected)
        strategies = await copy_factory_client.get_strategies_with_classic_pagination(
            {'includeRemoved': True, 'limit': 100, 'offset': 200}
        )
        expected['items'][0]['riskLimits'][0]['startTime'] = date(expected['items'][0]['riskLimits'][0]['startTime'])
        assert strategies == expected
        domain_client.request_copyfactory.assert_called_with(
            {
                'url': '/users/current/configuration/strategies',
                'method': 'GET',
                'headers': {'auth-token': token, 'api-version': '2'},
                'params': {'includeRemoved': True, 'limit': 100, 'offset': 200},
            },
            True,
        )
    ...
    async def test_not_retrieve_strategies_with_account_token(self):
        ...
        copy_factory_client = ConfigurationClient(domain_client)
        try:
            await copy_factory_client.get_strategies_with_classic_pagination()
            pytest.fail()
        except Exception as err:
            assert (
                err.__str__()
...
class TestGetPortfolioStrategiesWithInfiniteScrollPagination:
    """Test ConfigurationClient.get_portfolio_strategies_with_infinite_scroll_pagination."""
        ...
        expected = [
            {
                ...
                'name': 'Test strategy',
                'members': [
                    {'strategyId': 'BCDE', 'riskLimits': [{'type': 'daily', 'startTime': '2020-08-24T00:00:00.000Z'}]}
                ],
                'maxTradeRisk': 0.1,
            }
        ]
        domain_client.request_copyfactory = AsyncMock(return_value=expected)
        strategies = await copy_factory_client.get_portfolio_strategies_with_infinite_scroll_pagination(
            {'includeRemoved': True, 'limit': 100, 'offset': 200}
        )
        expected[0]['members'][0]['riskLimits'][0]['startTime'] = date(
    ...
    async def test_not_retrieve_portfolio_strategies_with_account_token(self):
        ...
        copy_factory_client = ConfigurationClient(domain_client)
        try:
            await copy_factory_client.get_portfolio_strategies_with_infinite_scroll_pagination()
            pytest.fail()
        except Exception as err:
            assert (
                err.__str__() == 'You can not invoke get_portfolio_strategies method, because you have connected '
                'with account access token. Please use API access token from '
                'https://app.metaapi.cloud/token page to invoke this method.'
            )


class TestGetPortfolioStrategiesWithClassicPagination:
    """Test ConfigurationClient.get_portfolio_strategies_with_classic_pagination."""
    ...
    async def test_retrieve_portfolio_strategies(self):
            ...
            'items': [
                {
                    ...
                    'members': [
                        {
                            'strategyId': 'BCDE',
                            'riskLimits': [{'type': 'daily', 'startTime': '2020-08-24T00:00:00.000Z'}],
                        }
                    ],
                    'maxTradeRisk': 0.1,
                }
        ...
        domain_client.request_copyfactory = AsyncMock(return_value=expected)
        strategies = await copy_factory_client.get_portfolio_strategies_with_classic_pagination(
            {'includeRemoved': True, 'limit': 100, 'offset': 200}
        )
        expected['items'][0]['members'][0]['riskLimits'][0]['startTime'] = date(
            expected['items'][0]['members'][0]['riskLimits'][0]['startTime']
        )
        assert strategies == expected
        domain_client.request_copyfactory.assert_called_with(
            {
    ...
    async def test_not_retrieve_portfolio_strategies_with_account_token(self):
        ...
        copy_factory_client = ConfigurationClient(domain_client)
        try:
            await copy_factory_client.get_portfolio_strategies_with_classic_pagination()
            pytest.fail()
        except Exception as err:
            assert (
                err.__str__() == 'You can not invoke get_portfolio_strategies method, because you have connected '
...
class TestGetSubscribersWithInfiniteScrollPagination:
    @pytest.mark.asyncio
    async def test_retrieve_copyfactory_subscribers_from_api(self):
        ...
        domain_client.request_copyfactory = AsyncMock(return_value=expected)
        accounts = await copy_factory_client.get_subscribers_with_infinite_scroll_pagination(
            {'includeRemoved': True, 'limit': 100, 'offset': 200}
        )
    ...
    async def test_not_retrieve_copyfactory_subscribers_with_account_token(self):
        ...
        copy_factory_client = ConfigurationClient(domain_client)
        try:
            await copy_factory_client.get_subscribers_with_infinite_scroll_pagination()
            pytest.fail()
        except Exception as err:
            assert (
                err.__str__()
                == 'You can not invoke get_subscribers method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )


class TestGetSubscribersWithClassicPagination:
    @pytest.mark.asyncio
    async def test_retrieve_copyfactory_subscribers_from_api(self):
        """Should retrieve CopyFactory subscribers from API."""
        expected = {
        ...
        domain_client.request_copyfactory = AsyncMock(return_value=expected)
        accounts = await copy_factory_client.get_subscribers_with_classic_pagination(
            {'includeRemoved': True, 'limit': 100, 'offset': 200}
        )
        assert accounts == expected
        domain_client.request_copyfactory.assert_called_with(
    ...
    async def test_not_retrieve_copyfactory_subscribers_with_account_token(self):
        ...
        copy_factory_client = ConfigurationClient(domain_client)
        try:
            await copy_factory_client.get_subscribers_with_classic_pagination()
            pytest.fail()
        except Exception as err:
            assert (
                err.__str__()
...
class TestConfigurationClient:
    ...
    async def test_not_generate_strategy_id_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__()
                == 'You can not invoke generate_strategy_id method, because you have connected '
                + 'with account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_retrieve_strategy_from_api(self):
        ...
        domain_client.request_copyfactory.assert_called_with(
            {'url': '/users/current/configuration/strategies/ABCD', 'method': 'GET', 'headers': {'auth-token': token}}
        )
    ...
    async def test_not_retrieve_strategy_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__()
                == 'You can not invoke get_strategy method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_not_update_strategy_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__()
                == 'You can not invoke update_strategy method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_not_remove_strategy_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__()
                == 'You can not invoke remove_strategy method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_retrieve_portfolio_strategy(self):
        ...
        expected['members'][0]['riskLimits'][0]['startTime'] = date(
    ...
    async def test_not_retrieve_portfolio_strategy_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__() == 'You can not invoke get_portfolio_strategy method, because you have connected '
                'with account access token. Please use API access token from '
                'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_update_portfolio_strategy(self):
        ...
        strategy = {'name': 'Test strategy', 'members': [{'strategyId': 'BCDE'}], 'maxTradeRisk': 0.1}
    ...
    async def test_not_update_portfolio_strategy_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__() == 'You can not invoke update_portfolio_strategy method, because you have connected '
                'with account access token. Please use API access token from '
                'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_not_remove_portfolio_strategy_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__() == 'You can not invoke remove_portfolio_strategy method, because you have '
    ...
    async def test_not_remove_portfolio_strategy_member_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__() == 'You can not invoke remove_portfolio_strategy_member method, because you have '
                'connected with account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_not_retrieve_copyfactory_subscriber_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__()
                == 'You can not invoke get_subscriber method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_not_update_copyfactory_subscriber_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__()
                == 'You can not invoke update_subscriber method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_not_remove_copyfactory_subscriber_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__()
                == 'You can not invoke remove_subscriber method, because you have connected with '
                + 'account access token. Please use API access token from '
                + 'https://app.metaapi.cloud/token page to invoke this method.'
            )
    ...
    async def test_remove_copyfactory_subscription(self):
        ...
        payload = {'mode': 'preserve', 'removeAfter': date('2020-08-24T00:00:01.000Z')}
        subscriber_id = 'e8867baa-5ec2-45ae-9930-4d5cea18d0d6'
        await copy_factory_client.remove_subscription(subscriber_id, 'ABCD', payload)
        domain_client.request_copyfactory.assert_called_with(
            {
                'url': f'/users/current/configuration/subscribers/{subscriber_id}/subscriptions/ABCD',
                'method': 'DELETE',
                'headers': {'auth-token': token},
                'body': payload,
            }
    ...
    async def test_not_remove_copyfactory_subscription_with_account_token(self):
        ...
        try:
            ...
            assert (
                err.__str__() == 'You can not invoke remove_subscription method, because you have connected '
                'with account access token. Please use API access token from '
                'https://app.metaapi.cloud/token page to invoke this method.'
            )
