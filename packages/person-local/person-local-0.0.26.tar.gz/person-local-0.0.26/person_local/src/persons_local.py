...
class PersonsLocal(GenericCRUD):
    ...
    def insert(self, person: Person) -> int:
        ...
        x_coordinate, y_coordinate = float(
            person.last_coordinate[0]), float(person.last_coordinate[1])
        query = (
    ...
    def update_birthday_date(person_id: int, birthday_date: datetime.date) -> None:
        ...
        PersonsLocal().update_by_id(id_column_value=person_id, data_json=person_json)
        logger.end()
    ...
    def update_first_name_by_profile_id(profile_id: int, first_name: str) -> None:
        ...
        PersonsLocal().update_by_id(id_column_value=profile_id, data_json=person_json)
        logger.end()
