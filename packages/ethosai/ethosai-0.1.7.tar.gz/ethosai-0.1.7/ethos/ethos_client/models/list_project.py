...
class ListProject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListProject:
        """Create an instance of ListProject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListProject:
        """Create an instance of ListProject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListProject.parse_obj(obj)

        _obj = ListProject.parse_obj({
