...
class ListPhase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListPhase:
        """Create an instance of ListPhase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListPhase:
        """Create an instance of ListPhase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListPhase.parse_obj(obj)

        _obj = ListPhase.parse_obj({
