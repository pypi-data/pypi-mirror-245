...
class ListTask(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTask:
        """Create an instance of ListTask from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTask:
        """Create an instance of ListTask from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTask.parse_obj(obj)

        _obj = ListTask.parse_obj({
