...
import ethos.ethos_client.models
from ethos.ethos_client import rest
from ethos.ethos_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ethos.ethos_client.models, klass)
