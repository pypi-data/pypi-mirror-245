...
class Team(BaseModel):
    ...
    __properties = ["object", "id", "org", "name", "type", "users"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('system_managed', 'user_managed'):
            raise ValueError("must be one of enum values ('system_managed', 'user_managed')")
        return value
