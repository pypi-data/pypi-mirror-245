...
class ResourceCreate(BaseModel):
    ...
    related_id: Optional[Any] = Field(...)
    value: Optional[ResourceJsonDoc] = None
    resource_blob_links: Optional[Any] = None
    dataset_schema: Optional[DatasetSchemaCreate] = None
    __properties = ["name", "type", "version_tags", "tags", "meta", "related_id", "value", "resource_blob_links", "dataset_schema"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.related_id is None and "related_id" in self.__fields_set__:
            _dict['related_id'] = None
