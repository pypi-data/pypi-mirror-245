...
if __name__ == "__main__":
    setup(
        ...
        # Do not uncomment above line. I remove the line to include package_data, which are bot_configs.
        # It is unintuitive, and looks like a setuptools bug. The symptom is show_available_bots() will
        # fail, and it is hard to detect manually. See:
