...
from tool.file import file_tools
from tool.weixin.token.wx_token_models import WeixinTokenInfo
...
def get_access_token(app_id: str, app_secret: str) -> str:
    """获取token"""
    access_token_file = os.path.join(os.path.dirname(__file__), f'wx_{app_id}_access_token.bin')
