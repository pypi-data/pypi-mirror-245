from tool.aliyun_pan.aliyun_pan_tools import get_user_info, get_ali_api, get_share_info_by_link, \
    get_share_file_list, get_file_info, list_file, list_path
...
def share_url_demo():
    ...
    file_list = get_share_file_list(ali_api, share_id)
    for tmp_file in file_list:
        # 打印文件信息
        # 文件id，如：'63b8e37d08f61f64808b4dfdba2c1119ed140464'
        print(tmp_file.file_id)
