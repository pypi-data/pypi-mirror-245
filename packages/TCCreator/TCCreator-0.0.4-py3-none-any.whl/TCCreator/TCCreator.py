...
class TestingCaseCreator():
    ...
    @staticmethod
    def Creator(acrf_path, meta_path,out_path):
        try:
            file_path_CRF = acrf_path
            file_path_metadata = meta_path

            annotedcrf_path=file_path_CRF
            metadata_path=file_path_metadata
            # Debug_path = out_path + "output.txt"
            Debug_path = os.path.join(out_path, "output.txt")
            # acrf=pdfplumber.open(annotedcrf_path)
            # annotedcrf_path="C:/Users/YueXu/Downloads/BUPI-ISL-1003_AnnotatedCRF_5.0.4.1_20231102 (1).pdf"
            # metadata_path="C:/Users/YueXu/Downloads/BUPI-ISL-1003_Metadata_5.0.4.1_20231102 (1).xlsx"
            acrf=pdfplumber.open(annotedcrf_path)
