...
def _parser_callback(args: argparse.Namespace) -> None:
    ...
    """
    print("Warning: the clear-policies command is deprecated. Use policies clear instead.")
...
def clear_policies(
    ...
    """
    policies_clear(
        api_endpoint, storage_path, api_token, username, password, timeout, project_id, organization_id, debug
    )
