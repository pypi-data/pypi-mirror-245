...
def _parser_callback(args: argparse.Namespace) -> None:
    ...
    """
    print("Warning: the set-config command is deprecated. Use config set instead.")
...
def set_config(
    ...
    """
    config_set(api_endpoint, storage_path, api_token, username, password, timeout, organization_id, config_path, debug)
