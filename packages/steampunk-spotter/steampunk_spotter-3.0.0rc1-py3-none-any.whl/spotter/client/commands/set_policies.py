...
def _parser_callback(args: argparse.Namespace) -> None:
    ...
    """
    print("Warning: the set-policies command is deprecated. Use policies set instead.")
...
def include_policies(
    ...
    """
    policies_set(
        api_endpoint, storage_path, api_token, username, password, timeout, project_id, organization_id, path, debug
    )
