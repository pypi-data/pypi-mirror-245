...
def _parser_callback(args: argparse.Namespace) -> None:
    ...
    """
    print("Warning: the clear-config command is deprecated. Use config clear instead.")
...
def clear_config(
    ...
    """
    config_clear(api_endpoint, storage_path, api_token, username, password, timeout, organization_id, debug)
