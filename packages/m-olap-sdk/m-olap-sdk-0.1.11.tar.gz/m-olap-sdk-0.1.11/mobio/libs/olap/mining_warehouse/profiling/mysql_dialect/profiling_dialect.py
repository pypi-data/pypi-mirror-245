...
if __name__ == "__main__":
    a = ProfilingDialect(olap_uri='mobio://profile_user:p123@192.168.5.130:9030/default_catalog.profiling').get_profile_by_criteria(merchant_id="1b99bdcf-d582-4f49-9715-1b61dfff3924", profile_id="7c836313-b6c5-4b87-af86-6e53dfe02302", lst_criteria=["cri_merchant_id", "cri_profile_id", "cri_name", "cri_customer_id", "cri_operation"])
    print(a)
