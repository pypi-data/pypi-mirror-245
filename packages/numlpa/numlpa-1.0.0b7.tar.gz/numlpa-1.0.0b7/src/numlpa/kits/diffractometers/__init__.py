...
by a single screw or edge dislocation is given in the dislocation
reference framerespectively by: [2]_

.. math::

   \\mathbf{u}_{\\text{screw}} = \\left( \\begin{array}{c}
   0 \\\\
   0 \\\\
...
.. math::
   ...
   \\mathbf{u}_{\\text{edge}} = \\left( \\begin{array}{c}
