        ...
        for btn in msg_btns:
            try:
                ...
                if btn['knd'] == 'payment':
                    ...
                    btn_html = f'<a id="btn-{btn["knd"]}-{btn["i"]}-{str(len(data_push))}" class="button" data-url="{invoice_link}">{btn_cnt_click} {btn["lbl"]}ᵖ</a>'
                    ...
                    btn_html = f'<a id="btn-{btn["knd"]}-{btn["i"]}-{str(len(data_push))}" class="button" data-url="{btn["lnk"]}">{btn_cnt_click} {btn["lbl"]}ᴸ</a>'
                    row_html = f"{row_html}{btn_html}"
