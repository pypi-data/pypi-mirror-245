...
class PARAM_ITEMS:
    ...
    PARAMETERS: ParamItem = ParamItem("parameters", "Parameters")
...
EMAIL_CORRECTION: list[tuple[tuple[str], str]] = [
    (("gmail.ru", "email.ru", "gmail", "gmail/com", "gmail/ru"), "gmail.com"),
    (("mail.com", "mail.ruu", "mail", "mail/ru", "mail/com"), "mail.ru"),
    (("icloud.ru", "icloud/ru", "icloud/com"), "icloud.com"),
    (("yndex.ru", "yandex/ru"), "yandex.ru"),
]
...
class JournalType(Enum):
    COMPUTER: tuple[int, ParamItem] = (auto(), ParamItem("computer", "Компьютер"))
    ...
    SERVER_ROOM: tuple[int, ParamItem] = (
        auto(),
        ParamItem("server_room", "Коммутационная комната"),
    )
    ...
    PRINTER: tuple[int, ParamItem] = (auto(), ParamItem("printer", "Принтер"))


class Tag(Enum):
    SERVICE: tuple[int, str, str] = (auto(), "Обслуживание", CONST.VISUAL.GOOD)
    ERROR: tuple[int, str, str] = (auto(), "Ошибка", CONST.VISUAL.ERROR)
    WARNING: tuple[int, str, str] = (auto(), "Внимание", CONST.VISUAL.WARNING)
