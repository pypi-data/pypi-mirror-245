...
class PresentationLibrary(object):
    ...
    def CreatePresentationFile(self, fileName: "std::string const &", author: "std::string const &", description: "std::string const &", buildNumber: "int const", narrationProjects: "std::vector< PresentationFile::NarrationProject,std::allocator< PresentationFile::NarrationProject > > const &", supplementaryFiles: "std::vector< PresentationFile::SupplementaryFile,std::allocator< PresentationFile::SupplementaryFile > > const &", presentationOrder: "std::vector< PresentationFile::PresentationItemType,std::allocator< PresentationFile::PresentationItemType > > const &", narrations: "std::vector< PresentationFile::Narration,std::allocator< PresentationFile::Narration > > const &", learningModules: "std::vector< LearningModule,std::allocator< LearningModule > > const") -> "boost::filesystem::path":
    ...
    def GetFiles(self) -> "std::vector< boost::filesystem::path,std::allocator< boost::filesystem::path > >":
        return _pyglass.PresentationLibrary_GetFiles(self)
