...
DEMOSAIC_OPENCV_STANDARD = _libcaer_wrap.DEMOSAIC_OPENCV_STANDARD

DEMOSAIC_OPENCV_EDGE_AWARE = _libcaer_wrap.DEMOSAIC_OPENCV_EDGE_AWARE

DEMOSAIC_OPENCV_TO_GRAY = _libcaer_wrap.DEMOSAIC_OPENCV_TO_GRAY

CONTRAST_STANDARD = _libcaer_wrap.CONTRAST_STANDARD

CONTRAST_OPENCV_NORMALIZATION = _libcaer_wrap.CONTRAST_OPENCV_NORMALIZATION

CONTRAST_OPENCV_HISTOGRAM_EQUALIZATION = _libcaer_wrap.CONTRAST_OPENCV_HISTOGRAM_EQUALIZATION

CONTRAST_OPENCV_CLAHE = _libcaer_wrap.CONTRAST_OPENCV_CLAHE
...
def caerDeviceDiscover(deviceType, discoveredDevices):
    r"""caerDeviceDiscover(int16_t deviceType, caerDeviceDiscoveryResult * discoveredDevices) -> int64_t"""
...
DVX_DVS_CHIP_DTAG_CONTROL = _libcaer_wrap.DVX_DVS_CHIP_DTAG_CONTROL
...
DVX_DVS_CHIP_DTAG_CONTROL_STOP = _libcaer_wrap.DVX_DVS_CHIP_DTAG_CONTROL_STOP

DVX_DVS_CHIP_DTAG_CONTROL_START = _libcaer_wrap.DVX_DVS_CHIP_DTAG_CONTROL_START

DVX_DVS_CHIP_DTAG_CONTROL_RESTART = _libcaer_wrap.DVX_DVS_CHIP_DTAG_CONTROL_RESTART
...
def caerFilterDVSNoiseGetHotPixels(noiseFilter, hotPixels):
    r"""caerFilterDVSNoiseGetHotPixels(caerFilterDVSNoise noiseFilter, caerFilterDVSPixel * hotPixels) -> int64_t"""
...
def get_polarity_event_color_filter(x, y):
    r"""get_polarity_event_color_filter(int64_t x, int64_t y) -> int64_t"""
    return _libcaer_wrap.get_polarity_event_color_filter(x, y)

def get_color_and_filtered_polarity_event(event_packet, event_vec):
    r"""get_color_and_filtered_polarity_event(caer_polarity_event_packet event_packet, int64_t * event_vec)"""
    return _libcaer_wrap.get_color_and_filtered_polarity_event(event_packet, event_vec)

def get_color_polarity_event(event_packet, event_vec):
    r"""get_color_polarity_event(caer_polarity_event_packet event_packet, int64_t * event_vec)"""
    return _libcaer_wrap.get_color_polarity_event(event_packet, event_vec)
