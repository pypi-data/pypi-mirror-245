"""
Forbes Kernel. Operates on representations including bit vectors e.g. Morgan/ECFP6 fingerprints count vectors e.g.
...
class ForbesKernel(Kernel):
    r"""
     Computes a covariance matrix based on the Forbes kernel
    ...
    def __init__(self, **kwargs):
        super(ForbesKernel, self).__init__(**kwargs)
