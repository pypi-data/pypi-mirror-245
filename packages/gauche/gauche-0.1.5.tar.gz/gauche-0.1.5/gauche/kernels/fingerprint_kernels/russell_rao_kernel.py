"""
Russell-Rao Kernel. Operates on representations including bit vectors e.g. Morgan/ECFP6 fingerprints count vectors e.g.
...
class RussellRaoKernel(Kernel):
    r"""
     Computes a covariance matrix based on the Russell and Rao kernel
    ...
    def __init__(self, **kwargs):
        super(RussellRaoKernel, self).__init__(**kwargs)
    ...
    def covar_dist(
        ...
        **params,
        ...
        return batch_russell_rao_sim(x1, x2)
