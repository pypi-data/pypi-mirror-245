    ...
    data = [
        {
            ...
            'gnb_cu_ue_f1ap_id': item['gnb_cu_ue_f1ap_id'],
            'gnb_cu_cp_ue_e1ap_id': item['gnb_cu_cp_ue_e1ap_id'],
            'gnb_cu_up_ue_e1ap_id': item['gnb_cu_up_ue_e1ap_id'],
            'ran_ue_ngap_id': item['ran_ue_ngap_id'],
            'amf_ue_ngap_id': item['amf_ue_ngap_id'],
            'xnap_src_ran_id': item['xnap_src_ran_id'],
            'xnap_trgt_ran_id': item['xnap_trgt_ran_id'],
            'pci': item['pci'],
            'f1ap_cause': item['f1ap_cause'],
            'ngap_cause': item['ngap_cause'],
        }
