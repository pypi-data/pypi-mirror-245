...
class InternalDAIVersionResource(ModelNormal):
    ...
    def _from_openapi_data(cls, image, *args, **kwargs):  # noqa: E501
        """InternalDAIVersionResource - a model defined in OpenAPI

        Args:
            image (str): Name of the Docker image used when using this DAIVersion.
        ...
        Keyword Args:
            ...
            version (str): Version identifier. For example \"1.10.1.2\".. [optional]  # noqa: E501
            ...
            image_pull_secrets ([str]): List of references to k8s secrets that can be used for pulling an image of this DAIVersion from a private container image registry or repository.. [optional]  # noqa: E501
            gpu_resource_name (str): K8s GPU resource name. For example: `nvidia.com/gpu` or `amd.com/gpu`. When unset, server will choose a default value.. [optional]  # noqa: E501
            data_directory_storage_class (str): Name of the storage class used by Driverless AI when using this DAIVersion. When unset, the default storage class of the k8s cluster will be used.. [optional]  # noqa: E501
