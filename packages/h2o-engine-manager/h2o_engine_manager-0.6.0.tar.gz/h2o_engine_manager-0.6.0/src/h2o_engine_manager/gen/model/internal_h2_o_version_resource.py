...
class InternalH2OVersionResource(ModelNormal):
    ...
    def _from_openapi_data(cls, image, *args, **kwargs):  # noqa: E501
        """InternalH2OVersionResource - a model defined in OpenAPI

        Args:
            image (str): Name of the Docker image used when using this H2OVersion.
        ...
        Keyword Args:
            ...
            version (str): Version identifier. For example \"3.42.0.3\".. [optional]  # noqa: E501
            ...
            image_pull_secrets ([str]): List of references to k8s secrets that can be used for pulling an image of this H2OVersion from a private container image registry or repository.. [optional]  # noqa: E501
