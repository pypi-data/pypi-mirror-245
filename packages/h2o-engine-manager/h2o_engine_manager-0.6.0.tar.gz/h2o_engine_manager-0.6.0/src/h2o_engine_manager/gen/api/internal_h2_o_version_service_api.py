    ...
    def internal_h2_o_version_service_update_internal_h2_o_version(
        ...
        **kwargs
        ...
        Args:
            ...
            update_mask (str): The list of paths referencing which fields to update. Update mask must be non-empty.  Allowed field paths are: {version, aliases, deprecated, image, image_pull_policy, image_pull_secrets, gpu_resource_name, annotations}.  To update all allowed fields, specify exactly one path with value \"*\".
