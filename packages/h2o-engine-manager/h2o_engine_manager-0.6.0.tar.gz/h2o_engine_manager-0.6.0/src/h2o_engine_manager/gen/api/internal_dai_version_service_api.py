...
class InternalDAIVersionServiceApi(object):
    ...
    def internal_dai_version_service_delete_internal_dai_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_dai_version_service_delete_internal_dai_version(name_3, async_req=True)
        >>> result = thread.get()

        Args:
            name_3 (str): InternalDAIVersion resource name.
    ...
    def internal_dai_version_service_get_internal_dai_version(
        ...
        **kwargs
        ...
        >>> thread = api.internal_dai_version_service_get_internal_dai_version(name_10, async_req=True)
        >>> result = thread.get()

        Args:
            name_10 (str): InternalDAIVersion resource name.
    ...
    def internal_dai_version_service_update_internal_dai_version(
        ...
        **kwargs
        ...
        Args:
            ...
            update_mask (str): The list of paths referencing which fields to update. Update mask must be non-empty.  Allowed field paths are: {aliases, deprecated, image, image_pull_policy, image_pull_secrets, gpu_resource_name, data_directory_storage_class, annotations}.  To update all allowed fields, specify exactly one path with value \"*\".
