...
def from_custom_internal_h2o_version_to_api_resource(internal_h2o_version: InternalH2OVersion) -> InternalH2OVersionResource:
    """
    ...
    return InternalH2OVersionResource(
        aliases=internal_h2o_version.aliases,
