...
class PersonOrOrganization:
    ...
    def from_jsonld(
        cls, jsonld: Json
    ) -> PersonOrOrganization | list[PersonOrOrganization] | None:
        """Builds the class from the JSON-LD."""
        if jsonld is None:
            return None
        elif isinstance(jsonld, list):
            return [PersonOrOrganization.from_jsonld(element) for element in jsonld]
        else:
            return cls(
...
class Metadata(Node):
    ...
    creator: PersonOrOrganization | list[PersonOrOrganization] | None = None
    ...
    def to_json(self) -> Json:
        ...
        return remove_empty_values({
            ...
            "name": self.name,
            "description": self.description,
            "creator": self.creator.to_json() if self.creator else None,
    ...
    def from_jsonld(
        ...
        creator = PersonOrOrganization.from_jsonld(
