...
class LuminesceCertificateManagementApi:
    ...
    @overload
    async def get_certificates(self, **kwargs) -> List[CertificateState]:  # noqa: E501
        ...

    @overload
    def get_certificates(self, async_req: Optional[bool]=True, **kwargs) -> List[CertificateState]:  # noqa: E501
        ...

    @validate_arguments
    def get_certificates(self, async_req: Optional[bool]=None, **kwargs) -> Union[List[CertificateState], Awaitable[List[CertificateState]]]:  # noqa: E501
        """[EXPERIMENTAL] GetCertificates: Shows Table and Field level information on Providers that are currently running that you have access to (in Json format)  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_certificates_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    @validate_arguments
    def get_certificates_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetCertificates: Shows Table and Field level information on Providers that are currently running that you have access to (in Json format)  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_certificates" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
