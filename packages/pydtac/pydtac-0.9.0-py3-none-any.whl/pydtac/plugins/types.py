...
class EndpointRequest:
    ...
    def __str__(self):
        return f'{self._api_endpoint_request.headers} | {self._api_endpoint_request.parameters} | {self._api_endpoint_request.body}'
...
class EndpointResponse:
    ...
    def __str__(self):
        return f'{self._api_endpoint_response.headers} | {self._api_endpoint_response.parameters} | {self._api_endpoint_response.value}'
