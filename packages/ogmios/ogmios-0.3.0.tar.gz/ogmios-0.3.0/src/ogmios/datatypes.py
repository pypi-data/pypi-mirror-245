"""This module contains user-friendly datatypes for Ogmios objects.
    ...
    server is properly formatted. However, the schema types are not conducive to Pythonic use.
    Therefore, we use intermediate datatypes for user-facing functions of this library.
