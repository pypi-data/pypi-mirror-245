...
class NextTransaction:
    ...
    def execute(
        self, full_tx: bool = False, id: Optional[Any] = None
    ) -> (None | str | dict, Optional[Any]):
        ...
        :rtype: (str | dict, Optional[Any])
        """
        self.send(full_tx, id)
        return self.receive()

    def send(self, full_tx: bool = False, id: Optional[Any] = None) -> None:
        """Send the request.
        ...
        :type id: Any
        """
        params = om.Params8(fields="all") if full_tx else None
    ...
    def receive(self) -> (str | dict, Optional[Any]):
