...
from ...models.collections_items_create_item_form_style_upload import (
    CollectionsItemsCreateItemFormStyleUpload,
)
from ...models.collections_items_create_item_new_item_request import (
...
def _get_kwargs(
    ...
    version_id: str,
    *,
    multipart_data: CollectionsItemsCreateItemFormStyleUpload,
    json_body: CollectionsItemsCreateItemNewItemRequest,
) -> Dict[str, Any]:
    json_body.to_dict()
...
def sync_detailed(
    ...
    * `multipart/form-data` is used for larger files. The item
    ...
    assumed that the datastore `pigeon+datastore://default` will
    ...
    as `https://` or `s3://`, or another Pigeon resource available
    through the URL scheme
    `pigeon://hostname/collection-id/version-id/item-id`.
    ...
    Args:
        collection_id (str):
        version_id (str):
        multipart_data (CollectionsItemsCreateItemFormStyleUpload): Creation of a new item
        json_body (CollectionsItemsCreateItemNewItemRequest):
