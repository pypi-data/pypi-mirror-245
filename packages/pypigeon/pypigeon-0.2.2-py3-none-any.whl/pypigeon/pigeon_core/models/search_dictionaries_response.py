...
T = TypeVar("T", bound="SearchDictionariesResponse")


@_attrs_define
class SearchDictionariesResponse:
    """SearchDictionariesResponse model
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Create an instance of :py:class:`SearchDictionariesResponse` from a dict"""
        from ..models.data_element import DataElement
        from ..models.pagination import Pagination
        ...
        search_dictionaries_response = cls(
            elements=elements,
            pagination=pagination,
        )

        return search_dictionaries_response
