...
def _get_kwargs(
    ...
    element_id: str,
    *,
    json_body: CollectionsDictionariesCreateNewDataElementVersionDataElement,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        item_id (str):
        element_id (str):
        json_body (CollectionsDictionariesCreateNewDataElementVersionDataElement): Pigeon Data
            Element
