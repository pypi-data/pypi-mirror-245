...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, None, ItemType] = UNSET,
    in_folder: Union[Unset, None, str] = UNSET,
    in_path: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    params["name"] = name
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, None, ItemType]):
        in_folder (Union[Unset, None, str]):
        in_path (Union[Unset, None, str]):
