...
from ...models.collections_items_copy_item_json_body import (
...
def _get_kwargs(
    ...
    version_id: str,
    *,
    json_body: CollectionsItemsCopyItemJsonBody,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    The source item must be specified as a pigeon:// URL, and the
