...
function we(n, t, e) {
  const l = n.slice();
  return l[6] = t[e].type, l[7] = t[e].description, l[8] = t[e].default, l[10] = e, l;
}
function ye(n) {
  let t, e = he(
    /*_docs*/
...
function ve(n) {
  ...
  return {
    ...
    m(m, h) {
      H(m, t, h), M(t, e), M(t, l), M(t, f), M(t, s), i.m(o, t), H(m, a, h), H(m, r, h), M(r, _), M(_, c);
    },
    p(m, h) {
      h & /*_docs*/
      1 && o !== (o = /*_default*/
...
function qe(n) {
  ...
  return {
    ...
    m(m, h) {
      H(m, t, h), M(t, e), l.m(f, e), M(e, s), M(e, i), M(t, o), c && c.m(t, null), M(t, a), r || (_ = _t(i, "click", u), r = !0);
    },
    p(m, h) {
      n = m, h & /*_docs*/
      1 && f !== (f = /*type*/
      n[6] + "") && l.p(f), h & /*show_desc*/
...
function bt(n, t, e) {
  ...
  i.matches ? o("dark") : o("light"), i.addEventListener("change", (r) => {
    console.log(r), o(r.matches ? "dark" : "light");
  });
  function o(r) {
    r === "dark" ? e(0, l = Object.entries(s).map(([_, { type: u, description: c, default: m }]) => (console.log({ type: u, description: c, _default: m }), {
      name: _,
      type: u.dark,
      description: c,
      default: m.dark
    }))) : e(0, l = Object.entries(s).map(([_, { type: u, description: c, default: m }]) => (console.log({ type: u, description: c, _default: m }), {
      name: _,
      type: u.light,
      description: c,
      default: m.light
  ...
  const a = (r) => e(1, f[r] = !f[r], f);
  return n.$$set = (r) => {
    "docs" in r && e(2, s = r.docs);
  }, n.$$.update = () => {
    n.$$.dirty & /*docs*/
    4 && e(0, l = Object.entries(s).map(([r, { type: _, description: u, default: c }]) => (console.log({ type: _, description: u, _default: c }), {
      name: r,
      type: _.dark,
      description: u,
      default: c.dark
...
function Ve(n, t = {}) {
  const e = wt(n), { stiffness: l = 0.15, damping: f = 0.8, precision: s = 0.01 } = t;
  let i, o, a, r = n, _ = n, u = 1, c = 0, m = !1;
  function h(v, F = {}) {
    _ = v;
    const q = a = {};
    return n == null || F.hard || N.stiffness >= 1 && N.damping >= 1 ? (m = !0, i = Ce(), r = v, e.set(n = _), Promise.resolve()) : (F.soft && (c = 1 / ((F.soft === !0 ? 0.5 : +F.soft) * 60), u = 0), o || (i = Ce(), m = !1, o = kt((d) => {
      if (m)
        return m = !1, o = null, !1;
      u = Math.min(u + c, 1);
      const w = {
      ...
      return i = d, r = n, e.set(n = Z), w.settled && (o = null), !w.settled;
    })), new Promise((d) => {
      o.promise.then(() => {
        q === a && d();
      });
...
function jt(n) {
  ...
  return {
    c() {
      t = qt("div"), e = j("svg"), l = j("g"), f = j("path"), s = j("path"), i = j("path"), o = j("path"), a = j("g"), r = j("path"), _ = j("path"), u = j("path"), c = j("path"), k(f, "d", "M255.926 0.754768L509.702 139.936V221.027L255.926 81.8465V0.754768Z"), k(f, "fill", "#FF7C00"), k(f, "fill-opacity", "0.4"), k(f, "class", "svelte-43sxxs"), k(s, "d", "M509.69 139.936L254.981 279.641V361.255L509.69 221.55V139.936Z"), k(s, "fill", "#FF7C00"), k(s, "class", "svelte-43sxxs"), k(i, "d", "M0.250138 139.937L254.981 279.641V361.255L0.250138 221.55V139.937Z"), k(i, "fill", "#FF7C00"), k(i, "fill-opacity", "0.4"), k(i, "class", "svelte-43sxxs"), k(o, "d", "M255.923 0.232622L0.236328 139.936V221.55L255.923 81.8469V0.232622Z"), k(o, "fill", "#FF7C00"), k(o, "class", "svelte-43sxxs"), ne(l, "transform", "translate(" + /*$top*/
      n[1][0] + "px, " + /*$top*/
      n[1][1] + "px)"), k(r, "d", "M255.926 141.5L509.702 280.681V361.773L255.926 222.592V141.5Z"), k(r, "fill", "#FF7C00"), k(r, "fill-opacity", "0.4"), k(r, "class", "svelte-43sxxs"), k(_, "d", "M509.69 280.679L254.981 420.384V501.998L509.69 362.293V280.679Z"), k(_, "fill", "#FF7C00"), k(_, "class", "svelte-43sxxs"), k(u, "d", "M0.250138 280.681L254.981 420.386V502L0.250138 362.295V280.681Z"), k(u, "fill", "#FF7C00"), k(u, "fill-opacity", "0.4"), k(u, "class", "svelte-43sxxs"), k(c, "d", "M255.923 140.977L0.236328 280.68V362.294L255.923 222.591V140.977Z"), k(c, "fill", "#FF7C00"), k(c, "class", "svelte-43sxxs"), ne(a, "transform", "translate(" + /*$bottom*/
      n[2][0] + "px, " + /*$bottom*/
      n[2][1] + "px)"), k(e, "viewBox", "-1200 -1200 3000 3000"), k(e, "fill", "none"), k(e, "xmlns", "http://www.w3.org/2000/svg"), k(e, "class", "svelte-43sxxs"), k(t, "class", "svelte-43sxxs"), Ne(
        t,
        "margin",
        /*margin*/
        n[0]
    ...
    m(m, h) {
      Ct(m, t, h), V(t, e), V(e, l), V(l, f), V(l, s), V(l, i), V(l, o), V(e, a), V(a, r), V(a, _), V(a, u), V(a, c);
    },
    p(m, [h]) {
      h & /*$top*/
...
function Ht(n) {
  ...
  return {
    c() {
      _ && _.c(), t = z(), e = T("div"), m && m.c(), l = z(), h && h.c(), f = z(), i && i.c(), o = z(), q && q.c(), a = Q(), S(e, "class", "progress-text svelte-1txqlrd"), C(
        e,
        "meta-text-center",
        /*variant*/
        n[8] === "center"
    ...
    m(d, w) {
      _ && _.m(d, w), g(d, t, w), g(d, e, w), m && m.m(e, null), O(e, l), h && h.m(e, null), g(d, f, w), ~s && v[s].m(d, w), g(d, o, w), q && q.m(d, w), g(d, a, w), r = !0;
    },
    p(d, w) {
      /*variant*/
      d[8] === "default" && /*show_eta_bar*/
      d[18] && /*show_progress*/
      d[6] === "full" ? _ ? _.p(d, w) : (_ = Ze(d), _.c(), _.m(t.parentNode, t)) : _ && (_.d(1), _ = null), c === (c = u(d)) && m ? m.p(d, w) : (m && m.d(1), m = c && c(d), m && (m.c(), m.m(e, l))), /*timer*/
      d[5] ? h ? h.p(d, w) : (h = De(d), h.c(), h.m(e, null)) : h && (h.d(1), h = null), (!r || w[0] & /*variant*/
      256) && C(
        e,
        "meta-text-center",
        /*variant*/
      ...
      let Z = s;
      s = F(d), s === Z ? ~s && v[s].p(d, w) : (i && ($e(), K(v[Z], 1, 1, () => {
        v[Z] = null;
      }), We()), ~s ? (i = v[s], i ? i.p(d, w) : (i = v[s] = N[s](d), i.c()), U(i, 1), i.m(o.parentNode, o)) : i = null), /*timer*/
      d[5] ? q && (q.d(1), q = null) : q ? q.p(d, w) : (q = He(d), q.c(), q.m(a.parentNode, a));
    },
    i(d) {
      r || (U(i), r = !0);
    },
    ...
    d(d) {
      d && (p(t), p(e), p(f), p(o), p(a)), _ && _.d(d), m && m.d(), h && h.d(), ~s && v[s].d(d), q && q.d(d);
    }
  };
}
function Ze(n) {
...
function ll(n, t, e) {
  let l, { $$slots: f = {}, $$scope: s } = t, { i18n: i } = t, { eta: o = null } = t, { queue: a = !1 } = t, { queue_position: r } = t, { queue_size: _ } = t, { status: u } = t, { scroll_to_output: c = !1 } = t, { timer: m = !0 } = t, { show_progress: h = "full" } = t, { message: N = null } = t, { progress: v = null } = t, { variant: F = "default" } = t, { loading_text: q = "Loading..." } = t, { absolute: d = !0 } = t, { translucent: w = !1 } = t, { border: Z = !1 } = t, { autoscroll: re } = t, W, x = !1, te = 0, E = 0, ae = null, de = 0, I = null, $, A = null, me = !0;
  const nt = () => {
  ...
  return n.$$set = (b) => {
    "i18n" in b && e(1, i = b.i18n), "eta" in b && e(0, o = b.eta), "queue" in b && e(21, a = b.queue), "queue_position" in b && e(2, r = b.queue_position), "queue_size" in b && e(3, _ = b.queue_size), "status" in b && e(4, u = b.status), "scroll_to_output" in b && e(22, c = b.scroll_to_output), "timer" in b && e(5, m = b.timer), "show_progress" in b && e(6, h = b.show_progress), "message" in b && e(23, N = b.message), "progress" in b && e(7, v = b.progress), "variant" in b && e(8, F = b.variant), "loading_text" in b && e(9, q = b.loading_text), "absolute" in b && e(10, d = b.absolute), "translucent" in b && e(11, w = b.translucent), "border" in b && e(12, Z = b.border), "autoscroll" in b && e(24, re = b.autoscroll), "$$scope" in b && e(28, s = b.$$scope);
  }, n.$$.update = () => {
