...
class CalendarObjectResource(DAVObject):
    ...
    def __init__(
        ...
        if data is not None:
            self.data = data
            if id:
                old_id = self.icalendar_instance.subcomponents().pop("UID", None)
                self.icalendar_instance.subcomponents().add("UID", id)
    ...
    def set_relation(
        ...
        if isinstance(other, CalendarObjectResource):
            if other.id:
                ...
                uid = other.icalendar_instance.subcomponents()["uid"]
        else:
            uid = other
            if set_reverse:
        ...
        existing_relation = self.icalendar_instance.icalendar_object().get(
            "related-to", None
        )
        existing_relations = (
            existing_relation
    ...
    def split_expanded(self):
        ...
        for ical_obj in ntz:
            ...
            obj.subcomponents = []
            if tz_:
                obj.subcomponents.append(tz_[0])
            obj.subcomponents.append(ical_obj)
    ...
    def _find_id_path(self, id=None, path=None):
        ...
        """
        i = self.icalendar_instance.icalendar_object()
