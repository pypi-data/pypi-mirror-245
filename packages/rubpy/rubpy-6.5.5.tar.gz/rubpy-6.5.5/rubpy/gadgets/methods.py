...
class Functions:
    ...
    @classmethod
    def to_metadata(cls, value: str, *args, **kwargs):
        conflict = 0
        meta_data_parts = []

        for markdown in cls.MARKDOWN_RE.finditer(value):
            span = markdown.span()
            match_group = markdown.group(0)

            if match_group.startswith('`'):
                value = value[:span[0] - conflict] + markdown.group(1) + value[span[1] - conflict:]
            ...
            elif match_group.startswith('**'):
                value = value[:span[0] - conflict] + markdown.group(2) + value[span[1] - conflict:]
                meta_data_parts.append({
                    'type': 'Bold',
                    'from_index': span[0] - conflict,
            ...
            elif match_group.startswith('__'):
                value = value[:span[0] - conflict] + markdown.group(3) + value[span[1] - conflict:]
                meta_data_parts.append({
                    'type': 'Italic',
                    'from_index': span[0] - conflict,
                    'length': span[1] - span[0] - 4
                ...
                value = value[:span[0] - conflict] + markdown.group(4) + value[span[1] - conflict:]
                meta_data_parts.append({
                    'type': 'Underline',
                    'from_index': span[0] - conflict,
                    'length': span[1] - span[0] - 4
                ...
                value = value[:span[0] - conflict] + markdown.group(5) + value[span[1] - conflict:]
                meta_data_parts.append({
                    'type': 'Strike',
                    'from_index': span[0] - conflict,
                    'length': span[1] - span[0] - 4
                ...
                value = value[:span[0] - conflict] + markdown.group(6) + value[span[1] - conflict:]
                meta_data_parts.append({
                    'type': 'Spoiler',
                    'from_index': span[0] - conflict,
                    'length': span[1] - span[0] - 4
                ...
                value = value[:span[0] - conflict] + markdown.group(7) + value[span[1] - conflict:]
...
#print(Functions.to_metadata('''
#**hi** __hi__ --hi-- ~~hi~~ ||hi|| `hi` [hihihihi](URL)'''))