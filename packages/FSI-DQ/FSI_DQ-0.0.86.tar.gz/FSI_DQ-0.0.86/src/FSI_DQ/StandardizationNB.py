...
class Standardization:
    ...
    def format_issue_detection(self):
        ...
        prompt= """ For the column "{0}", extract the following information:
                ...
                Note- Do not include anything other than Json in the result.
        ...
        for column in self.columns:
            ...
            agent = create_pandas_dataframe_agent(llm, df_standard[[column]], verbose=True, max_iterations=10, early_stopping_method="generate",handle_parsing_errors="Check your output and make sure it conforms!", reduce_k_below_max_tokens=True)
            #
