...
class Standardization:
    ...
    def format_issue_detection(self):
        ...
        for column in self.columns:
            ...
            agent = create_pandas_dataframe_agent(llm, df_standard[[column]], verbose=True, max_iterations=10, early_stopping_method="generate", reduce_k_below_max_tokens=True)
