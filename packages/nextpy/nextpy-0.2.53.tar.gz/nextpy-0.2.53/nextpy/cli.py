...
@cli.command()
def install(extras: str = typer.Argument(..., help="The name of the extras group to install.")):
    """
    ...
    result = subprocess.run(["poetry", "install", "-E", extras], capture_output=True, text=True)
