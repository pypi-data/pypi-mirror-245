...
def decode_devencoded_video(raw_data: bytes) -> ImageData | None:
    ...
    return ImageData(data, frame_id=image_frame_number)


def decode_devencoded_image(raw_data: bytes) -> ImageData:
    ...
    return ImageData(data, frame_id=frame_id)
