...
class ChainDict(typing_extensions.TypedDict):
    """Chain description from a scan"""

    """List of the whole devices involved by the chain

    The first one is the top master of the chain.
    """
    devices: list[str]
...
class ScanInfoDict(typing_extensions.TypedDict):
    ...
    _display_extra: typing_extensions.NotRequired[DisplayExtraDict]
