...
def array(elements, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ArrayOp(elements=elements, loc=loc, ip=ip))
...
class StructOp(_ods_ir.OpView):
  ...
  def __init__(self, fields, names, *, loc=None, ip=None):
    ...
    issubclass(type(names), _ods_ir.Attribute) or
...
def struct(fields, names, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(StructOp(fields=fields, names=names, loc=loc, ip=ip))
...
def variable(name, value, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(VariableOp(name=name, value=value, loc=loc, ip=ip))
