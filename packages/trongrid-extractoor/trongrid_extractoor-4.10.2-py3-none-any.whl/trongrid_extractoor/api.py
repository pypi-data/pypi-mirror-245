...
class Api:
    ...
    def contract_events(
        ...
        """
        endpoint_url = build_endpoint_url(f"v1/contracts/{progress_tracker.address}/events")
    ...
    def get_all_contract_events(self, contract_address: str, event_name: Optional[str] = None) -> List[TronEvent]:
        ...
        TRC20 'Transfer's will be returned as events. Use with caution on contracts with lots of event logs.
        """
    ...
    def txn_events(self, tx_hash: str) -> List[TronEvent]:
        ...
        endpoint_url = build_endpoint_url(f"v1/transactions/{tx_hash}/events")
    ...
    def get_contract(self, address: str) -> Optional[TronContract]:
        ...
        endpoint_url = build_endpoint_url('wallet/getcontract')
    ...
    def get_account(self, address: str) -> Optional[TronAccount]:
        ...
        endpoint_url = build_endpoint_url('wallet/getaccount')
    ...
    def account_trc20_txns(self, address: str, contract_address: str) -> Iterator[Trc20Txn]:
        ...
        """
        endpoint_url = build_endpoint_url(f"v1/accounts/{address}/transactions/trc20")
    ...
    def account_txns(
        ...
        endpoint_url = build_endpoint_url(f"v1/accounts/{address}/transactions")
        params = RequestParams(endpoint_url, since, until, order_by=order_by, extra={'search_internal': search_internal})
    ...
    def txn_by_id(self, txn_id: str) -> Dict[str, Any]:
        """Get properties of single txn. Pass through to TronTxn method."""
        return TronTxn.txn_by_id(txn_id)
    ...
    def read_contract_data(
        ...
        endpoint_url = build_endpoint_url('wallet/triggerconstantcontract')
    ...
    def list_trc10_tokens(self) -> Iterator[Trc10Token]:
        ...
        endpoint_url = build_endpoint_url('v1/assets')
    ...
    def _extract_objects_from_response(
        ...
        try:
            ...
            events = [progress_tracker.build_tron_obj(row) for row in rows]

            if internal_txns:
                events += [
                    progress_tracker.build_tron_obj(row)
