...
class 以太坊:
    ...
    def 发布交易(self, 私钥, From,to, gas=None, gasPrice=None, value=None, data='', nonce=None):
        """返回交易哈希"""
        # 检查data是否为有效的16进制
        ...
        参数 = {
            ...
            'data': data or '',
            'gasPrice': int(gasPrice*100000000) if gasPrice is not None else self.web3.eth.gas_price
        }

        # 设置链ID
        参数['chainId'] = self.web3.eth.chain_id

        # 设置Gas
        参数['gas'] = 参数['gas'] if gas else self.web3.eth.estimate_gas(参数)
    ...
    def 取链上Gas价格(self) -> int:
        ...
        return self.web3.eth.gas_price / 100000000
