...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    def _request(
        ...
        if headers.get("X-Chalk-Branch-Id") and headers.get("X-Chalk-Env-Id"):
            branch_environment_id = headers.get("X-Chalk-Env-Id")
            status_url = urljoin(api_server_override or default_api_server, f"/v1/branches/{branch_environment_id}")
            r = self._raw_session_request(method="POST", headers={}, url=status_url, json=None)
