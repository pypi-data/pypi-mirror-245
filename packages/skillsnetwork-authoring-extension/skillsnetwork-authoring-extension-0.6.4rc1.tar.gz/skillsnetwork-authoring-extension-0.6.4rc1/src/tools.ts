...
export const openIndependentLab = async (awb_token: string, docManager: IDocumentManager, contentsManager: ContentsManager): Promise<NotebookPanel> => {
  ...
  await deleteEmptyFile(labFilename, contentsManager, docManager)
 ...
 * @returns {Promise<void>} - Returns nothing
 */
async function deleteEmptyFile(labFilename: string, contentsManager: ContentsManager, docManager: IDocumentManager): Promise<void> {
