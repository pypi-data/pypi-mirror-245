...
setup(
    name='enio-package',  # * Your package will have this name
    ...
    author='Enio Rodriguez',  # Your name
    author_email='enio2298@gmail.com',  # Your email
    url='https://github.com/Enio2298',  # Homepage of your library (e.g. github or your website)
