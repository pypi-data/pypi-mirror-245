...
class FileFormatConverter:
    ...
    def sample_and_label_augment2(self, image_path, json_path, image_augment_path, json_augment_path,
                                  image_file_suffix):
    ...
    def samples_augmentation2(self, input_image_folder, input_label_folder, output_image_folder,
        ...
        for filename in os.listdir(input_image_folder):
            ...
            if file_suffix.lower() in [".jpg", ".jpeg", ".png", ".gif", ".bmp"]:
    ...
    def samples_augmentation3(self, input_image_folder, input_label_folder, output_image_folder,
                              output_label_folder, image_aug_suffix, label_suffix):
        ...
        for filename in os.listdir(input_image_folder):
            ...
            if file_suffix.lower() in [".jpg", ".jpeg", ".png", "gif", ".bmp"]:
                ...
                self.sample_and_label_augment2(image_path, json_path, image_aug_path, json_aug_path,
                                               file_suffix)
...
class SampleHandler:
    ...
    def split_train_val_data_of_yolov8(all_image_path, all_label_path, dest_path, category_name, train_radio,
                                       valid_radio,
                                       test_radio):
        SampleHandler.init_yolov8_data_dir(dest_path, category_name)
    ...
    @staticmethod
    def get_all_label_of_labelme_json_files(self, json_dir_path):
        label_list = []
