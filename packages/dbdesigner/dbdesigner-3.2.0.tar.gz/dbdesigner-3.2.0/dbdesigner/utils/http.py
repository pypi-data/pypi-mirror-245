...
from dbdesigner.utils.datastructures import MultiValueDict
from dbdesigner.utils.deprecation import RemovedInDjango40Warning
from dbdesigner.utils.functional import keep_lazy_text
...
def urlquote(url, safe='/'):
    ...
    """
    warnings.warn(
        'dbdesigner.utils.http.urlquote() is deprecated in favor of '
        'urllib.parse.quote().',
...
def urlquote_plus(url, safe=''):
    ...
    """
    warnings.warn(
        'dbdesigner.utils.http.urlquote_plus() is deprecated in favor of '
...
def urlunquote(quoted_url):
    ...
    """
    warnings.warn(
        'dbdesigner.utils.http.urlunquote() is deprecated in favor of '
...
def urlunquote_plus(quoted_url):
    ...
    """
    warnings.warn(
        'dbdesigner.utils.http.urlunquote_plus() is deprecated in favor of '
...
def url_has_allowed_host_and_scheme(url, allowed_hosts, require_https=False):
    ...
    quoted incorrectly. Ensure to also use dbdesigner.utils.encoding.iri_to_uri()
...
def is_safe_url(url, allowed_hosts, require_https=False):
    warnings.warn(
        'dbdesigner.utils.http.is_safe_url() is deprecated in favor of '
