...
from dbdesigner.core.serializers.base import SerializerDoesNotExist

# Built-in serializers
BUILTIN_SERIALIZERS = {
    "xml": "dbdesigner.core.serializers.xml_serializer",
    "python": "dbdesigner.core.serializers.python",
    "json": "dbdesigner.core.serializers.json",
    "yaml": "dbdesigner.core.serializers.pyyaml",
    "jsonl": "dbdesigner.core.serializers.jsonl",
}
