...
W001 = Warning(
    "You do not have 'dbdesigner.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'dbdesigner.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
W009 = Warning(
    ...
    "dbdesigner. Please generate a long and random SECRET_KEY, otherwise many of "
...
def _security_middleware():
    return 'dbdesigner.middleware.security.SecurityMiddleware' in settings.MIDDLEWARE


def _xframe_middleware():
    return 'dbdesigner.middleware.clickjacking.XFrameOptionsMiddleware' in settings.MIDDLEWARE
