...
from dbdesigner.db.models.expressions import Func, Value
from dbdesigner.db.models.fields import DateTimeField, Field, IntegerField
...
class Lookup:
    ...
    def __init__(self, lhs, rhs):
        ...
        if bilateral_transforms:
            ...
            from dbdesigner.db.models.sql.query import Query  # avoid circular import
