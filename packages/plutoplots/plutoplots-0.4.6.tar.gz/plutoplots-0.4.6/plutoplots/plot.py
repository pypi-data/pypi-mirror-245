...
class Countplot(Plot):
    ...
    def create(self, data, x=None, y=None, c="#69b3a2", hue= None, order=None, width=0.8):
        self.axes = sns.countplot(data, x=x, y=y, width=width, color=c, hue=hue, order=order, zorder=2)
        return self
