...
class GrantClusterDefaultPrivilege(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import materialize:index/grantClusterDefaultPrivilege:GrantClusterDefaultPrivilege example GRANT DEFAULT|CLUSTER|<grantee_id>|<target_role_id>|||<privilege>
        ```
