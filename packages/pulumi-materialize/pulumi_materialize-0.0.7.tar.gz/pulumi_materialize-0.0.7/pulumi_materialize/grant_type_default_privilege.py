...
class GrantTypeDefaultPrivilege(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import materialize:index/grantTypeDefaultPrivilege:GrantTypeDefaultPrivilege example GRANT DEFAULT|TYPE|<grantee_id>|<target_role_id>|<database_id>|<schema_id>|<privilege>
        ```
