...
class GrantSecretDefaultPrivilege(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import materialize:index/grantSecretDefaultPrivilege:GrantSecretDefaultPrivilege example GRANT DEFAULT|SECRET|<grantee_id>|<target_role_id>|<database_id>|<schema_id>|<privilege>
        ```
