...
class GrantConnectionDefaultPrivilege(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import materialize:index/grantConnectionDefaultPrivilege:GrantConnectionDefaultPrivilege example GRANT DEFAULT|CONNECTION|<grantee_id>|<target_role_id>|<database_id>|<schema_id>|<privilege>
        ```
