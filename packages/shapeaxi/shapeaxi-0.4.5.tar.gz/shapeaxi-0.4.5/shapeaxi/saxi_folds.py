...
################################################################################## AGGREGATE PART #####################################################################################################
    ...
    if args.nn == "SaxiClassification" or args.nn == "SaxiRegression":
        ...
        if args.nn == "SaxiClassification":
            ...
            for f in range(0, args.folds):
                out_prediction_fold = aggregate(args, out_prediction_agg)
                out_prediction_agg.append(pd.read_csv(out_prediction_fold))
                probs_fn = out_prediction_fold.replace("_prediction.csv", "_probs.pickle")
...
################################################################################ EXPLAINABILITY PART ##############################################################################################################      
    ...
    if args.nn == "SaxiClassification" or args.nn == "SaxiRegression" or args.nn == "IcoConv":
        for f in range(0, args.folds):
