...
from ..models.canvas_initialize_webhook_v0_beta_type import CanvasInitializeWebhookV0BetaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="CanvasInitializeWebhookV0Beta")


@attr.s(auto_attribs=True, repr=False)
class CanvasInitializeWebhookV0Beta:
    """ Sent when a user initializes a canvas via trigger in the Benchling UI """

    _feature_id: str
    _resource_id: str
    _type: CanvasInitializeWebhookV0BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "CanvasInitializeWebhookV0Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> CanvasInitializeWebhookV0BetaType:
            _type = d.pop("type")
            try:
                type = CanvasInitializeWebhookV0BetaType(_type)
            except ValueError:
                type = CanvasInitializeWebhookV0BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(CanvasInitializeWebhookV0BetaType, UNSET)
        ...
        canvas_initialize_webhook_v0_beta = cls(
        ...
        return canvas_initialize_webhook_v0_beta
    ...
    @property
    def type(self) -> CanvasInitializeWebhookV0BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: CanvasInitializeWebhookV0BetaType) -> None:
        self._type = value
