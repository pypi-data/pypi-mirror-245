...
from ..models.canvas_interaction_webhook_v0_beta_type import CanvasInteractionWebhookV0BetaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="CanvasInteractionWebhookV0Beta")


@attr.s(auto_attribs=True, repr=False)
class CanvasInteractionWebhookV0Beta:
    """ Sent when a user interacts with an app canvas via button press """

    _button_id: str
    _canvas_id: str
    _type: CanvasInteractionWebhookV0BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "CanvasInteractionWebhookV0Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> CanvasInteractionWebhookV0BetaType:
            _type = d.pop("type")
            try:
                type = CanvasInteractionWebhookV0BetaType(_type)
            except ValueError:
                type = CanvasInteractionWebhookV0BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(CanvasInteractionWebhookV0BetaType, UNSET)
        ...
        canvas_interaction_webhook_v0_beta = cls(
            button_id=button_id,
            canvas_id=canvas_id,
            type=type,
        ...
        return canvas_interaction_webhook_v0_beta
    ...
    @property
    def type(self) -> CanvasInteractionWebhookV0BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: CanvasInteractionWebhookV0BetaType) -> None:
        self._type = value
