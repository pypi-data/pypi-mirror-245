...
Refer to the Terraform Registory for docs: [`data_google_dns_keys`](https://registry.terraform.io/providers/hashicorp/google-beta/5.9.0/docs/data-sources/google_dns_keys).
'''
import abc
import builtins
import datetime
...
class DataGoogleDnsKeys(
    ...
    def __init__(
        ...
        *,
        ...
        :param managed_zone: The Name of the zone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.9.0/docs/data-sources/google_dns_keys#managed_zone DataGoogleDnsKeys#managed_zone}
        :param project: The ID of the project for the Google Cloud. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.9.0/docs/data-sources/google_dns_keys#project DataGoogleDnsKeys#project}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataGoogleDnsKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.9.0/docs/data-sources/google_dns_keys#import import section} in the documentation of this resource for the id to use
