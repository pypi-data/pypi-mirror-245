...
from utils.task_processor import (
    get_task_data_paths,
...
if __name__ == "__main__":
    s = SideBySide("responsiveness-reddit-billgates-post-2/")
    s.run(
        test_name="browsertime-responsiveness-firefox-reddit-billgates-post-2",
        platform="test-windows10-64-shippable-qr",
        # base_branch="try",
        base_revision="07ff1e2e4f656661631e6746f339e6232b59ebfd",
        # new_branch="try",
        new_revision="07ff1e2e4f656661631e6746f339e6232b59ebfd"
    )
