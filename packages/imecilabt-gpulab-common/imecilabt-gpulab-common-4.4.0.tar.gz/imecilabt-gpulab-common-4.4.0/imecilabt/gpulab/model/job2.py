...
from imecilabt.gpulab.model.usage_statistics import GPULabUsageStatistics, GpuOverview, WasteReport, WasteReview
...
class JobState:
    ...
    waste_report: Optional[WasteReport] = None  # Waste report calculated by workers (legacy)
