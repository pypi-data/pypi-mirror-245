...
TEST_CPU_USAGE_STATISTICS_OBJ = ContainerUsageStatistics(
    first_time=_parse_date("2020-03-01T07:00:01Z"),
    last_time=_parse_date("2020-03-01T07:00:03Z"),
...
"containerStatistics": """+TEST_CPU_USAGE_STATISTICS_JSON+""",
"gpuStatistics": """+TEST_GPU_USAGE_STATISTICS_JSON+"""
}"""

TEST_GPULAB_USAGE_STATISTICS_OBJ = GPULabUsageStatistics(TEST_CPU_USAGE_STATISTICS_OBJ, TEST_GPU_USAGE_STATISTICS_OBJ)
