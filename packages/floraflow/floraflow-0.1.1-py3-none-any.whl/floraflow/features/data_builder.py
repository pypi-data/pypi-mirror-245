...
def create_dataset_from_directory(data_dir: str, train_size: float = 0.9, shuffle: bool = True, excluded_folder: str = 'nonsegmented') -> ImageDataWrapper:
    """
    ...
    Args:
        ...
        excluded_folder (str): Folder to exclude from the dataset. Defaults to 'nonsegmented'.
    Returns:
