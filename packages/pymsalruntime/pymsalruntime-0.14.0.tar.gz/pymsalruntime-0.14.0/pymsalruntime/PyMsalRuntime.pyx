...
IF UNAME_SYSNAME == "Windows":
    ...
    def _get_encoded_string(str input_str):
        return input_str
...
def read_account_by_id(
    ...
    encoded_accountid = _get_encoded_string(accountid)
    cdef mrt.os_char* coerced_account_id = encoded_accountid
    encoded_correlationId = _get_encoded_string(correlationId)
    cdef mrt.os_char* coerced_correlationId = encoded_correlationId
...
def signin(
    ...
    encoded_correlationId = _get_encoded_string(correlationId)
    cdef mrt.os_char* coerced_correlationId = encoded_correlationId
    encoded_accountHint = _get_encoded_string("" if not accountHint else accountHint)
    cdef mrt.os_char* coerced_accountHint = encoded_accountHint
    cdef void* coerced_callback_data_id = <void*> callback_data.id
    cdef mrt.MSALRUNTIME_ERROR_HANDLE mrt_error = NULL
    cdef MSALRuntimeAsyncHandle async_handle = MSALRuntimeAsyncHandle()
...
def signout_silently(
    ...
    encoded_correlationId = _get_encoded_string(correlationId)
    cdef mrt.os_char* coerced_correlationId = encoded_correlationId
    encoded_clientId = _get_encoded_string(clientId)
    cdef mrt.os_char* coerced_clientId = encoded_clientId
...
cdef class MSALRuntimeAuthParameters:
    ...
    def __init__(self, str clientid not None, str authority not None):
        ...
        encoded_clientid = _get_encoded_string(clientid)
        cdef mrt.os_char* coerced_clientid = encoded_clientid
        encoded_authority = _get_encoded_string(authority)
        cdef mrt.os_char* coerced_authority = encoded_authority
        cdef mrt.MSALRUNTIME_ERROR_HANDLE mrt_error = NULL
    ...
    def set_requested_scopes(self, scopes not None):
        ...
        encoded_scopes_list_string = _get_encoded_string(scopes_list_string)
        cdef mrt.os_char* coerced_scopes = encoded_scopes_list_string
        cdef mrt.MSALRUNTIME_ERROR_HANDLE mrt_error = NULL
    ...
    def set_redirect_uri(self, str redirect_uri not None):
        encoded_redirect_uri = _get_encoded_string(redirect_uri)
        cdef mrt.os_char* coerced_redirect_uri = encoded_redirect_uri
        cdef mrt.MSALRUNTIME_ERROR_HANDLE mrt_error = NULL
    ...
    def set_decoded_claims(self, str claims not None):
        encoded_claims = _get_encoded_string(claims)
        cdef mrt.os_char* coerced_claims = encoded_claims
        cdef mrt.MSALRUNTIME_ERROR_HANDLE mrt_error = NULL
    ...
    def set_access_token_to_renew(self, str access_token_to_renew not None):
        encoded_access_token_to_renew = _get_encoded_string(access_token_to_renew)
        cdef mrt.os_char* coerced_access_token_to_renew = encoded_access_token_to_renew
        cdef mrt.MSALRUNTIME_ERROR_HANDLE mrt_error = NULL
    ...
    def set_pop_params(
            ...
            str uri_path,
            str nonce):
        encoded_http_method = _get_encoded_string(http_method)
        cdef mrt.os_char* coerced_http_method = encoded_http_method
        encoded_uri_host = _get_encoded_string(uri_host)
        cdef mrt.os_char* coerced_uri_host = encoded_uri_host
        encoded_uri_path = _get_encoded_string("" if not uri_path else uri_path)
        cdef mrt.os_char* coerced_uri_path = encoded_uri_path
        encoded_nonce = _get_encoded_string("" if not nonce else nonce)
        cdef mrt.os_char* coerced_nonce = encoded_nonce
    ...
    def set_additional_parameter(self, str key not None, str value not None):
        encoded_key = _get_encoded_string(key)
        cdef mrt.os_char* coerced_key = encoded_key
        encoded_value = _get_encoded_string(value)
        cdef mrt.os_char* coerced_value = encoded_value
        cdef mrt.MSALRUNTIME_ERROR_HANDLE mrt_error = NULL
