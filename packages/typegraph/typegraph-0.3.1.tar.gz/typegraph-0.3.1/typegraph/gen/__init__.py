...
class Root:
    ...
    def __init__(self, store: wasmtime.Store) -> None:
        ...
        post_return1 = instance0["cabi_post_metatype:typegraph/utils#oauth2"]
        assert(isinstance(post_return1, wasmtime.Func))
        self._post_return1 = post_return1
        post_return2 = instance0["cabi_post_metatype:typegraph/core#get-internal-policy"]
        ...
        lift_callee3 = instance0["metatype:typegraph/core#refb"]
        ...
        lift_callee9 = instance0["metatype:typegraph/core#listb"]
