...
from common_constants import MmDetectionDatasetLiterals, MMdetModes
...
class ObjectDetectionModelWrapper(nn.Module):
    ...
    @classmethod
    def prepare_inputs_for_model_forward(cls, data, is_train=False):
    ...
    def forward(
        ...
        """
        # test mode
        inputs, batch_data_samples = ObjectDetectionModelWrapper.prepare_inputs_for_model_forward(data)
