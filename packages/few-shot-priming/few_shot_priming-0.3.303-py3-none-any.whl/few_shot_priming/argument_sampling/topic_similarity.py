...
def sort_and_filter_hashmap(test_hashmap, df_training_indices):
    ...
    items_indices = [claim_with_sim[0] for claim_with_sim in claims_with_similarity if claim_with_sim in df_training_indices]
...
def sample_similar_examples(test_index, similarities, df_training, few_shot_size):
    ...
    df_training_indices = set(df_training["id"].values.to_list())
