...
def testVal_BaseCfgLine_eq_01():
    ...
    print()
    print("OBJ01", obj01.get_unique_identifier())
    print("OBJ02", obj02.get_unique_identifier())
    assert obj01 == obj02
...
def testVal_BaseCfgLine_is_comment_01():
    ...
    obj01 = BaseCfgLine(all_lines=None, line="! hostname Foo", comment_delimiters=["!"])
    assert obj01.is_comment is True
    obj02 = BaseCfgLine(all_lines=None, line="hostname !Foo", comment_delimiters=["!"])
    assert obj02.is_comment is False
    obj03 = BaseCfgLine(all_lines=None, line="hostname Foo!", comment_delimiters=["!"])
