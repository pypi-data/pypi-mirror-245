...
def parse_f02_ios_01(request):
    ...
    parse_f02_ios_01 = CiscoConfParse(f02, syntax="ios", comment_delimiters=["#"], factory=False)
...
def parse_j01(request):
    """Preparsed j01"""
    parse_j01 = CiscoConfParse(j01, syntax="junos", comment_delimiters=["#"], factory=False)
