# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb.

# %% auto 0
__all__ = ['load_datasets', 'rand', 'Tunables', 'Encoder', 'Decoder', 'TSARTransformer', 'make_model']

# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 1
import dataclasses
import random
import math
import torch
...
# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 2
from pathlib import Path
import pylab as plt
import pandas as pd
import numpy as np

# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 3
import whisper
from whisperspeech.train import *
from whisperspeech.modules import *

# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 10
...
# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 11
import re
...
# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 13
def rand(start, end):
...
# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 14
...
# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 15
...
# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 16
class TSARTransformer(nn.Module):
    def __init__(self, depth=6, n_head=6, head_width=64, ffn_mult=4, language='en',
        ...
        super().__init__()
        store_attr("depth,n_head,head_width,stoks_width,ttoks_width,ttoks_len,stoks_len,ttoks_codes,stoks_codes,language")
...
# %% ../nbs/5. Text to semantic token modeling μP-Copy2.ipynb 17
