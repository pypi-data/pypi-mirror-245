...
print(f"{trainer.strategy=}")
for attr in 'cluster_environment local_rank global_rank node_rank world_size parallel_devices'.split(' '):
    print(f"{attr}={getattr(trainer.strategy, attr, '–')}")
import torch
for i in range(torch.cuda.device_count()):
    print(f"Device {i}: {torch.cuda.get_device_properties(i).name}")
    
kwargs = {}
print('resume_from' in args, repr(args['resume_from']))
