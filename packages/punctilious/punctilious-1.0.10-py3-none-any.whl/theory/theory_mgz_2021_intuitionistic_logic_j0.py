...
class MGZ2021IntuitionisticLogicJ0(pu.TheoryPackage):
    ...
    def __init__(self, u: (None, pu.UniverseOfDiscourse) = None):
        ...
        t = self.u.t.declare(symbol=theory_symbol, index=0, dashed_name='intuitionistic-logic',
        ...
        # Axiom: PL11
        self.pl11_declaration = u.a.declare(symbol=axiom_symbol, index=11, natural_language=f'¬𝐴 ⊃ (𝐴 ⊃ 𝐵)')
