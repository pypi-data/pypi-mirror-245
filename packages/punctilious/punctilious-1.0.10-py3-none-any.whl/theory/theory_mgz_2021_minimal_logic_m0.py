...
class MGZ2021MinimalLogicM0(pu.TheoryPackage):
    ...
    def __init__(self, u: (None, pu.UniverseOfDiscourse) = None):
        ...
        t = self.u.t.declare(symbol=theory_symbol, index=0, dashed_name='minimal-logic', name='minimal logic',
            explicit_name='minimal logic [MGZ21]')
        self.t = t
        self.m0 = t
        ...
        with u.with_variable(symbol='A', auto_index=False) as a, u.with_variable(symbol='B',
            ...
            self.pl3_statement = t.i.axiom_interpretation.infer_formula_statement(a=self.pl3_inclusion,
                p=(a | u.c1.implies | b) | u.c1.implies | ((a | u.c1.land | c) | u.c1.implies | (b | u.c1.land | c)),
                lock=True)
        ...
        with u.with_variable(symbol='A', auto_index=False) as a, u.with_variable(symbol='B',
            auto_index=False) as b, u.with_variable(symbol='C', auto_index=False) as c:
            self.pl4_statement = t.i.axiom_interpretation.infer_formula_statement(a=self.pl4_inclusion,
                p=((a | u.c1.implies | b) | u.c1.land | (b | u.c1.implies | c)) | u.c1.implies | (a | u.c1.implies | c),
                lock=True)
        ...
        with u.with_variable(symbol='A', auto_index=False) as a, u.with_variable(symbol='B',
            auto_index=False) as b, u.with_variable(symbol='C', auto_index=False) as c:
            self.pl9_statement = t.i.axiom_interpretation.infer_formula_statement(a=self.pl9_inclusion,
                p=((a | u.c1.implies | c) | u.c1.land | (b | u.c1.implies | c)) | u.c1.implies | (
        ...
        with u.with_variable(symbol='A', auto_index=False) as a, u.with_variable(symbol='B', auto_index=False) as b:
            self.pl10_statement = t.i.axiom_interpretation.infer_formula_statement(a=self.pl10_inclusion,
                p=((a | u.c1.implies | b) | u.c1.land | (a | u.c1.implies | u.c1.lnot(b))) | u.c1.implies | u.c1.lnot(
                    a), lock=True)

        # First derivation

        section_1_2 = t.open_section(section_title='First derivation', section_number=2, section_parent=section_1)

        # Original: 𝑝1 ⊃ (𝑝1 ∨ 𝑝2)
        # Punctilious: 𝐩₁ ⟹ (𝐩₁ ∨ 𝐩₂)
        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            line_1 = t.i.variable_substitution.infer_formula_statement(ref='1', p=self.pl7_statement,
                phi=u.c1.tupl(p1, p2))
        ...
        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            ...
            a = (p1 | u.c1.lor | p2) | u.c1.implies | (p2 | u.c1.lor | p1)
            # Original B: [𝑝1 ⊃ (𝑝1 ∨ 𝑝2)]
            b = p1 | u.c1.implies | (p1 | u.c1.lor | p2)
            # Substitution tuple
            # Note that the order of variables is not alphabetical,
            # instead it must comply with the order of appearance in the formula!
            substitution_tuple: pu.CompoundFormula = u.c1.tupl(b, a)
            line_2 = t.i.variable_substitution.infer_formula_statement(ref='2', p=self.pl5_statement,
        ...
        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            ...
            b = p1 | u.c1.implies | (p1 | u.c1.lor | p2)
            # C --> ((𝑝1 ∨ 𝑝2) ⊃ (𝑝2 ∨ 𝑝1))
            c = (p1 | u.c1.lor | p2) | u.c1.implies | (p2 | u.c1.lor | p1)
            # Substitution tuple
            # Note that the order of variables is not alphabetical,
            # instead it must comply with the order of appearance in the formula!
            substitution_tuple: pu.CompoundFormula = u.c1.tupl(a, b, c)
            line_4 = t.i.variable_substitution.infer_formula_statement(ref='4', p=self.pl3_statement,
                phi=substitution_tuple)
        ...
        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            ...
            # Note that the order of variables is not alphabetical,
            # instead it must comply with the order of appearance in the formula!
            substitution_tuple: pu.CompoundFormula = u.c1.tupl(a)
            line_6 = t.i.variable_substitution.infer_formula_statement(ref='6', p=self.pl1_statement,
                phi=substitution_tuple)
        ...
        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            ...
            # Note that the order of variables is not alphabetical,
            # instead it must comply with the order of appearance in the formula!
            substitution_tuple: pu.CompoundFormula = u.c1.tupl(a, b)
            line_7 = t.i.variable_substitution.infer_formula_statement(ref='7', p=self.pl8_statement,
                phi=substitution_tuple)
        ...
        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            ...
            # instead it must comply with the order of appearance in the formula!
            substitution_tuple: pu.CompoundFormula = u.c1.tupl(a, b, c)
            line_10 = t.i.variable_substitution.infer_formula_statement(ref='10', p=self.pl4_statement,
                phi=substitution_tuple)
        ...
        section_1_3 = t.open_section(section_title='Meta derivation', section_number=3, section_parent=section_1)
        ...
        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            c = u.c3.declare(symbol='C', auto_index=False, value=p1 | u.c1.implies | (p1 | u.c1.lor | p2), echo=True)

        with u.with_variable(symbol='p', index=1) as p1, u.with_variable(symbol='p', index=2) as p2:
            d = u.c3.declare(symbol='D', auto_index=False,
                value=(p1 | u.c1.lor | p2) | u.c1.implies | (p2 | u.c1.lor | p1), echo=True)
        ...
        # 2. ⊢ 𝐶 ⊃ (𝐷 ⊃ 𝐶)
        h1_l2 = t.i.variable_substitution.infer_formula_statement(p=self.pl5_statement, phi=u.c1.tupl(c, d))
        ...
        print(psi)
        mask: frozenset[pu.FreeVariable] = frozenset(
            pu.get_formula_unique_variable_ordered_set(u=u, phi=phi) + pu.get_formula_unique_variable_ordered_set(u=u,
                phi=psi))
        print(mask)
