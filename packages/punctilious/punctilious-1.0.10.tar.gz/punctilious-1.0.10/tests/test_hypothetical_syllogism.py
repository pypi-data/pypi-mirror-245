...
class TestHypotheticalSyllogism(TestCase):
    ...
    def test_hypothetical_syllogism(self):
        ...
        self.assertTrue(
            proposition_of_interest.is_formula_syntactically_equivalent_to(phi=r1(o1, o2) | u.c1.implies | r1(o3, o1)))
        # Syntax error
        with self.assertRaises(pu.PunctiliousException) as error:
            t1.i.hypothetical_syllogism.infer_formula_statement(p_implies_q=o3 | u.c1.implies | o2,
                q_implies_r=o1 | u.c1.implies | o2)
        self.assertIs(pu.error_codes.error_002_inference_premise_syntax_error, error.exception.error_code)
        # Validity error
        with self.assertRaises(pu.PunctiliousException) as error:
            t1.i.hypothetical_syllogism.infer_formula_statement(p_implies_q=o3 | u.c1.implies | o2,
                q_implies_r=o2 | u.c1.implies | o1)
