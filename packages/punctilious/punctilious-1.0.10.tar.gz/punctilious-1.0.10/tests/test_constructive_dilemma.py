...
class TestConstructiveDilemma(TestCase):
    def test_constructive_dilemma(self):
        ...
        self.assertTrue(proposition_of_interest.is_formula_syntactically_equivalent_to(phi=o2 | u.c1.lor | o4))
        # Syntax error
        with self.assertRaises(pu.PunctiliousException) as error:
            t1.i.constructive_dilemma.infer_formula_statement(p_implies_q=o1 | u.c1.iff | o2,
                r_implies_s=o3 | u.c1.implies | o4, p_or_r=o1 | u.c1.lor | o4)
        self.assertIs(pu.error_codes.error_002_inference_premise_syntax_error, error.exception.error_code)
        # Syntax error 2
        with self.assertRaises(pu.PunctiliousException) as error:
            t1.i.constructive_dilemma.infer_formula_statement(p_implies_q=o2 | u.c1.implies | o1,
                r_implies_s=o3 | u.c1.implies | o4, p_or_r=o1 | u.c1.lor | o4)
        self.assertIs(pu.error_codes.error_002_inference_premise_syntax_error, error.exception.error_code)
        # Validity error
        with self.assertRaises(pu.PunctiliousException) as error:
            t1.i.constructive_dilemma.infer_formula_statement(p_implies_q=o2 | u.c1.implies | o1,
                r_implies_s=o3 | u.c1.implies | o4, p_or_r=o2 | u.c1.lor | o3)
