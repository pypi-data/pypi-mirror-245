...
class TestTheory(TestCase):
    ...
    def test_list_theoretical_objcts_recursively(self):
        ...
        self.assertEqual({t1}, set(t1.iterate_theoretical_objcts_references()))
        r2 = u.c1.declare(2, signal_proposition=True)
        o1 = u.o.declare()
        o2 = u.o.declare()
        o3 = u.o.declare()
        ...
        limit = t1.i.axiom_interpretation.infer_formula_statement(ap1, f2)
        t1.i.axiom_interpretation.infer_formula_statement(ap1, f3)
        t2a = u.t.declare(extended_theory=t1, extended_theory_limit=limit)
        t2b = u.t.declare(extended_theory=t1)
        ...
        t2a.i.axiom_interpretation.infer_formula_statement(ap1, f2)
        a2 = u._inference_rule(random_data.random_sentence())
        ap2 = t2a.include_axiom(a2)
        t2a.i.axiom_interpretation.infer_formula_statement(ap2, f3)
        t3 = u.t.declare(extended_theory=t2a)
