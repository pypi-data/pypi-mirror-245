...
class TestDefinitionDeclaration(TestCase):
    ...
    def test_title(self):
        ...
        d1 = u.d.declare(natural_language=content1)
        self.assertEqual('Definition (D1)', d1.rep_title(cap=True, encoding=pu.encodings.plaintext))
        self.assertEqual('definition (D1)', d1.rep_title(cap=False, encoding=pu.encodings.plaintext))
        self.assertEqual('𝗗𝗲𝗳𝗶𝗻𝗶𝘁𝗶𝗼𝗻 (𝒟₁)', d1.rep_title(cap=True, encoding=pu.encodings.unicode))
        self.assertEqual('𝗱𝗲𝗳𝗶𝗻𝗶𝘁𝗶𝗼𝗻 (𝒟₁)', d1.rep_title(cap=False, encoding=pu.encodings.unicode))
    ...
    def test_definition_declaration(self):
        ...
        d1 = u.d.declare(natural_language=content1)
        d2 = u.d.declare(natural_language=content2)
        d3 = u.d.declare(natural_language=content3, symbol='b')
        d4 = u.d.declare(natural_language=content4, symbol='c', name='the definition of test')
        d5 = u.d.declare(natural_language=content5, acronym='oaot', symbol='d', name='the other definition of test')
        self.assertEqual(
