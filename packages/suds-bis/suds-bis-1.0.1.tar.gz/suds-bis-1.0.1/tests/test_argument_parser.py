...
def test_extra_positional_arguments(param_optional, args):
    ...
    _expect_error(
        TypeError,
        expected,
        suds.argparser.parse_args,
        "fru-fru",
        params,
        args,
        {},
        param_processor.process,
        True,
    )
...
def test_not_reporting_extra_argument_errors():
    ...
    param_processor = MockParamProcessor()
    args_required, args_allowed = suds.argparser.parse_args(
        "w", params, args, kwargs, param_processor.process, False
    )
...
@pytest.mark.parametrize(
    ("expect_required", "expect_allowed", "param_defs"),
    (
        # No parameters.
        (0, 0, []),
        # Single parameter.
        ...
        (
            0,
            4,
            [("a", True, [1]), ("b", True, [1]), ("c", True, [1]), ("d", True, [1])],
        ),
        (
            2,
            4,
            [("a", True, [1]), ("b", False, [1]), ("c", True, [1]), ("d", False, [1])],
        ),
        (
            2,
            4,
            [("a", False, [1]), ("b", True, [1]), ("c", False, [1]), ("d", True, [1])],
        ),
        (
            3,
            4,
            [("a", False, [1]), ("b", False, [1]), ("c", False, [1]), ("d", True, [1])],
        ),
        (
            3,
            4,
            [("a", True, [1]), ("b", False, [1]), ("c", False, [1]), ("d", False, [1])],
        ),
        # Choice containing only simple members.
        (1, 2, [("a", False, [[1]]), ("b", False, [[1]])]),
        (0, 2, [("a", True, [[1]]), ("b", False, [[1]])]),
        (0, 2, [("a", False, [[1]]), ("b", True, [[1]])]),
        (0, 2, [("a", True, [[1]]), ("b", True, [[1]])]),
        ...
        (0, 3, [("a", False, [1, [2]]), ("b", True, [1, [2]]), ("c", False, [1, [2]])]),
        (
            0,
            3,
            [
...
def test_unwrapped_arg_counts(expect_required, expect_allowed, param_defs):
    ...
    args_required, args_allowed = suds.argparser.parse_args(
        "w", params, args, {}, param_processor.process, False
    )
...
def _expect_error(
    expected_exception, expected_error_text, test_function, *args, **kwargs
):
    """
