...
class Files:
    ...
    # Clean
    @staticmethod
    def clean(__signalnum: Optional[int] = None,
              __frame: Optional[FrameType] = None) -> None:
        ...
        # Raise signal
        if __signalnum:
            kill(getpid(), __signalnum)

    # Temp
    @staticmethod
    def temp(path: Optional[str] = None, mode: str = 'wt', newline: str = '\n',
             prefix: str = '.tmp.') -> TempFile:
