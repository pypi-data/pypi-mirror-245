...
def get_random_user_agent():
	...
	return array[random.randint(0, len(array) - 1)] if array else "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.72 Safari/537.36"
