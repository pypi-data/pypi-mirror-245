...
class PdfAnnotationActions(SpireObject):
    ...
    def MouseEnter(self) -> 'PdfAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_MouseEnter(self.Ptr)
    ...
    def MouseEnter(self, value: 'PdfAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_MouseEnter(self.Ptr, value.Ptr)
    ...
    def MouseLeave(self) -> 'PdfAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_MouseLeave(self.Ptr)
        ret = None if intPtr == None else PdfAction(intPtr)
        return ret
    ...
    def MouseLeave(self, value: 'PdfAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_MouseLeave(self.Ptr, value.Ptr)
    ...
    def MouseDown(self) -> 'PdfAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_MouseDown(self.Ptr)
        ret = None if intPtr == None else PdfAction(intPtr)
        return ret
    ...
    def MouseDown(self, value: 'PdfAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_MouseDown(self.Ptr, value.Ptr)
    ...
    def MouseUp(self) -> 'PdfAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_MouseUp(self.Ptr)
        ret = None if intPtr == None else PdfAction(intPtr)
        return ret
    ...
    def MouseUp(self, value: 'PdfAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_MouseUp(self.Ptr, value.Ptr)
    ...
    def GotFocus(self) -> 'PdfAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_GotFocus(self.Ptr)
        ret = None if intPtr == None else PdfAction(intPtr)
        return ret
    ...
    def GotFocus(self, value: 'PdfAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_GotFocus(self.Ptr, value.Ptr)
    ...
    def LostFocus(self) -> 'PdfAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_LostFocus(self.Ptr)
        ret = None if intPtr == None else PdfAction(intPtr)
        return ret
    ...
    def LostFocus(self, value: 'PdfAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_LostFocus(self.Ptr, value.Ptr)
    ...
    def Caculate(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_Caculate(self.Ptr)
    ...
    def Caculate(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_Caculate(self.Ptr, value.Ptr)
    ...
    def Validate(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_Validate(self.Ptr)
        ret = None if intPtr == None else PdfJavaScriptAction(intPtr)
        return ret
    ...
    def Validate(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_Validate(self.Ptr, value.Ptr)
    ...
    def KeyPressed(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_KeyPressed(self.Ptr)
        ret = None if intPtr == None else PdfJavaScriptAction(intPtr)
        return ret
    ...
    def KeyPressed(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_KeyPressed(self.Ptr, value.Ptr)
    ...
    def Format(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationActions_get_Format(self.Ptr)
        ret = None if intPtr == None else PdfJavaScriptAction(intPtr)
        return ret
    ...
    def Format(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfAnnotationActions_set_Format(self.Ptr, value.Ptr)