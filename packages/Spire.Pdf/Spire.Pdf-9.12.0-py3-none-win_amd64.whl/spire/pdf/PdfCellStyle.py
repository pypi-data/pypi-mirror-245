...
class PdfCellStyle(SpireObject):
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_CreatePdfCellStyle()
    ...
    def __init__(self, font: PdfFontBase, brush: PdfBrush, pen: PdfPen):
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_CreatePdfCellStyleFFB(ptrFont, ptrBrush, ptrPen)
        super(PdfCellStyle, self).__init__(intPtr)
    ...
    def Font(self) -> 'PdfFontBase':
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_get_Font(self.Ptr)
    ...
    def Font(self, value: 'PdfFontBase'):
        ...
        GetDllLibPdf().PdfCellStyle_set_Font(self.Ptr, value.Ptr)
    ...
    def StringFormat(self) -> 'PdfStringFormat':
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_get_StringFormat(self.Ptr)
    ...
    def StringFormat(self, value: 'PdfStringFormat'):
        ...
        GetDllLibPdf().PdfCellStyle_set_StringFormat(self.Ptr, value.Ptr)
    ...
    def TextPen(self) -> 'PdfPen':
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_get_TextPen(self.Ptr)
    ...
    def TextPen(self, value: 'PdfPen'):
        ...
        GetDllLibPdf().PdfCellStyle_set_TextPen(self.Ptr, value.Ptr)
    ...
    def TextBrush(self) -> 'PdfBrush':
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_get_TextBrush(self.Ptr)
    ...
    def TextBrush(self, value: 'PdfBrush'):
        ...
        GetDllLibPdf().PdfCellStyle_set_TextBrush(self.Ptr, value.Ptr)
    ...
    def BorderPen(self) -> 'PdfPen':
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_get_BorderPen(self.Ptr)
        ret = None if intPtr == None else PdfPen(intPtr)
        return ret
    ...
    def BorderPen(self, value: 'PdfPen'):
        ...
        GetDllLibPdf().PdfCellStyle_set_BorderPen(self.Ptr, value.Ptr)
    ...
    def BackgroundBrush(self) -> 'PdfBrush':
        ...
        intPtr = GetDllLibPdf().PdfCellStyle_get_BackgroundBrush(self.Ptr)
        ret = None if intPtr == None else PdfBrush(intPtr)
        return ret
    ...
    def BackgroundBrush(self, value: 'PdfBrush'):
        ...
        GetDllLibPdf().PdfCellStyle_set_BackgroundBrush(self.Ptr, value.Ptr)
