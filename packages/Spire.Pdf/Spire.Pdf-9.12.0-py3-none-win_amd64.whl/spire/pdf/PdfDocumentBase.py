...
class PdfDocumentBase (SpireObject) :
    ...
    def SaveToPostScript(self ,filename:str):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToPostScript(self.Ptr, filename)
    ...
    def SaveToDoc(self ,stream:Stream,IsDocx:bool):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToDoc(self.Ptr, intPtrstream,IsDocx)
    ...
    def SaveToDoc(self ,filename:str):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToDocF(self.Ptr, filename)
    ...
    def Close(self):
        ...
        GetDllLibPdf().PdfDocumentBase_Close(self.Ptr)
    ...
    def Close(self ,completely:bool):
        ...
        GetDllLibPdf().PdfDocumentBase_CloseC(self.Ptr, completely)
    ...
    def Save(self ,stream:Stream):
        ...
        GetDllLibPdf().PdfDocumentBase_Save(self.Ptr, intPtrstream)
    ...
    def ImportPage(self ,ldDoc:'PdfDocumentBase',page:'PdfPageBase')->'PdfPageBase':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_ImportPage(self.Ptr, intPtrldDoc,intPtrpage)
    ...
    def ImportPage(self ,ldDoc:'PdfDocumentBase',pageIndex:int)->'PdfPageBase':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_ImportPageLP(self.Ptr, intPtrldDoc,pageIndex)
        ret = None if intPtr==None else PdfPageBase(intPtr)
        return ret
    ...
    def ImportPage(self ,ldDoc:'PdfDocumentBase',pageIndex:int,resultPageIndex:int)->'PdfPageBase':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_ImportPageLPR(self.Ptr, intPtrldDoc,pageIndex,resultPageIndex)
        ret = None if intPtr==None else PdfPageBase(intPtr)
        return ret
    ...
    def ImportPageRange(self ,ldDoc:'PdfDocumentBase',startIndex:int,endIndex:int)->'PdfPageBase':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_ImportPageRange(self.Ptr, intPtrldDoc,startIndex,endIndex)
        ret = None if intPtr==None else PdfPageBase(intPtr)
        return ret
    ...
    def ImportPageRange(self ,ldDoc:'PdfDocumentBase',startIndex:int,endIndex:int,resultPageIndex:int)->'PdfPageBase':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_ImportPageRangeLSER(self.Ptr, intPtrldDoc,startIndex,endIndex,resultPageIndex)
        ret = None if intPtr==None else PdfPageBase(intPtr)
        return ret
    ...
    def Dispose(self):
        ...
        GetDllLibPdf().PdfDocumentBase_Dispose(self.Ptr)
    ...
    def Conformance(self)->'PdfConformanceLevel':
        ...
        ret = GetDllLibPdf().PdfDocumentBase_get_Conformance(self.Ptr)
    ...
    #    GetDllLibPdf().PdfDocumentBase_set_Conformance(self.Ptr, value.value)
    ...
    def Attachments(self)->'PdfAttachmentCollection':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_Attachments(self.Ptr)
    ...
    def ColorSpace(self)->'PdfColorSpace':
        ...
        ret = GetDllLibPdf().PdfDocumentBase_get_ColorSpace(self.Ptr)
    ...
    def ColorSpace(self, value:'PdfColorSpace'):
        ...
        GetDllLibPdf().PdfDocumentBase_set_ColorSpace(self.Ptr, value.value)
    ...
    def Form(self)->'PdfForm':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_Form(self.Ptr)
    ...
    def PageLabels(self)->'PdfPageLabels':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_PageLabels(self.Ptr)
    ...
    def PageLabels(self, value:'PdfPageLabels'):
        ...
        GetDllLibPdf().PdfDocumentBase_set_PageLabels(self.Ptr, value.Ptr)
...
#        intPtrArray = GetDllLibPdf().PdfDocumentBase_get_UsedFonts(self.Ptr)
...
#        return ret
    ...
    def Sections(self)->'PdfSectionCollection':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_Sections(self.Ptr)
    ...
    def PageSettings(self)->'PdfPageSettings':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_PageSettings(self.Ptr)
    ...
    def PageSettings(self, value:'PdfPageSettings'):
        ...
        GetDllLibPdf().PdfDocumentBase_set_PageSettings(self.Ptr, value.Ptr)
    ...
    def Template(self)->'PdfDocumentTemplate':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_Template(self.Ptr)
    ...
    def Template(self, value:'PdfDocumentTemplate'):
        ...
        GetDllLibPdf().PdfDocumentBase_set_Template(self.Ptr, value.Ptr)
    ...
    def Pages(self)->'PdfPageCollection':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_Pages(self.Ptr)
    ...
    def Security(self)->'PdfSecurity':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_Security(self.Ptr)
    ...
    def DocumentInformation(self)->'PdfDocumentInformation':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_DocumentInformation(self.Ptr)
    ...
    def ViewerPreferences(self)->'PdfViewerPreferences':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_ViewerPreferences(self.Ptr)
    ...
    def ViewerPreferences(self, value:'PdfViewerPreferences'):
        ...
        GetDllLibPdf().PdfDocumentBase_set_ViewerPreferences(self.Ptr, value.Ptr)
    ...
    def CompressionLevel(self)->'PdfCompressionLevel':
        ...
        ret = GetDllLibPdf().PdfDocumentBase_get_CompressionLevel(self.Ptr)
    ...
    def CompressionLevel(self, value:'PdfCompressionLevel'):
        ...
        GetDllLibPdf().PdfDocumentBase_set_CompressionLevel(self.Ptr, value.value)
    ...
    def FileStructure(self)->'PdfFileInfo':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_FileStructure(self.Ptr)
    ...
    def FileStructure(self, value:'PdfFileInfo'):
        ...
        GetDllLibPdf().PdfDocumentBase_set_FileStructure(self.Ptr, value.Ptr)
    ...
    def JavaScripts(self)->'PdfDocumentActions':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_JavaScripts(self.Ptr)
    ...
    def Bookmarks(self)->'PdfBookmarkCollection':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_get_Bookmarks(self.Ptr)
    ...
    def Clone(self)->'SpireObject':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_Clone(self.Ptr)
    ...
    def Split(self ,destFilePattern:str):
        ...
        GetDllLibPdf().PdfDocumentBase_Split(self.Ptr, destFilePattern)
    ...
    def Split(self ,destFilePattern:str,startNumber:int):
        ...
        GetDllLibPdf().PdfDocumentBase_SplitDS(self.Ptr, destFilePattern,startNumber)
    ...
    def Merge(dest:'PdfDocumentBase',sourceDocuments:List['SpireObject'])->'PdfDocumentBase':
        ...
        intPtr = GetDllLibPdf().PdfDocumentBase_Merge( intPtrdest,arraysourceDocuments)
...
#        GetDllLibPdf().PdfDocumentBase_DisposeOnClose(self.Ptr, intPtrobj)
    ...
    def Save(self ,fileName:str,fileformat:FileFormat):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveFF(self.Ptr, fileName,enumfileformat)
    ...
    def Save(self ,stream:Stream,fileformat:FileFormat):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveSF(self.Ptr, intPtrstream,enumfileformat)
...
#        intPtrArray = GetDllLibPdf().PdfDocumentBase_SaveF(self.Ptr, enumfileformat)
...
#        intPtrArray = GetDllLibPdf().PdfDocumentBase_SaveSEF(self.Ptr, startIndex,endIndex,enumfileformat)
#        ret = GetObjVectorFromArray(intPtrArray, Stream)
#        return ret
    ...
    def Save(self ,filename:str):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveF1(self.Ptr, filename)
    ...
    def SaveToXPS(self ,stream:Stream):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToXPS(self.Ptr, intPtrstream)
    ...
    def SaveToXPS(self ,savefilename:str):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToXPSS(self.Ptr, savefilename)
...
#        intPtrArray = GetDllLibPdf().PdfDocumentBase_SaveToSVG(self.Ptr)
...
#        return ret
    ...
    def SaveToHtml(self ,filename:str):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToHtml(self.Ptr, filename)
    ...
    def SaveToHtml(self ,stream:Stream):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToHtmlS(self.Ptr, intPtrstream)
    ...
    def SaveToPcl(self ,stream:Stream):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToPcl(self.Ptr, intPtrstream)
    ...
    def SaveToPcl(self ,filename:str):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToPclF(self.Ptr, filename)
    ...
    def SaveToPostScript(self ,stream:Stream):
        ...
        GetDllLibPdf().PdfDocumentBase_SaveToPostScriptS(self.Ptr, intPtrstream)
