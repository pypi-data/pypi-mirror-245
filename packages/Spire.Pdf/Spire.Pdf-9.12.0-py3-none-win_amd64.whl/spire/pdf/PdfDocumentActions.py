...
class PdfDocumentActions(SpireObject):
    ...
    def AfterOpenAction(self) -> 'PdfAction':
        ...
        intPtr = GetDllLibPdf().PdfDocumentActions_get_AfterOpenAction(self.Ptr)
    ...
    def AfterOpenAction(self, value: 'PdfAction'):
        ...
        GetDllLibPdf().PdfDocumentActions_set_AfterOpenAction(self.Ptr, value.Ptr)
    ...
    def BeforeCloseAction(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfDocumentActions_get_BeforeCloseAction(self.Ptr)
    ...
    def BeforeCloseAction(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfDocumentActions_set_BeforeCloseAction(self.Ptr, value.Ptr)
    ...
    def BeforeSaveAction(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfDocumentActions_get_BeforeSaveAction(self.Ptr)
        ret = None if intPtr == None else PdfJavaScriptAction(intPtr)
        return ret
    ...
    def BeforeSaveAction(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfDocumentActions_set_BeforeSaveAction(self.Ptr, value.Ptr)
    ...
    def AfterSaveAction(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfDocumentActions_get_AfterSaveAction(self.Ptr)
        ret = None if intPtr == None else PdfJavaScriptAction(intPtr)
        return ret
    ...
    def AfterSaveAction(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfDocumentActions_set_AfterSaveAction(self.Ptr, value.Ptr)
    ...
    def BeforePrintAction(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfDocumentActions_get_BeforePrintAction(self.Ptr)
        ret = None if intPtr == None else PdfJavaScriptAction(intPtr)
        return ret
    ...
    def BeforePrintAction(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfDocumentActions_set_BeforePrintAction(self.Ptr, value.Ptr)
    ...
    def AfterPrintAction(self) -> 'PdfJavaScriptAction':
        ...
        intPtr = GetDllLibPdf().PdfDocumentActions_get_AfterPrintAction(self.Ptr)
        ret = None if intPtr == None else PdfJavaScriptAction(intPtr)
        return ret
    ...
    def AfterPrintAction(self, value: 'PdfJavaScriptAction'):
        ...
        GetDllLibPdf().PdfDocumentActions_set_AfterPrintAction(self.Ptr, value.Ptr)
