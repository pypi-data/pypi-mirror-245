...
class PdfBarcode (SpireObject) :
    ...
    def BackColor(self)->'PdfRGBColor':
        ...
        intPtr = GetDllLibPdf().PdfBarcode_get_BackColor(self.Ptr)
    ...
    def BackColor(self, value:'PdfRGBColor'):
        ...
        GetDllLibPdf().PdfBarcode_set_BackColor(self.Ptr, value.Ptr)
    ...
    def BarColor(self)->'PdfRGBColor':
        ...
        intPtr = GetDllLibPdf().PdfBarcode_get_BarColor(self.Ptr)
        ret = None if intPtr==None else PdfRGBColor(intPtr)
        return ret
    ...
    def BarColor(self, value:'PdfRGBColor'):
        ...
        GetDllLibPdf().PdfBarcode_set_BarColor(self.Ptr, value.Ptr)
    ...
    def TextColor(self)->'PdfRGBColor':
        ...
        intPtr = GetDllLibPdf().PdfBarcode_get_TextColor(self.Ptr)
        ret = None if intPtr==None else PdfRGBColor(intPtr)
        return ret
    ...
    def TextColor(self, value:'PdfRGBColor'):
        ...
        GetDllLibPdf().PdfBarcode_set_TextColor(self.Ptr, value.Ptr)
    ...
    def NarrowBarWidth(self)->float:
        ...
        ret = GetDllLibPdf().PdfBarcode_get_NarrowBarWidth(self.Ptr)
        return ret
    ...
    def NarrowBarWidth(self, value:float):
        ...
        GetDllLibPdf().PdfBarcode_set_NarrowBarWidth(self.Ptr, value)
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfBarcode_get_Text(self.Ptr))
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibPdf().PdfBarcode_set_Text(self.Ptr, value)
    ...
    def Location(self)->'PointF':
        ...
        intPtr = GetDllLibPdf().PdfBarcode_get_Location(self.Ptr)
    ...
    def Location(self, value:'PointF'):
        ...
        GetDllLibPdf().PdfBarcode_set_Location(self.Ptr, value.Ptr)
    ...
    def QuietZone(self)->'PdfBarcodeQuietZones':
        ...
        intPtr = GetDllLibPdf().PdfBarcode_get_QuietZone(self.Ptr)
    ...
    def QuietZone(self, value:'PdfBarcodeQuietZones'):
        ...
        GetDllLibPdf().PdfBarcode_set_QuietZone(self.Ptr, value.Ptr)
    ...
    def BarHeight(self)->float:
        ...
        ret = GetDllLibPdf().PdfBarcode_get_BarHeight(self.Ptr)
        return ret

    @BarHeight.setter
    def BarHeight(self, value:float):
        GetDllLibPdf().PdfBarcode_set_BarHeight.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfBarcode_set_BarHeight(self.Ptr, value)
    ...
    def Size(self)->'SizeF':
        ...
        intPtr = GetDllLibPdf().PdfBarcode_get_Size(self.Ptr)
    ...
    def Bounds(self)->'RectangleF':
        ...
        intPtr = GetDllLibPdf().PdfBarcode_get_Bounds(self.Ptr)
    ...
    def Bounds(self, value:'RectangleF'):
        ...
        GetDllLibPdf().PdfBarcode_set_Bounds(self.Ptr, value.Ptr)
