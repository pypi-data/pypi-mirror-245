...
class PdfSeparationColor (  PdfComplexColor) :
    ...
    def __init__(self, colorspace:PdfColorSpaces,tint:float):
        ...
        intPtr = GetDllLibPdf().PdfSeparationColor_CreatePdfSeparationColorCT(ptrColor,tint)
    ...
    def Tint(self)->float:
        ...
        ret = GetDllLibPdf().PdfSeparationColor_get_Tint(self.Ptr)
        return ret

    @Tint.setter
    def Tint(self, value:float):
        GetDllLibPdf().PdfSeparationColor_set_Tint.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfSeparationColor_set_Tint(self.Ptr, value)
