...
class PdfAnnotationCollection(PdfCollection):
    ...
    def get_Item(self, index: int) -> 'PdfAnnotation':
        ...
        intPtr = GetDllLibPdf().PdfAnnotationCollection_get_Item(self.Ptr, index)
    ...
    def Add(self, annotation: 'PdfAnnotation') -> int:
        ...
        ret = GetDllLibPdf().PdfAnnotationCollection_Add(self.Ptr, intPtrannotation)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibPdf().PdfAnnotationCollection_Clear(self.Ptr)
    ...
    def Contains(self, annotation: 'PdfAnnotation') -> bool:
        ...
        ret = GetDllLibPdf().PdfAnnotationCollection_Contains(self.Ptr, intPtrannotation)
        return ret
    ...
    def IndexOf(self, annotation: 'PdfAnnotation') -> int:
        ...
        ret = GetDllLibPdf().PdfAnnotationCollection_IndexOf(self.Ptr, intPtrannotation)
        return ret
    ...
    def Insert(self, index: int, annotation: 'PdfAnnotation'):
        ...
        GetDllLibPdf().PdfAnnotationCollection_Insert(self.Ptr, index, intPtrannotation)
    ...
    def RemoveAt(self, index: int):
        ...
        GetDllLibPdf().PdfAnnotationCollection_RemoveAt(self.Ptr, index)
    ...
    def Remove(self, annot: 'PdfAnnotation'):
        ...
        GetDllLibPdf().PdfAnnotationCollection_Remove(self.Ptr, intPtrannot)