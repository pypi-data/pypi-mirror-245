...
class PdfSectionNumberField(PdfMultipleNumberValueField):
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPdf().PdfSectionNumberField_CreatePdfSectionNumberField()
    ...
    def __init__(self, font: PdfFontBase):
        ...
        intPtr = GetDllLibPdf().PdfSectionNumberField_CreatePdfSectionNumberFieldF(ptrFont)
        super(PdfSectionNumberField, self).__init__(intPtr)
    ...
    def __init__(self, font: PdfFontBase, brush: PdfBrush):
        ...
        intPtr = GetDllLibPdf().PdfSectionNumberField_CreatePdfSectionNumberFieldFB(ptrFont, ptrBrush)
        super(PdfSectionNumberField, self).__init__(intPtr)
    ...
    def __init__(self, font: PdfFontBase, bounds: RectangleF):
        ...
        intPtr = GetDllLibPdf().PdfSectionNumberField_CreatePdfSectionNumberFieldFBs(ptrFont, ptrBounds)
        super(PdfSectionNumberField, self).__init__(intPtr)