...
class PdfTableLayoutFormat(PdfTextLayout):
    ...
    def StartColumnIndex(self) -> int:
        ...
        ret = GetDllLibPdf().PdfTableLayoutFormat_get_StartColumnIndex(self.Ptr)
        return ret
    ...
    def StartColumnIndex(self, value: int):
        ...
        GetDllLibPdf().PdfTableLayoutFormat_set_StartColumnIndex(self.Ptr, value)
    ...
    def EndColumnIndex(self) -> int:
        ...
        ret = GetDllLibPdf().PdfTableLayoutFormat_get_EndColumnIndex(self.Ptr)
        return ret
    ...
    def EndColumnIndex(self, value: int):
        ...
        GetDllLibPdf().PdfTableLayoutFormat_set_EndColumnIndex(self.Ptr, value)