...
class PdfDocumentTemplate (SpireObject) :
    ...
    def Left(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_Left(self.Ptr)
    ...
    def Left(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_Left(self.Ptr, value.Ptr)
    ...
    def Top(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_Top(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def Top(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_Top(self.Ptr, value.Ptr)
    ...
    def Right(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_Right(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def Right(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_Right(self.Ptr, value.Ptr)
    ...
    def Bottom(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_Bottom(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def Bottom(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_Bottom(self.Ptr, value.Ptr)
    ...
    def EvenLeft(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_EvenLeft(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def EvenLeft(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_EvenLeft(self.Ptr, value.Ptr)
    ...
    def EvenTop(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_EvenTop(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def EvenTop(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_EvenTop(self.Ptr, value.Ptr)
    ...
    def EvenRight(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_EvenRight(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def EvenRight(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_EvenRight(self.Ptr, value.Ptr)
    ...
    def EvenBottom(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_EvenBottom(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def EvenBottom(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_EvenBottom(self.Ptr, value.Ptr)
    ...
    def OddLeft(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_OddLeft(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def OddLeft(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_OddLeft(self.Ptr, value.Ptr)
    ...
    def OddTop(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_OddTop(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def OddTop(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_OddTop(self.Ptr, value.Ptr)
    ...
    def OddRight(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_OddRight(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def OddRight(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_OddRight(self.Ptr, value.Ptr)
    ...
    def OddBottom(self)->'PdfPageTemplateElement':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_OddBottom(self.Ptr)
        ret = None if intPtr==None else PdfPageTemplateElement(intPtr)
        return ret
    ...
    def OddBottom(self, value:'PdfPageTemplateElement'):
        ...
        GetDllLibPdf().PdfDocumentTemplate_set_OddBottom(self.Ptr, value.Ptr)
    ...
    def Stamps(self)->'PdfStampCollection':
        ...
        intPtr = GetDllLibPdf().PdfDocumentTemplate_get_Stamps(self.Ptr)
