...
class PdfPKCS1Formatter(IPdfSignatureFormatter, Security_IPdfSignatureFormatter):
    ...
    def Properties(self) -> 'PdfSignatureProperties':
        ...
        intPtr = GetDllLibPdf().PdfPKCS1Formatter_get_Properties(self.Ptr)
...
#        intPtr = GetDllLibPdf().PdfPKCS1Formatter_get_Parameters(self.Ptr)
...
#        intPtrArray = GetDllLibPdf().PdfPKCS1Formatter_Sign(self.Ptr, arraycontent)
