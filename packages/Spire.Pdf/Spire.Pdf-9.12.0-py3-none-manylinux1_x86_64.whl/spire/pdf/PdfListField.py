...
class PdfListField(PdfAppearanceField):
    ...
    def Items(self) -> 'PdfListFieldItemCollection':
        ...
        intPtr = GetDllLibPdf().PdfListField_get_Items(self.Ptr)
    ...
    def SelectedIndex(self) -> int:
        ...
        ret = GetDllLibPdf().PdfListField_get_SelectedIndex(self.Ptr)
        return ret

    @SelectedIndex.setter
    def SelectedIndex(self, value: int):
        GetDllLibPdf().PdfListField_set_SelectedIndex.argtypes = [c_void_p, c_int]
        GetDllLibPdf().PdfListField_set_SelectedIndex(self.Ptr, value)
    ...
    def SelectedValue(self) -> str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfListField_get_SelectedValue(self.Ptr))
        return ret
    ...
    def SelectedValue(self, value: str):
        ...
        GetDllLibPdf().PdfListField_set_SelectedValue(self.Ptr, value)
    ...
    def SelectedItem(self) -> 'PdfListFieldItem':
        ...
        intPtr = GetDllLibPdf().PdfListField_get_SelectedItem(self.Ptr)
    ...
    def CommitOnSelChange(self) -> bool:
        ...
        ret = GetDllLibPdf().PdfListField_get_CommitOnSelChange(self.Ptr)
        return ret
    ...
    def CommitOnSelChange(self, value: bool):
        ...
        GetDllLibPdf().PdfListField_set_CommitOnSelChange(self.Ptr, value)