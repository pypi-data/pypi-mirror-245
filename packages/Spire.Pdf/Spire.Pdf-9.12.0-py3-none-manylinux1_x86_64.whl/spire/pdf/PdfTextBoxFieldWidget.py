...
class PdfTextBoxFieldWidget (  PdfStyledFieldWidget, IPdfTextBoxField) :
    ...
    def ForeColor(self)->'PdfRGBColor':
        ...
        intPtr = GetDllLibPdf().PdfTextBoxFieldWidget_get_ForeColor(self.Ptr)
    ...
    def ForeColor(self, value:'PdfRGBColor'):
        ...
        GetDllLibPdf().PdfTextBoxFieldWidget_set_ForeColor(self.Ptr, value.Ptr)
    ...
    def TextAlignment(self)->'PdfTextAlignment':
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_TextAlignment(self.Ptr)
    ...
    def TextAlignment(self, value:'PdfTextAlignment'):
        ...
        GetDllLibPdf().PdfTextBoxFieldWidget_set_TextAlignment(self.Ptr, value.value)
    ...
    def HighlightMode(self)->'PdfHighlightMode':
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_HighlightMode(self.Ptr)
    ...
    def HighlightMode(self, value:'PdfHighlightMode'):
        ...
        GetDllLibPdf().PdfTextBoxFieldWidget_set_HighlightMode(self.Ptr, value.value)
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfTextBoxFieldWidget_get_Text(self.Ptr))
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibPdf().PdfTextBoxFieldWidget_set_Text(self.Ptr, value)
    ...
    def DefaultValue(self)->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfTextBoxFieldWidget_get_DefaultValue(self.Ptr))
        return ret
    ...
    def DefaultValue(self, value:str):
        ...
        GetDllLibPdf().PdfTextBoxFieldWidget_set_DefaultValue(self.Ptr, value)
    ...
    def SpellCheck(self)->bool:
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_SpellCheck(self.Ptr)
        return ret

    @SpellCheck.setter
    def SpellCheck(self, value:bool):
        GetDllLibPdf().PdfTextBoxFieldWidget_set_SpellCheck.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfTextBoxFieldWidget_set_SpellCheck(self.Ptr, value)
    ...
    def InsertSpaces(self)->bool:
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_InsertSpaces(self.Ptr)
        return ret

    @InsertSpaces.setter
    def InsertSpaces(self, value:bool):
        GetDllLibPdf().PdfTextBoxFieldWidget_set_InsertSpaces.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfTextBoxFieldWidget_set_InsertSpaces(self.Ptr, value)
    ...
    def Multiline(self)->bool:
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_Multiline(self.Ptr)
        return ret

    @Multiline.setter
    def Multiline(self, value:bool):
        GetDllLibPdf().PdfTextBoxFieldWidget_set_Multiline.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfTextBoxFieldWidget_set_Multiline(self.Ptr, value)
    ...
    def Password(self)->bool:
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_Password(self.Ptr)
        return ret

    @Password.setter
    def Password(self, value:bool):
        GetDllLibPdf().PdfTextBoxFieldWidget_set_Password.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfTextBoxFieldWidget_set_Password(self.Ptr, value)
    ...
    def Scrollable(self)->bool:
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_Scrollable(self.Ptr)
        return ret

    @Scrollable.setter
    def Scrollable(self, value:bool):
        GetDllLibPdf().PdfTextBoxFieldWidget_set_Scrollable.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfTextBoxFieldWidget_set_Scrollable(self.Ptr, value)
    ...
    def MaxLength(self)->int:
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_get_MaxLength(self.Ptr)
        return ret

    @MaxLength.setter
    def MaxLength(self, value:int):
        GetDllLibPdf().PdfTextBoxFieldWidget_set_MaxLength.argtypes=[c_void_p, c_int]
        GetDllLibPdf().PdfTextBoxFieldWidget_set_MaxLength(self.Ptr, value)
    ...
    def WidgetItems(self)->'PdfTextBoxWidgetItemCollection':
        ...
        intPtr = GetDllLibPdf().PdfTextBoxFieldWidget_get_WidgetItems(self.Ptr)
    ...
    def ObjectID(self)->int:
        ...
        ret = GetDllLibPdf().PdfTextBoxFieldWidget_ObjectID(self.Ptr)
        return ret
