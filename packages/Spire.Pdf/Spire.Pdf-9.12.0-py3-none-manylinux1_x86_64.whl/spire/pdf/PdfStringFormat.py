...
class PdfStringFormat (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPdf().PdfStringFormat_CreatePdfStringFormat()
    ...
    def __init__(self, alignment:PdfTextAlignment, lineAlignment:PdfVerticalAlignment):
        ...
        intPtr = GetDllLibPdf().PdfStringFormat_CreatePdfStringFormatAL(enumAlignment,enumVerticalAlignment)
        super(PdfStringFormat, self).__init__(intPtr)
    ...
    def __init__(self, alignment:PdfTextAlignment):
        ...
        intPtr = GetDllLibPdf().PdfStringFormat_CreatePdfStringFormatA(enumAlignment)
        super(PdfStringFormat, self).__init__(intPtr)
    ...
    def __init__(self, columnFormat:str):
        ...
        intPtr = GetDllLibPdf().PdfStringFormat_CreatePdfStringFormatC(columnFormat)
        super(PdfStringFormat, self).__init__(intPtr)
    ...
    def Alignment(self)->'PdfTextAlignment':
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'PdfTextAlignment'):
        ...
        GetDllLibPdf().PdfStringFormat_set_Alignment(self.Ptr, value.value)
    ...
    def LineAlignment(self)->'PdfVerticalAlignment':
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_LineAlignment(self.Ptr)
    ...
    def LineAlignment(self, value:'PdfVerticalAlignment'):
        ...
        GetDllLibPdf().PdfStringFormat_set_LineAlignment(self.Ptr, value.value)
...
<remarks>Note, that this property doesn't change any alignment of the text. 
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_RightToLeft(self.Ptr)
        return ret

    @RightToLeft.setter
    def RightToLeft(self, value:bool):
        GetDllLibPdf().PdfStringFormat_set_RightToLeft.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfStringFormat_set_RightToLeft(self.Ptr, value)
...
<remarks>
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_CharacterSpacing(self.Ptr)
        return ret
    ...
    def CharacterSpacing(self, value:float):
        ...
        GetDllLibPdf().PdfStringFormat_set_CharacterSpacing(self.Ptr, value)
...
<remarks>Default value is 0.</remarks>
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_WordSpacing(self.Ptr)
        return ret

    @WordSpacing.setter
    def WordSpacing(self, value:float):
        GetDllLibPdf().PdfStringFormat_set_WordSpacing.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfStringFormat_set_WordSpacing(self.Ptr, value)
...
<remarks>Default value is 0.</remarks>
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_LineSpacing(self.Ptr)
        return ret

    @LineSpacing.setter
    def LineSpacing(self, value:float):
        GetDllLibPdf().PdfStringFormat_set_LineSpacing.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfStringFormat_set_LineSpacing(self.Ptr, value)
    ...
    def ClipPath(self)->bool:
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_ClipPath(self.Ptr)
        return ret

    @ClipPath.setter
    def ClipPath(self, value:bool):
        GetDllLibPdf().PdfStringFormat_set_ClipPath.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfStringFormat_set_ClipPath(self.Ptr, value)
    ...
    def SubSuperScript(self)->'PdfSubSuperScript':
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_SubSuperScript(self.Ptr)
    ...
    def SubSuperScript(self, value:'PdfSubSuperScript'):
        ...
        GetDllLibPdf().PdfStringFormat_set_SubSuperScript(self.Ptr, value.value)
    ...
    def ParagraphIndent(self)->float:
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_ParagraphIndent(self.Ptr)
        return ret
    ...
    def ParagraphIndent(self, value:float):
        ...
        GetDllLibPdf().PdfStringFormat_set_ParagraphIndent(self.Ptr, value)
    ...
    def LineLimit(self)->bool:
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_LineLimit(self.Ptr)
        return ret

    @LineLimit.setter
    def LineLimit(self, value:bool):
        GetDllLibPdf().PdfStringFormat_set_LineLimit.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfStringFormat_set_LineLimit(self.Ptr, value)
    ...
    def MeasureTrailingSpaces(self)->bool:
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_MeasureTrailingSpaces(self.Ptr)
        return ret
    ...
    def MeasureTrailingSpaces(self, value:bool):
        ...
        GetDllLibPdf().PdfStringFormat_set_MeasureTrailingSpaces(self.Ptr, value)
    ...
    def NoClip(self)->bool:
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_NoClip(self.Ptr)
        return ret

    @NoClip.setter
    def NoClip(self, value:bool):
        GetDllLibPdf().PdfStringFormat_set_NoClip.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfStringFormat_set_NoClip(self.Ptr, value)
    ...
    def WordWrap(self)->'PdfWordWrapType':
        ...
        ret = GetDllLibPdf().PdfStringFormat_get_WordWrap(self.Ptr)
    ...
    def WordWrap(self, value:'PdfWordWrapType'):
        ...
        GetDllLibPdf().PdfStringFormat_set_WordWrap(self.Ptr, value.value)
    ...
    def Clone(self)->'SpireObject':
        ...
        intPtr = GetDllLibPdf().PdfStringFormat_Clone(self.Ptr)
