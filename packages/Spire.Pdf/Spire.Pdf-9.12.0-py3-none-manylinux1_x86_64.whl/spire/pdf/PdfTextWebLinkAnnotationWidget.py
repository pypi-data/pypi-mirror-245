...
class PdfTextWebLinkAnnotationWidget(PdfStyledAnnotationWidget):
    ...
    def Url(self) -> str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfTextWebLinkAnnotationWidget_get_Url(self.Ptr))
        return ret
    ...
    def Url(self, value: str):
        ...
        GetDllLibPdf().PdfTextWebLinkAnnotationWidget_set_Url(self.Ptr, value)
    ...
    def ObjectID(self) -> int:
        ...
        ret = GetDllLibPdf().PdfTextWebLinkAnnotationWidget_ObjectID(self.Ptr)
        return ret