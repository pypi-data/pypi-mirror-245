...
class HtmlConverter (SpireObject) :
    ...
    def Password(self, value:str):
        ...
        GetDllLibPdf().HtmlConverter_set_Password(self.Ptr, value)
    ...
    def Username(self)->str:
        ...
        ret = PtrToStr(GetDllLibPdf().HtmlConverter_get_Username(self.Ptr))
        return ret
    ...
    def Username(self, value:str):
        ...
        GetDllLibPdf().HtmlConverter_set_Username(self.Ptr, value)
    ...
    def LoadHtmlTimeout(self)->int:
        ...
        ret = GetDllLibPdf().HtmlConverter_get_LoadHtmlTimeout(self.Ptr)
        return ret
    ...
    def LoadHtmlTimeout(self, value:int):
        ...
        GetDllLibPdf().HtmlConverter_set_LoadHtmlTimeout(self.Ptr, value)
    ...
    def IsWaiting(self, value:bool):
        ...
        GetDllLibPdf().HtmlConverter_set_IsWaiting(self.Ptr, value)
    ...
    def WaitingTime(self)->int:
        ...
        ret = GetDllLibPdf().HtmlConverter_get_WaitingTime(self.Ptr)
        return ret

    @WaitingTime.setter
    def WaitingTime(self, value:int):
        GetDllLibPdf().HtmlConverter_set_WaitingTime.argtypes=[c_void_p, c_int]
        GetDllLibPdf().HtmlConverter_set_WaitingTime(self.Ptr, value)
...
#        ret = GetDllLibPdf().HtmlConverter_Authenticate(self.Ptr, intPtrphwnd,intPtrpszUsername,intPtrpszPassword)
#        return ret
    ...
    def Convert(self ,url:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio)->HtmlToPdfResult:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_Convert(self.Ptr, url,enumtype,width,height,enumaspectRatio)
    ...
    def Convert(self ,html:str,baseurl:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio)->HtmlToPdfResult:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertHBTWHA(self.Ptr, html,baseurl,enumtype,width,height,enumaspectRatio)
        ret = None if intPtr==None else HtmlToPdfResult(intPtr)
        return ret
    ...
    def Convert(self ,url:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio,username:str,password:str)->HtmlToPdfResult:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertUTWHAUP(self.Ptr, url,enumtype,width,height,enumaspectRatio,username,password)
        ret = None if intPtr==None else HtmlToPdfResult(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImage(self.Ptr, url,enumtype)
    ...
    def ConvertToImage(self ,stream:Stream,encoding:Encoding,type:ImageType)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageSET(self.Ptr, intPtrstream,intPtrencoding,enumtype)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType,width:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageUTW(self.Ptr, url,enumtype,width)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,stream:Stream,encoding:Encoding,type:ImageType,width:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageSETW(self.Ptr, intPtrstream,intPtrencoding,enumtype,width)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType,width:int,height:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageUTWH(self.Ptr, url,enumtype,width,height)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType,username:str,password:str)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageUTUP(self.Ptr, url,enumtype,username,password)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,stream:Stream,encoding:Encoding,type:ImageType,width:int,height:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageSETWH(self.Ptr, intPtrstream,intPtrencoding,enumtype,width,height)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageUTWHA(self.Ptr, url,enumtype,width,height,enumaspectRatio)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType,width:int,username:str,password:str)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageUTWUP(self.Ptr, url,enumtype,width,username,password)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,stream:Stream,encoding:Encoding,type:ImageType,width:int,height:int,aspectRatio:AspectRatio)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageSETWHA(self.Ptr, intPtrstream,intPtrencoding,enumtype,width,height,enumaspectRatio)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType,width:int,height:int,username:str,password:str)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageUTWHUP(self.Ptr, url,enumtype,width,height,username,password)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def ConvertToImage(self ,url:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio,username:str,password:str)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_ConvertToImageUTWHAUP(self.Ptr, url,enumtype,width,height,enumaspectRatio,username,password)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def CustomizeDownload(self)->int:
        ...
        ret = GetDllLibPdf().HtmlConverter_CustomizeDownload(self.Ptr)
        return ret
    ...
    def FromString(self ,html:str,type:ImageType,width:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromString(self.Ptr, html,enumtype,width)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FromString(self ,html:str,baseUrl:str,type:ImageType)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromStringHBT(self.Ptr, html,baseUrl,enumtype)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FromString(self ,html:str,type:ImageType,width:int,height:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromStringHTWH(self.Ptr, html,enumtype,width,height)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FromString(self ,html:str,baseUrl:str,type:ImageType,width:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromStringHBTW(self.Ptr, html,baseUrl,enumtype,width)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FromString(self ,html:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromStringHTWHA(self.Ptr, html,enumtype,width,height,enumaspectRatio)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FromString(self ,html:str,baseUrl:str,type:ImageType,width:int,height:int)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromStringHBTWH(self.Ptr, html,baseUrl,enumtype,width,height)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FromString(self ,html:str,baseUrl:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromStringHBTWHA(self.Ptr, html,baseUrl,enumtype,width,height,enumaspectRatio)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FromString(self ,html:str,baseUrl:str,type:ImageType,width:int,height:int,aspectRatio:AspectRatio,username:str,password:str)->Image:
        ...
        intPtr = GetDllLibPdf().HtmlConverter_FromStringHBTWHAUP(self.Ptr, html,baseUrl,enumtype,width,height,enumaspectRatio,username,password)
        ret = None if intPtr==None else Image(intPtr)
        return ret
...
#        intPtrArray = GetDllLibPdf().HtmlConverter_GetImagesFromString(self.Ptr, html,baseUrl,enumtype)
...
#        ret = GetDllLibPdf().HtmlConverter_QueryService(self.Ptr, intPtrguidService,intPtrriid,intPtrppvObject)
#        return ret
    ...
    def AutoDetectPageBreak(self)->bool:
        ...
        ret = GetDllLibPdf().HtmlConverter_get_AutoDetectPageBreak(self.Ptr)
        return ret
    ...
    def AutoDetectPageBreak(self, value:bool):
        ...
        GetDllLibPdf().HtmlConverter_set_AutoDetectPageBreak(self.Ptr, value)
    ...
    def EnableBinaryBehaviors(self)->bool:
        ...
        ret = GetDllLibPdf().HtmlConverter_get_EnableBinaryBehaviors(self.Ptr)
        return ret
    ...
    def EnableBinaryBehaviors(self, value:bool):
        ...
        GetDllLibPdf().HtmlConverter_set_EnableBinaryBehaviors(self.Ptr, value)
    ...
    def EnableHyperlinks(self)->bool:
        ...
        ret = GetDllLibPdf().HtmlConverter_get_EnableHyperlinks(self.Ptr)
        return ret
    ...
    def EnableHyperlinks(self, value:bool):
        ...
        GetDllLibPdf().HtmlConverter_set_EnableHyperlinks(self.Ptr, value)
    ...
    def EnableJavaScript(self)->bool:
        ...
        ret = GetDllLibPdf().HtmlConverter_get_EnableJavaScript(self.Ptr)
        return ret
    ...
    def EnableJavaScript(self, value:bool):
        ...
        GetDllLibPdf().HtmlConverter_set_EnableJavaScript(self.Ptr, value)
    ...
    def Password(self)->str:
        ...
        ret = PtrToStr(GetDllLibPdf().HtmlConverter_get_Password(self.Ptr))
        return ret
