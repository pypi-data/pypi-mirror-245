...
class PdfPen (SpireObject) :
    ...
    def __init__(self, rgbColor:PdfRGBColor):
        ...
        intPtr = GetDllLibPdf().PdfPen_CreatePdfPenRC(ptrColor)
    ...
    def __init__(self, color:Color):
        ...
        intPtr = GetDllLibPdf().PdfPen_CreatePdfPenCoC(ptrColor)
        super(PdfPen, self).__init__(intPtr)
    ...
    def __init__(self, rgbColor:PdfRGBColor,width:float ):
        ...
        intPtr = GetDllLibPdf().PdfPen_CreatePdfPenCW(ptrColor,width)
        super(PdfPen, self).__init__(intPtr)
    ...
    def __init__(self, brush:PdfBrush):
        ...
        intPtr = GetDllLibPdf().PdfPen_CreatePdfPenB(ptrBrush)
        super(PdfPen, self).__init__(intPtr)
    ...
    def __init__(self, brush:PdfBrush,width:float ):
        ...
        intPtr = GetDllLibPdf().PdfPen_CreatePdfPenBW(ptrBrush,width)
        super(PdfPen, self).__init__(intPtr)
    ...
    def __init__(self, cmpColor:PdfComplexColor):
        ...
        intPtr = GetDllLibPdf().PdfPen_CreatePdfPenCC(ptrColor)
        super(PdfPen, self).__init__(intPtr)
    ...
    def Brush(self)->'PdfBrush':
        ...
        intPtr = GetDllLibPdf().PdfPen_get_Brush(self.Ptr)
    ...
    def Brush(self, value:'PdfBrush'):
        ...
        GetDllLibPdf().PdfPen_set_Brush(self.Ptr, value.Ptr)
    ...
    def Color(self)->'PdfRGBColor':
        ...
        intPtr = GetDllLibPdf().PdfPen_get_Color(self.Ptr)
    ...
    def Color(self, value:'PdfRGBColor'):
        ...
        GetDllLibPdf().PdfPen_set_Color(self.Ptr, value.Ptr)
    ...
    def DashOffset(self)->float:
        ...
        ret = GetDllLibPdf().PdfPen_get_DashOffset(self.Ptr)
        return ret

    @DashOffset.setter
    def DashOffset(self, value:float):
        GetDllLibPdf().PdfPen_set_DashOffset.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfPen_set_DashOffset(self.Ptr, value)
    ...
    def DashPattern(self)->List[float]:
        ...
        intPtrArray = GetDllLibPdf().PdfPen_get_DashPattern(self.Ptr)
    ...
    def DashPattern(self, value:List[float]):
        ...
        GetDllLibPdf().PdfPen_set_DashPattern(self.Ptr, vArray, vCount)
    ...
    def DashStyle(self)->'PdfDashStyle':
        ...
        ret = GetDllLibPdf().PdfPen_get_DashStyle(self.Ptr)
    ...
    def DashStyle(self, value:'PdfDashStyle'):
        ...
        GetDllLibPdf().PdfPen_set_DashStyle(self.Ptr, value.value)
    ...
    def LineCap(self)->'PdfLineCap':
        ...
        ret = GetDllLibPdf().PdfPen_get_LineCap(self.Ptr)
    ...
    def LineCap(self, value:'PdfLineCap'):
        ...
        GetDllLibPdf().PdfPen_set_LineCap(self.Ptr, value.value)
    ...
    def LineJoin(self)->'PdfLineJoin':
        ...
        ret = GetDllLibPdf().PdfPen_get_LineJoin(self.Ptr)
    ...
    def LineJoin(self, value:'PdfLineJoin'):
        ...
        GetDllLibPdf().PdfPen_set_LineJoin(self.Ptr, value.value)
    ...
    def Width(self)->float:
        ...
        ret = GetDllLibPdf().PdfPen_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPdf().PdfPen_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfPen_set_Width(self.Ptr, value)
    ...
    def MiterLimit(self)->float:
        ...
        ret = GetDllLibPdf().PdfPen_get_MiterLimit(self.Ptr)
        return ret

    @MiterLimit.setter
    def MiterLimit(self, value:float):
        GetDllLibPdf().PdfPen_set_MiterLimit.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfPen_set_MiterLimit(self.Ptr, value)
    ...
    def Clone(self)->'PdfPen':
        ...
        intPtr = GetDllLibPdf().PdfPen_Clone(self.Ptr)
