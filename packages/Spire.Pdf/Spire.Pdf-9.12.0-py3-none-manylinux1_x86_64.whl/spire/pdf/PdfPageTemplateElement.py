...
class PdfPageTemplateElement (SpireObject) :
    ...
    def __init__(self, bounds:RectangleF):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementB(ptrBounds)
    ...
    def __init__(self, bounds:RectangleF,page):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementBP(ptrBounds,ptrPage)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    @dispatch
    def __init__(self, location:PointF,size:SizeF):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementLS(ptrPoint,ptrSize)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    @dispatch
    def __init__(self, location:PointF,size:SizeF,page):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementLSP(ptrPoint,ptrSize,ptrPage)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    @dispatch
    def __init__(self, size:SizeF):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementS(ptrSize)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    @dispatch
    def __init__(self, width:float,height:float):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementWH(width,height)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    @dispatch
    def __init__(self, width:float,height:float,page):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementWHP(width,height,ptrPage)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    @dispatch
    def __init__(self, x:float,y:float,width:float,height:float):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementXYWH(x,y,width,height)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    @dispatch
    def __init__(self, x:float,y:float,width:float,height:float,page):
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_CreatePdfPageTemplateElementXYWHP(x,y,width,height,ptrPage)
        super(PdfPageTemplateElement, self).__init__(intPtr)
    ...
    def Dock(self)->'PdfDockStyle':
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_Dock(self.Ptr)
    ...
    def Dock(self, value:'PdfDockStyle'):
        ...
        GetDllLibPdf().PdfPageTemplateElement_set_Dock(self.Ptr, value.value)
    ...
    def Alignment(self)->'PdfAlignmentStyle':
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'PdfAlignmentStyle'):
        ...
        GetDllLibPdf().PdfPageTemplateElement_set_Alignment(self.Ptr, value.value)
    ...
    def Foreground(self)->bool:
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_Foreground(self.Ptr)
        return ret

    @Foreground.setter
    def Foreground(self, value:bool):
        GetDllLibPdf().PdfPageTemplateElement_set_Foreground.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfPageTemplateElement_set_Foreground(self.Ptr, value)
    ...
    def Background(self)->bool:
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_Background(self.Ptr)
        return ret

    @Background.setter
    def Background(self, value:bool):
        GetDllLibPdf().PdfPageTemplateElement_set_Background.argtypes=[c_void_p, c_bool]
        GetDllLibPdf().PdfPageTemplateElement_set_Background(self.Ptr, value)
    ...
    def Location(self)->'PointF':
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_get_Location(self.Ptr)
    ...
    def Location(self, value:'PointF'):
        ...
        GetDllLibPdf().PdfPageTemplateElement_set_Location(self.Ptr, value.Ptr)
    ...
    def X(self)->float:
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:float):
        GetDllLibPdf().PdfPageTemplateElement_set_X.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfPageTemplateElement_set_X(self.Ptr, value)
    ...
    def Y(self)->float:
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:float):
        GetDllLibPdf().PdfPageTemplateElement_set_Y.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfPageTemplateElement_set_Y(self.Ptr, value)
    ...
    def Size(self)->'SizeF':
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_get_Size(self.Ptr)
    ...
    def Size(self, value:'SizeF'):
        ...
        GetDllLibPdf().PdfPageTemplateElement_set_Size(self.Ptr, value.Ptr)
    ...
    def Width(self)->float:
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPdf().PdfPageTemplateElement_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfPageTemplateElement_set_Width(self.Ptr, value)
    ...
    def Height(self)->float:
        ...
        ret = GetDllLibPdf().PdfPageTemplateElement_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPdf().PdfPageTemplateElement_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPdf().PdfPageTemplateElement_set_Height(self.Ptr, value)
    ...
    def Bounds(self)->'RectangleF':
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_get_Bounds(self.Ptr)
    ...
    def Bounds(self, value:'RectangleF'):
        ...
        GetDllLibPdf().PdfPageTemplateElement_set_Bounds(self.Ptr, value.Ptr)
    ...
    def Graphics(self)->'PdfCanvas':
        ...
        intPtr = GetDllLibPdf().PdfPageTemplateElement_get_Graphics(self.Ptr)
