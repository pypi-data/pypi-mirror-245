...
class PdfJavaScriptAction(PdfAction):
    ...
    def __init__(self, javaScript: str):
        ...
        intPtr = GetDllLibPdf().PdfJavaScriptAction_CreatePdfJavaScriptActionJ(javaScript)
    ...
    def Script(self) -> str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfJavaScriptAction_get_Script(self.Ptr))
        return ret
    ...
    def Script(self, value: str):
        ...
        GetDllLibPdf().PdfJavaScriptAction_set_Script(self.Ptr, value)