...
class PdfStandardStructTypes (SpireObject) :
    ...
    def Document()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Document())
        return ret
    ...
    def Part()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Part())
        return ret
    ...
    def Article()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Article())
        return ret
    ...
    def Section()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Section())
        return ret
    ...
    def Division()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Division())
        return ret
    ...
    def BlockQuote()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_BlockQuote())
        return ret
    ...
    def Caption()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Caption())
        return ret
    ...
    def TOC()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TOC())
        return ret
    ...
    def TOCI()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TOCI())
        return ret
    ...
    def Index()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Index())
        return ret
    ...
    def NonStruct()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_NonStruct())
        return ret
    ...
    def Private()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Private())
        return ret
    ...
    def Heading()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Heading())
        return ret
    ...
    def HeadingLevel1()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_HeadingLevel1())
        return ret
    ...
    def HeadingLevel2()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_HeadingLevel2())
        return ret
    ...
    def HeadingLevel3()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_HeadingLevel3())
        return ret
    ...
    def HeadingLevel4()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_HeadingLevel4())
        return ret
    ...
    def HeadingLevel5()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_HeadingLevel5())
        return ret
    ...
    def HeadingLevel6()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_HeadingLevel6())
        return ret
    ...
    def Paragraph()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Paragraph())
        return ret
    ...
    def List()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_List())
        return ret
    ...
    def ListItem()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_ListItem())
        return ret
    ...
    def Label()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Label())
        return ret
    ...
    def ListBody()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_ListBody())
        return ret
    ...
    def Table()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Table())
        return ret
    ...
    def TableRow()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TableRow())
        return ret
    ...
    def TableHeaderCell()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TableHeaderCell())
        return ret
    ...
    def TableDataCell()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TableDataCell())
        return ret
    ...
    def TableHeader()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TableHeader())
        return ret
    ...
    def TableBody()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TableBody())
        return ret
    ...
    def TableFooter()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_TableFooter())
        return ret
    ...
    def Span()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Span())
        return ret
    ...
    def Quotation()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Quotation())
        return ret
    ...
    def Note()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Note())
        return ret
    ...
    def Reference()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Reference())
        return ret
    ...
    def BibEntry()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_BibEntry())
        return ret
    ...
    def Code()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Code())
        return ret
    ...
    def Link()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Link())
        return ret
    ...
    def Annotation()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Annotation())
        return ret
    ...
    def Ruby()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Ruby())
        return ret
    ...
    def RB()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_RB())
        return ret
    ...
    def RT()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_RT())
        return ret
    ...
    def RP()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_RP())
        return ret
    ...
    def Warichu()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Warichu())
        return ret
    ...
    def WT()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_WT())
        return ret
    ...
    def WP()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_WP())
        return ret
    ...
    def Figure()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Figure())
        return ret
    ...
    def Form()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Form())
        return ret
    ...
    def Formula()->str:
        ...
        ret = PtrToStr(GetDllLibPdf().PdfStandardStructTypes_Formula())
        return ret
