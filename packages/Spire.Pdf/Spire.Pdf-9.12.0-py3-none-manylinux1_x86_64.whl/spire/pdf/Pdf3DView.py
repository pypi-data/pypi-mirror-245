...
class Pdf3DView(SpireObject):
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPdf().Pdf3DView_CreatePdf3DView()
    ...
    def Background(self) -> 'Pdf3DBackground':
        ...
        intPtr = GetDllLibPdf().Pdf3DView_get_Background(self.Ptr)
    ...
    def Background(self, value: 'Pdf3DBackground'):
        ...
        GetDllLibPdf().Pdf3DView_set_Background(self.Ptr, value.Ptr)
    ...
    def CameraToWorldMatrix(self) -> List[float]:
        ...
        intPtrArray = GetDllLibPdf().Pdf3DView_get_CameraToWorldMatrix(self.Ptr)
    ...
    def CameraToWorldMatrix(self, value: List[float]):
        ...
        GetDllLibPdf().Pdf3DView_set_CameraToWorldMatrix(self.Ptr, vArray, vCount)
    ...
    def CrossSections(self) -> 'Pdf3DCrossSectionCollection':
        ...
        intPtr = GetDllLibPdf().Pdf3DView_get_CrossSections(self.Ptr)
    ...
    def ExternalName(self) -> str:
        ...
        ret = PtrToStr(GetDllLibPdf().Pdf3DView_get_ExternalName(self.Ptr))
        return ret

    @ExternalName.setter
    def ExternalName(self, value: str):
        GetDllLibPdf().Pdf3DView_set_ExternalName.argtypes = [c_void_p, c_wchar_p]
        GetDllLibPdf().Pdf3DView_set_ExternalName(self.Ptr, value)
    ...
    def InternalName(self) -> str:
        ...
        ret = PtrToStr(GetDllLibPdf().Pdf3DView_get_InternalName(self.Ptr))
        return ret

    @InternalName.setter
    def InternalName(self, value: str):
        GetDllLibPdf().Pdf3DView_set_InternalName.argtypes = [c_void_p, c_wchar_p]
        GetDllLibPdf().Pdf3DView_set_InternalName(self.Ptr, value)
    ...
    def LightingScheme(self) -> 'Pdf3DLighting':
        ...
        intPtr = GetDllLibPdf().Pdf3DView_get_LightingScheme(self.Ptr)
    ...
    def LightingScheme(self, value: 'Pdf3DLighting'):
        ...
        GetDllLibPdf().Pdf3DView_set_LightingScheme(self.Ptr, value.Ptr)
    ...
    def Nodes(self) -> 'Pdf3DNodeCollection':
        ...
        intPtr = GetDllLibPdf().Pdf3DView_get_Nodes(self.Ptr)
    ...
    def Projection(self) -> 'Pdf3DProjection':
        ...
        intPtr = GetDllLibPdf().Pdf3DView_get_Projection(self.Ptr)
    ...
    def Projection(self, value:'Pdf3DProjection'):
        ...
        GetDllLibPdf().Pdf3DView_set_Projection(self.Ptr, value.Ptr)
    ...
    def RenderMode(self)->'Pdf3DRendermode':
        ...
        intPtr = GetDllLibPdf().Pdf3DView_get_RenderMode(self.Ptr)
    ...
    def RenderMode(self, value:'Pdf3DRendermode'):
        ...
        GetDllLibPdf().Pdf3DView_set_RenderMode(self.Ptr, value.Ptr)
    ...
    def ResetNodesState(self)->bool:
        ...
        ret = GetDllLibPdf().Pdf3DView_get_ResetNodesState(self.Ptr)
        return ret
    ...
    def ResetNodesState(self, value:bool):
        ...
        GetDllLibPdf().Pdf3DView_set_ResetNodesState(self.Ptr, value)
    ...
    def ViewNodeName(self)->str:
        ...
        ret = PtrToStr(GetDllLibPdf().Pdf3DView_get_ViewNodeName(self.Ptr))
        return ret
    ...
    def ViewNodeName(self, value:str):
        ...
        GetDllLibPdf().Pdf3DView_set_ViewNodeName(self.Ptr, value)