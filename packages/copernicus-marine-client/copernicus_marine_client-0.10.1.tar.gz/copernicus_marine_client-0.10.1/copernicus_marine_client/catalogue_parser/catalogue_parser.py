        ...
        for dataset in product.datasets:
            if dataset_id == dataset.dataset_id:
                if force_dataset_version_label:
                    ...
                    logger.info(
                        f'Selected dataset version is "{dataset_version.label}"'
                    )
                dataset_part = dataset_version.get_part_by_name(part_name)
...
def get_dataset_and_suffix_path_from_url(
    ...
    return next_or_raise_exception(
        (
            ...
            for product in catalogue.products
            for dataset in product.datasets
            for service in dataset.get_latest_version_or_raise()
