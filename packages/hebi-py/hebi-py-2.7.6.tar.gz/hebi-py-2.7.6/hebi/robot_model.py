...
class RobotModel(UnmanagedObject):
  ...
  def __update_cached_frame_counts(self):
    ...
    new_com_count = api.hebiRobotModelGetNumberOfFrames(self, enums.FrameTypeCenterOfMass.value)
    self._frame_count_map[enums.FrameTypeCenterOfMass] = new_com_count
    self._frame_count_map[enums.FrameTypeOutput] = api.hebiRobotModelGetNumberOfFrames(self, enums.FrameTypeOutput.value)
    self._frame_count_map[enums.FrameTypeEndEffector] = api.hebiRobotModelGetNumberOfFrames(self, enums.FrameTypeEndEffector.value)
...
class PositionObjective(_ObjectiveBase):
  def __init__(self, frame_type: str, *, xyz: 'npt.NDArray[np.float64]', idx: int = 0, weight: float = 1.0):
    ...
    super(PositionObjective, self).__init__(impl)
...
class SO3Objective(_ObjectiveBase):
  def __init__(self, frame_type: str, *, rotation: 'npt.NDArray[np.float64]', idx: int = 0, weight: float = 1.0):
    ...
    super(SO3Objective, self).__init__(impl)
...
class TipAxisObjective(_ObjectiveBase):
  def __init__(self, frame_type: str, *, axis: 'npt.NDArray[np.float64]', idx: int = 0, weight: float = 1.0):
    ...
    super(TipAxisObjective, self).__init__(impl)
...
def joint_limit_constraint(minimum: 'VectorType', maximum: 'VectorType', weight: float = 1.0):
  ...
  class JointLimitConstraint(_ObjectiveBase):
    def __init__(self, minimum, maximum, weight):
      ...
      super(JointLimitConstraint, self).__init__(impl)
...
def custom_objective(num_errors, func, user_data=None, weight=1.0):
  ...
  class CustomObjective(_ObjectiveBase):
    ...
    def __init__(self, num_errors: int, func: 'Callable', user_data, weight):
      ...
      super(CustomObjective, self).__init__(impl)
