...
class dataHelper():
    ...
    def build_6city(self):
        ...
        if self.city in NYC:
            self.G = gt.load_graph("/lab/kiran/beoenv/beogym/nyc.gt")
            self.Gdict = pickle.load(open('/lab/kiran/beoenv/beogym/nycgraph.pkl', 'rb'))
            self.Greversed={value: key for key, value in self.Gdict.items()}
        elif self.city in Pits:
            self.G = gt.load_graph("/lab/kiran/beoenv/beogym/pits.gt")
            self.Gdict = pickle.load(open('/lab/kiran/beoenv/beogym/pitsgraph.pkl', 'rb'))
            self.Greversed={value: key for key, value in self.Gdict.items()}
        elif 'navigation' in self.city:
            self.G = gt.load_graph("/lab/kiran/beoenv/beogym/tcd.gt")
            self.Gdict = pickle.load(open('/lab/kiran/beoenv/beogym/tcdgraph.pkl', 'rb'))
            self.Greversed={value: key for key, value in self.Gdict.items()}
            task = self.city.replace('navigation','')
            with open ('/lab/kiran/beoenv/skillset1.json', 'r') as f:
    ...
    def read_routes(self, csv_file="/lab/kiran/beoenv/beogym/data/pano_gps.csv"):
