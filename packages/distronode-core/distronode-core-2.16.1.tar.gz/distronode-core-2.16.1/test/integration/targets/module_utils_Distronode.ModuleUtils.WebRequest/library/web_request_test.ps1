...
$tests = [Ordered]@{
    'GET request over http' = {
        $r = Get-DistronodeWebRequest -Uri "http://$httpbin_host/get"
        ...
        $r.UserAgent | Assert-Equal -Expected 'distronode-httpget'
        ...
        $actual.headers.'User-Agent' | Assert-Equal -Expected 'distronode-httpget'
    ...
    'GET request over https' = {
        ...
        $r = Get-DistronodeWebRequest -url "https://$httpbin_host/get"
    ...
    'POST request' = {
        ...
        $r = Get-DistronodeWebRequest @getParams
    ...
    'Safe redirection of GET' = {
        $r = Get-DistronodeWebRequest -Uri "http://$httpbin_host/redirect/2"
    ...
    'Safe redirection of HEAD' = {
        $r = Get-DistronodeWebRequest -Uri "http://$httpbin_host/redirect/2" -Method HEAD
    ...
    'Safe redirection of PUT' = {
        ...
        $r = Get-DistronodeWebRequest @params
    ...
    'Request with file URI' = {
        ...
        $r = Get-DistronodeWebRequest -Uri $filePath
    ...
    'Web request based on module options' = {
        ...
        $testModule = [Distronode.Basic.DistronodeModule]::Create(@(), $spec, @(Get-DistronodeWebRequestSpec))
        $r = Get-DistronodeWebRequest -Url $testModule.Params.url -Module $testModule
