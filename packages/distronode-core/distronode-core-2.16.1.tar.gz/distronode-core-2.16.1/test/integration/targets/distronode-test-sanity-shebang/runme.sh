...
(
  cd distronode_collections/ns/col/scripts
...
mkdir distronode_collections/ns/col/examples

(
  cd distronode_collections/ns/col/examples
...
distronode-test sanity --test shebang --color --lint --failure-ok "${@}" > actual.txt
