...
Function Test-LocalCredential {
    ...
    try {
        $handle = [Distronode.AccessToken.TokenUtil]::LogonUser($Username, $null, $Password, "Network", "Default")
        $handle.Dispose()
...
$username = Get-DistronodeParam -obj $params -name "name" -type "str" -failifempty $true
$fullname = Get-DistronodeParam -obj $params -name "fullname" -type "str"
$description = Get-DistronodeParam -obj $params -name "description" -type "str"
$password = Get-DistronodeParam -obj $params -name "password" -type "str"
$state = Get-DistronodeParam -obj $params -name "state" -type "str" -default "present" -validateset "present","absent","query"
$update_password = Get-DistronodeParam -obj $params -name "update_password" -type "str" -default "always" -validateset "always","on_create"
$password_expired = Get-DistronodeParam -obj $params -name "password_expired" -type "bool"
$password_never_expires = Get-DistronodeParam -obj $params -name "password_never_expires" -type "bool"
$user_cannot_change_password = Get-DistronodeParam -obj $params -name "user_cannot_change_password" -type "bool"
$account_disabled = Get-DistronodeParam -obj $params -name "account_disabled" -type "bool"
$account_locked = Get-DistronodeParam -obj $params -name "account_locked" -type "bool"
$groups = Get-DistronodeParam -obj $params -name "groups"
$groups_action = Get-DistronodeParam -obj $params -name "groups_action" -type "str" -default "replace" -validateset "add","remove","replace"
