...
class ContentLayout(Layout):
    """Information about the current Distronode content being tested."""
    ...
    def __init__(
        ...
        self.is_distronode = root == DISTRONODE_SOURCE_ROOT
...
class CollectionDetail:
    ...
    def __init__(
        ...
        self.directory = os.path.join('distronode_collections', namespace, name)
...
class LayoutProvider(PathProvider):
    ...
    PLUGIN_TYPES = (
        ...
        'test',
        'vars',
        # The following are plugin directories not directly supported by distronode-core, but used in collections
        # (https://github.com/distronode-collections/overview/blob/main/collection_requirements.rst#modules--plugins)
        'plugin_utils',
        'sub_plugins',
    )
