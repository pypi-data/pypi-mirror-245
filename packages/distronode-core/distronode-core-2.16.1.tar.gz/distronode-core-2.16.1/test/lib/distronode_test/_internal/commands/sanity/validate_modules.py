...
class ValidateModulesTest(SanitySingleVersion):
    ...
    def __init__(self) -> None:
        ...
        if not data_context().content.collection:
            self._exclusions.add('lib/distronode/plugins/cache/base.py')
    ...
    def origin_hook(self, args: SanityConfig) -> None:
        ...
        if not data_context().content.is_distronode:
            return
        ...
        git = Git()
        git.run_git(['archive', '--output', path, base_commit, 'lib/distronode/modules/', 'lib/distronode/plugins/'])
