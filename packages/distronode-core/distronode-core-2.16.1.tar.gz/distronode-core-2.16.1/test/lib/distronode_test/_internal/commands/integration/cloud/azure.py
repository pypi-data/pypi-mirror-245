...
class AzureCloudProvider(CloudProvider):
    ...
    def __init__(self, args: IntegrationConfig) -> None:
        ...
        self.aci: t.Optional[DistronodeCoreCI] = None
    ...
    def _setup_dynamic(self) -> None:
        """Request Azure credentials through distronode-core-ci."""
    ...
    def _create_distronode_core_ci(self) -> DistronodeCoreCI:
        """Return an Azure instance of DistronodeCoreCI."""
        return DistronodeCoreCI(self.args, CloudResource(platform='azure'))
