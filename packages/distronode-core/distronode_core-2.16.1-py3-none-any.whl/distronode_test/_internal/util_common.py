...
def get_docs_url(url: str) -> str:
    """
    Return the given distronode.khulnasoft.com/docs URL updated to match the running distronode-test version, if it is not a pre-release version.
    The URL should be in the form: https://distronode.khulnasoft.com/docs/distronode/devel/path/to/doc.html
    ...
    """
    url_prefix = 'https://distronode.khulnasoft.com/docs/distronode-core/devel/'
    ...
    if re.search(r'^[0-9.]+$', distronode_version):
        ...
        new_prefix = f'https://distronode.khulnasoft.com/docs/distronode-core/{url_version}/'
