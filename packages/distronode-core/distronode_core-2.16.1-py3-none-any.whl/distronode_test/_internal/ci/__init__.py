...
class AuthHelper(metaclass=abc.ABCMeta):
    """Public key based authentication helper for Distronode Core CI."""
    ...
    def initialize_private_key(self) -> str:
        ...
        The private key is cached across distronode-test invocations, so it is only generated and published once per CI job.
        """
        path = os.path.expanduser('~/.distronode-core-ci-private.key')
...
class CryptographyAuthHelper(AuthHelper, metaclass=abc.ABCMeta):
    """Cryptography based public key based authentication helper for Distronode Core CI."""
...
class OpenSSLAuthHelper(AuthHelper, metaclass=abc.ABCMeta):
    """OpenSSL based public key based authentication helper for Distronode Core CI."""
