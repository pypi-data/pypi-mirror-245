...
def print_bs_labels(row, bs_type='info', cb=escape, show_keys=None, i18n=None):
    ...
    return mark_safe(
        tpl.PrintList(
            ...
            tpl_kwargs={'attrs': {'class': 'badge bg-' + bs_type + ' fs-6 preformatted'}},
            cb=cb,
            show_keys=show_keys,
            i18n=i18n
        ).nested(row)
...
def print_bs_badges(row, cb=escape, show_keys=None, i18n=None):
    ...
    return mark_safe(
        tpl.PrintList(
            ...
            tpl_kwargs={
                'attrs': {'class': "badge bg-info fs-6 preformatted"},
                'k_attrs': {'class': "badge bg-primary text-white preformatted"}
            },
            cb=cb,
            show_keys=show_keys,
            i18n=i18n
...
def print_bs_well(row, cb=escape, show_keys=None, i18n=None):
    ...
    return mark_safe(
        tpl.PrintList(
            ...
            tpl_kwargs={
                'attrs': {'class': "badge bg-info fs-6 text-start preformatted"},
                'k_attrs': {'class': "badge bg-secondary fs-6 text-start preformatted"}
            },
            cb=cb,
            show_keys=show_keys,
            i18n=i18n
    ...
    return mark_safe(
        tpl.PrintList(
            ...
            tpl_kwargs={
                ...
                'k_attrs': {'class': "badge bg-info float-right preformatted"},
            },
            cb=cb,
            show_keys=show_keys,
            i18n=i18n
