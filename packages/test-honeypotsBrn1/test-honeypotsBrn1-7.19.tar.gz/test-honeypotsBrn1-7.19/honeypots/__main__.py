                        ...
                        if config_data['sniffer_interface'] in current_interfaces:
                            ...
                            try:
                                ...
                                if netifaces.AF_INET in addresses:
                                    ...
                                    print("[x] Your IP: {}".format(ip_address))
                                else:
                                    print("[!] Error: No se encontró una dirección IP para la interfaz {}".format(interface_name))

                                if netifaces.AF_LINK in addresses:
                                    mac_address = addresses[netifaces.AF_LINK][0]['addr']
                                    print('[x] Your MAC: {}'.format(mac_address))
                                else:
                                    print("[!] Error: No se encontró una dirección MAC para la interfaz {}".format(interface_name))

                            except KeyError:
                                print("[!] Error: No se encontró una dirección IP o MAC para la interfaz {}".format(interface_name))
