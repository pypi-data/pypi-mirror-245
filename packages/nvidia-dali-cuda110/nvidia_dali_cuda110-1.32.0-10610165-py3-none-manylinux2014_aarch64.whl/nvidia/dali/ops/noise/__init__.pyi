...
class SaltAndPepper:
    ...
    def __init__(
        ...
        *,
        bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
        pepper_val: Union[DataNode, float, None] = None,
        per_channel: Union[bool, None] = False,
        preserve: Union[bool, None] = False,
        prob: Union[DataNode, float, None] = 0.05,
        salt_val: Union[DataNode, float, None] = None,
        salt_vs_pepper: Union[DataNode, float, None] = 0.5,
        seed: Union[int, None] = -1,
        device: Union[str, None] = None,
        name: Union[str, None] = None,
    ) -> None: ...
...
class Shot:
    ...
    def __init__(
        ...
        *,
        bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
        factor: Union[DataNode, float, None] = 20.0,
        preserve: Union[bool, None] = False,
        seed: Union[int, None] = -1,
        device: Union[str, None] = None,
        name: Union[str, None] = None,
