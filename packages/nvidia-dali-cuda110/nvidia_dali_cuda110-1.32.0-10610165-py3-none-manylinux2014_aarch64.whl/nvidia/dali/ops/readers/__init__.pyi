...
class Numpy:
    ...
    def __init__(
        ...
        *,
        ...
        rel_roi_end: Union[DataNode, Sequence[float], float, None] = None,
        rel_roi_shape: Union[DataNode, Sequence[float], float, None] = None,
        rel_roi_start: Union[DataNode, Sequence[float], float, None] = None,
        roi_axes: Union[Sequence[int], int, None] = [],
        roi_end: Union[DataNode, Sequence[int], int, None] = None,
        roi_shape: Union[DataNode, Sequence[int], int, None] = None,
        roi_start: Union[DataNode, Sequence[int], int, None] = None,
        seed: Union[int, None] = -1,
        shard_id: Union[int, None] = 0,
        shuffle_after_epoch: Union[bool, None] = False,
        skip_cached_images: Union[bool, None] = False,
...
class VideoResize:
    ...
    def __init__(
        ...
        *,
        ...
        random_shuffle: Union[bool, None] = False,
        read_ahead: Union[bool, None] = False,
        resize_longer: Union[DataNode, float, None] = 0.0,
        resize_shorter: Union[DataNode, float, None] = 0.0,
        resize_x: Union[DataNode, float, None] = 0.0,
        resize_y: Union[DataNode, float, None] = 0.0,
        resize_z: Union[DataNode, float, None] = 0.0,
        ...
        seed: Union[int, None] = -1,
        shard_id: Union[int, None] = 0,
        size: Union[DataNode, Sequence[float], float, None] = None,
        skip_cached_images: Union[bool, None] = False,
        skip_vfr_check: Union[bool, None] = False,
        step: Union[int, None] = -1,
        stick_to_shard: Union[bool, None] = False,
