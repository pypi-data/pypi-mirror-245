...
def audio(
    ...
    *,
    ...
    sample_rate: Union[DataNode, float, None] = 0.0,
...
def image_crop(
    ...
    *,
    affine: Union[bool, None] = True,
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    crop: Union[DataNode, Sequence[float], float, None] = None,
    crop_d: Union[DataNode, float, None] = 0.0,
    crop_h: Union[DataNode, float, None] = 0.0,
    crop_pos_x: Union[DataNode, float, None] = 0.5,
    crop_pos_y: Union[DataNode, float, None] = 0.5,
    crop_pos_z: Union[DataNode, float, None] = 0.5,
    crop_w: Union[DataNode, float, None] = 0.0,
    device_memory_padding: Union[int, None] = 16777216,
    device_memory_padding_jpeg2k: Union[int, None] = 0,
    host_memory_padding: Union[int, None] = 8388608,
    host_memory_padding_jpeg2k: Union[int, None] = 0,
...
def image_slice(
    __data: DataNode,
    __anchor: Union[DataNode, None] = None,
    __shape: Union[DataNode, None] = None,
    /,
    *,
    affine: Union[bool, None] = True,
    axes: Union[DataNode, Sequence[int], int, None] = [1, 0],
    axis_names: Union[str, None] = "WH",
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    device_memory_padding: Union[int, None] = 16777216,
    device_memory_padding_jpeg2k: Union[int, None] = 0,
    end: Union[DataNode, Sequence[int], int, None] = None,
    host_memory_padding: Union[int, None] = 8388608,
    host_memory_padding_jpeg2k: Union[int, None] = 0,
    hw_decoder_load: Union[float, None] = 0.65,
    hybrid_huffman_threshold: Union[int, None] = 1000000,
    ...
    preallocate_width_hint: Union[int, None] = 0,
    preserve: Union[bool, None] = False,
    rel_end: Union[DataNode, Sequence[float], float, None] = None,
    rel_shape: Union[DataNode, Sequence[float], float, None] = None,
    rel_start: Union[DataNode, Sequence[float], float, None] = None,
    seed: Union[int, None] = -1,
    shape: Union[DataNode, Sequence[int], int, None] = None,
    start: Union[DataNode, Sequence[int], int, None] = None,
    use_fast_idct: Union[bool, None] = False,
    device: Union[str, None] = None,
    name: Union[str, None] = None,
) -> DataNode:
