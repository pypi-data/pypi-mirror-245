...
class RandomMaskPixel:
    ...
    def __init__(
        ...
        *,
        ...
        foreground: Union[DataNode, int, None] = 0,
        preserve: Union[bool, None] = False,
        seed: Union[int, None] = -1,
        threshold: Union[DataNode, float, None] = 0.0,
        value: Union[DataNode, int, None] = None,
...
class RandomObjectBBox:
    ...
    def __init__(
        ...
        /,
        *,
        background: Union[DataNode, int, None] = 0,
        bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
        cache_objects: Union[bool, None] = False,
        class_weights: Union[DataNode, Sequence[float], float, None] = None,
        classes: Union[DataNode, Sequence[int], int, None] = None,
        foreground_prob: Union[DataNode, float, None] = 1.0,
        ...
        preserve: Union[bool, None] = False,
        seed: Union[int, None] = -1,
        threshold: Union[DataNode, Sequence[int], int, None] = None,
        device: Union[str, None] = None,
        name: Union[str, None] = None,
    ) -> None: ...
    def __call__(
