...
def combine(
    *input: DataNode,
    ...
    `input1` : TensorList
        Input to the operator.
    `input[2..98]` : TensorList, optional
...
def crop(
    __input_0: Union[DataNode, None] = None,
    /,
    *,
    absolute: Union[bool, None] = False,
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    from_end: Union[DataNode, Sequence[float], float, None] = [1.0],
    from_start: Union[DataNode, Sequence[float], float, None] = [0.0],
    preserve: Union[bool, None] = False,
    reverse_order: Union[bool, None] = False,
    seed: Union[int, None] = -1,
    to_end: Union[DataNode, Sequence[float], float, None] = [1.0],
    to_start: Union[DataNode, Sequence[float], float, None] = [0.0],
    device: Union[str, None] = None,
    name: Union[str, None] = None,
) -> DataNode:
    """
...
def rotation(
    ...
    /,
    *,
    angle: Union[DataNode, float],
    axis: Union[DataNode, Sequence[float], float, None] = None,
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    center: Union[DataNode, Sequence[float], float, None] = None,
    preserve: Union[bool, None] = False,
    reverse_order: Union[bool, None] = False,
    seed: Union[int, None] = -1,
    device: Union[str, None] = None,
...
def scale(
    ...
    /,
    *,
    scale: Union[DataNode, Sequence[float], float],
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    center: Union[DataNode, Sequence[float], float, None] = None,
...
def shear(
    ...
    /,
    *,
    angles: Union[DataNode, Sequence[float], float, None] = None,
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    center: Union[DataNode, Sequence[float], float, None] = None,
    preserve: Union[bool, None] = False,
    reverse_order: Union[bool, None] = False,
    seed: Union[int, None] = -1,
    shear: Union[DataNode, Sequence[float], float, None] = None,
    device: Union[str, None] = None,
    name: Union[str, None] = None,
) -> DataNode:
    """
...
def translation(
    ...
    /,
    *,
    offset: Union[DataNode, Sequence[float], float],
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    preserve: Union[bool, None] = False,
    reverse_order: Union[bool, None] = False,
    seed: Union[int, None] = -1,
