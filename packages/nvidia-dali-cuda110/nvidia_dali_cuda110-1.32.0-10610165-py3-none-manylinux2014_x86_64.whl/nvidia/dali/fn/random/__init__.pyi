...
def coin_flip(
    ...
    *,
    ...
    probability: Union[DataNode, float, None] = 0.5,
...
def normal(
    ...
    *,
    bytes_per_sample_hint: Union[Sequence[int], int, None] = [0],
    dtype: Union[DALIDataType, None] = None,
    mean: Union[DataNode, float, None] = 0.0,
    preserve: Union[bool, None] = False,
    seed: Union[int, None] = -1,
    shape: Union[DataNode, Sequence[int], int, None] = None,
    stddev: Union[DataNode, float, None] = 1.0,
    device: Union[str, None] = None,
    name: Union[str, None] = None,
) -> DataNode:
    """
...
def uniform(
    ...
    *,
    ...
    dtype: Union[DALIDataType, None] = None,
    preserve: Union[bool, None] = False,
    range: Union[DataNode, Sequence[float], float, None] = [-1.0, 1.0],
    seed: Union[int, None] = -1,
    shape: Union[DataNode, Sequence[int], int, None] = None,
    values: Union[DataNode, Sequence[float], float, None] = None,
    device: Union[str, None] = None,
    name: Union[str, None] = None,
) -> DataNode:
    """
