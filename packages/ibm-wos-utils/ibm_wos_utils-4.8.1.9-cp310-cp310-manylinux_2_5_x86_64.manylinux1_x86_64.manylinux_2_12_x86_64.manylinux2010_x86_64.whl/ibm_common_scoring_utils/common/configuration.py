...
class Configuration():
    """
        ...
        Foundation Models:
        {
            ...
            "PROMPT_SCORING_RETRY_SLEEP_INTERVAL": <No. of seconds to sleep between retry attempts mentioned above.>,
    ...
    def __init__(self,configuration:dict):
        ...
        # Setting the prompt scoring retry variables
        self.max_prompt_scoring_retry_count = configuration.get("MAX_PROMPT_SCORING_RETRY_COUNT", 50)
        self.prompt_scoring_retry_sleep_interval = configuration.get("PROMPT_SCORING_RETRY_SLEEP_INTERVAL", 5)
