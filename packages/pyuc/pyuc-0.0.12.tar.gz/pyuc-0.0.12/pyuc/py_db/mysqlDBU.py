...
import string
import datetime
if PyApiB.tryImportModule("pymysql", installName="PyMySQL"):
    import pymysql
    import pymysql.cursors
if PyApiB.tryImportModule("dbutils", installName="DBUtils"):
...
class MysqlDBU(PyApiB):
    ...
    def __init__(self):
        self.dbPools = {}
        self.host = pyuc.envU().get("mysql_host")
        self.port = pyuc.envU().get("mysql_port")
        self.user = pyuc.envU().get("mysql_user")
        self.pswd = pyuc.envU().get("mysql_pswd")
        self.charset = pyuc.envU().get("mysql_charset","utf8")
