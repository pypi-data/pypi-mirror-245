...
FREEQ_REDIS_BLOCKING_TIMEOUT = int(os.getenv("REDIS_BLOCKING_TIMEOUT", 60))
FREEQ_REDIS_EXPIRY = int(os.getenv("REDIS_EXPIRY", 60 * 60 * 24 * 2))
FREEQ_REDIS_MAX_QLEN = int(os.getenv("REDIS_MAX_QLEN", 2048))
