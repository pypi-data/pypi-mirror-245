...
class Data(ssc.DataDict):
    irrad_mode: float = INPUT(label='Irradiance input mode', units='0/1/2/3/4', type='NUMBER', group='Irradiance Processor', required='?=0', constraints='INTEGER,MIN=0,MAX=2', meta='Beam+Diff,Global+Beam, Global+Diff, POA Ref cell, POA Pyranometer ')
    beam: Array = INPUT(label='Beam normal irradiance', units='W/m2', type='ARRAY', group='Irradiance Processor', required='irrad_mode~2')
    diff: Array = INPUT(label='Diffuse horizontal irradiance', units='W/m2', type='ARRAY', group='Irradiance Processor', required='irrad_mode~1', constraints='LENGTH_EQUAL=beam')
    glob: Array = INPUT(label='Global horizontal irradiance', units='W/m2', type='ARRAY', group='Irradiance Processor', required='irrad_mode~0', constraints='LENGTH_EQUAL=beam')
    ...
    slope_tilt: float = INPUT(label='Terrain slope', units='deg', type='NUMBER', group='Irradiance Processor', required='?=0', constraints='MIN=0,MAX=1')
    slope_azm: float = INPUT(label='Terrain azimuth', units='deg', type='NUMBER', group='Irradiance Processor', required='?=0', constraints='MIN=0,MAX=1')
    elevation: float = INPUT(label='Elevation', units='m', type='NUMBER', group='Irradiance Processor', required='?')
    tamb: float = INPUT(label='Ambient Temperature (dry bulb temperature)', units='°C', type='NUMBER', group='Irradiance Processor', required='?')
    pressure: float = INPUT(label='Pressure', units='mbars', type='NUMBER', group='Irradiance Processor', required='?')
