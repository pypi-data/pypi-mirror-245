...
class Data(ssc.DataDict):
    ...
    elevation: float = INPUT(label='Elevation', units='m', type='NUMBER', group='POA Calibrate', required='?')
    tamb: float = INPUT(label='Ambient Temperature (dry bulb temperature)', units='°C', type='NUMBER', group='POA Calibrate', required='?')
    pressure: float = INPUT(label='Pressure', units='millibars', type='NUMBER', group='POA Calibrate', required='?')
