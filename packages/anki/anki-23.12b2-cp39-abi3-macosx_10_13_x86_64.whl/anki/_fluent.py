...
than available card templates, any extra cards will be removed. '''
    ...
    def deck_config_all_decks(self, option: str) -> str:
        r''' {$option} 🌐 '''
        return self._translate(11, 4, {"option": option})
...
optimizing the parameters. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 34, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 37, {"cards": cards})
...
is used to immediately remove a card from learning. '''
    ...
    def deck_config_estimated_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 51, {"num": num})
...
the manual before changing this option. '''
    ...
    def deck_config_iterations(self, count: int) -> str:
        r''' Iteration: {$count}... '''
        return self._translate(11, 64, {"count": count})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_1000_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 78, {"count": count})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 32)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP = (11, 33)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 34)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 35)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 36)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 37)
    DECK_CONFIG_DAILY_LIMITS = (11, 38)
    DECK_CONFIG_DECK_ONLY = (11, 39)
    DECK_CONFIG_DEFAULT_NAME = (11, 40)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 41)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 42)
    DECK_CONFIG_DESIRED_RETENTION = (11, 43)
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 44)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 45)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 46)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 47)
    DECK_CONFIG_DO_NOT_BURY = (11, 48)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 49)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 50)
    DECK_CONFIG_ESTIMATED_RETENTION = (11, 51)
    DECK_CONFIG_EVALUATE_BUTTON = (11, 52)
    DECK_CONFIG_FSRS_MUST_BE_ENABLED = (11, 53)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 54)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 55)
    DECK_CONFIG_GET_PARAMS = (11, 56)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 57)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 58)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 59)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 60)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 61)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 62)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 63)
    DECK_CONFIG_ITERATIONS = (11, 64)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 65)
    DECK_CONFIG_LEARNING_STEPS = (11, 66)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 67)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 68)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 69)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 70)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 71)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 72)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 73)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 74)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 75)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 76)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 77)
    DECK_CONFIG_MUST_HAVE_1000_REVIEWS = (11, 78)
    DECK_CONFIG_NAME_PROMPT = (11, 79)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 80)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 81)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 82)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 83)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 84)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 85)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 86)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 87)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 88)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 89)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 90)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 91)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 92)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 93)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 94)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 95)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 96)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 97)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 98)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 99)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 100)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 101)
    ...
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP = (11, 127)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 128)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 129)
    ...
    DECKS_CREATE_EVEN_IF_EMPTY = (12, 35)
