...
pipeline['time_epochs_with_gfp'] = AppendGFPChannel(pipeline['time_filtered_data'])
pipeline.run()
...
pipeline['plotter'] = PlotWaveforms(pipeline['fft_ave_f_tests'],
                                    ch_to_plot=np.array(['CH_0', 'CH_1', 'CH_2']),
...
database_path = reader.input_node.paths.file_directory + os.sep + 'assr_own_trials_data_f_test_data.sqlite'
