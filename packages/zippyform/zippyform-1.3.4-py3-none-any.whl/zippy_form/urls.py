...
from zippy_form.views import form_list, create_form, update_form, delete_form, \
    ...
    create_payment_gateway_webhook, get_payment_gateway_webhook_list, get_account_payment_details, \
    form_submission_details2

urlpatterns = [
    path('builder/account/list', account_list),
    path('builder/account/create', create_account),
    path('builder/account/<uuid:account_id>/get-payment-details', get_account_payment_details),
