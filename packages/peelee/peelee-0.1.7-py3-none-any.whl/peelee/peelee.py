...
def lighter_old(base_color, n_color):
...
def lighter(base_color, n_color, saturation=0.25):
...
def random_color(
    ...
    base_colors = _generate_base_colors(min_color, max_color, base_colors_total)
...
class Palette:
    ...
    def __init__(
        ...
        self.dark_base_colors = dark_base_colors
    ...
    def generate_palette_colors(self):
        ...
        if self.dark_base_colors and isinstance(self.dark_base_colors, list) and len(self.dark_base_colors) > 0:
            dark_colors = [
                lighter(_base_color, self.gradations_total)
    ...
    def generate_palette(self):
        ...
        for index, color in enumerate(palette_color_codes):
            ...
            str_base_color_sequence = _padding(
                base_color_sequence, len(str(self.base_colors_total))
            )
            str_colormap_sequence = _padding(
                colormap_sequence, len(str(self.gradations_total))
            )
...
def main():
    ...
    palette = Palette(
        base_colors_total, gradations_total, general_max_color, dark_max_color, dark_base_colors
    )
