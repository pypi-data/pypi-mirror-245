...
def random_color(
    ...
    for _ in range(0, 3):
        ...
        _random_color = padding(hex(random_int), 2)
        random_color_code = random_color_code + _random_color
...
class Palette:
    ...
    def __init__(self, base_colors_total=5, gradations_total=6):
    ...
    def generate_palette_colors(self):
        ...
        dark_colors = random_color(
            max_color=30, base_colors_total=1, gradations_total=self.gradations_total
        )
    ...
    def generate_palette(self):
        ...
        for index, color in enumerate(palette_color_codes):
            ...
            str_base_color_sequence = padding(base_color_sequence, len(str(self.base_colors_total)))
            str_colormap_sequence = padding(colormap_sequence, len(str(self.gradations_total)))
...
def main():
    ...
    opts, _ = getopt.getopt(
        sys.argv[1:], "b:g:", ["--base_colors_total=", "--gradations_total="]
    )
    base_colors_total = 5
    gradations_total = 6
    ...
    palette = Palette(base_colors_total, gradations_total)
