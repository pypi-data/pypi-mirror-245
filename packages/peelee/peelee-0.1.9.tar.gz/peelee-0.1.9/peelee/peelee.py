...
class Palette:
    ...
    def __init__(
        ...
        Parameters:
            ...
            dark_base_colors - base colors for dark theme. Note: (1) the value of dark_base_colors is a list. (2) the value of dark_base_colors will not be used as color of pelette, only their lighter colors will be used.
        """
    ...
    def generate_palette_colors(self):
        ...
        if self.dark_base_colors and isinstance(self.dark_base_colors, list) and len(self.dark_base_colors) > 0:
            dark_colors = [
    ...
    def generate_palette(self):
        ...
        for index, color in enumerate(palette_color_codes):
            ...
            if color_sequence > self.colors_total:
                ...
                sub_color_sequence = (index - (self.colors_total * self.gradations_total)) % (self.dark_color_gradations_total)
            str_base_color_sequence = _padding(
                color_sequence, len(str(self.colors_total))
            )
            str_colormap_sequence = _padding(
                sub_color_sequence, len(str(_gradations_total))
            )
...
def main():
    ...
    palette = Palette(
        base_colors_total, gradations_total, dark_color_gradations_total,general_max_color, dark_max_color, dark_base_colors
    )
