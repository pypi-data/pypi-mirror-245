...
def deploy(
    ...
    Args:
        ...
        file_name: The frontend or backend file name.
        key: The deployment name.
    ...
    Raises:
        ...
        Exception: If the operation fails. The exception message is the reason.
        ValueError: If neither the key or initiator_event_id is not provided.
    ...
    if key is None and initiator_event_id is None:
        raise ValueError("Either key or initiator_event_id is required.")
    # With this, we never upload frontend/backend files together now
    ...
    try:
        ...
        with open(os.path.join(export_dir, file_name), "rb") as file:
