...
st.markdown(
    ...
    - check_status: 'DONE' means success, 'UN_DONE' means pks check times more than 10 times and still not find difference
...
df_pg = pd.DataFrame(result_list_pg, columns=['id', 'source_table', 'dest_table', 'source_count',
                                              ...
                                              'only_in_source_list','only_in_dest_list','only_source_max_times_id', 'only_dest_max_times_id', 'check_timestamp', 'max_cdc_ts','check_status'])
