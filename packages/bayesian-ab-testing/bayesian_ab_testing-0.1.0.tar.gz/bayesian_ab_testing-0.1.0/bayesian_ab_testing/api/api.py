...
from bayesian_ab_testing.data_preperation import SqlHandler
from bayesian_ab_testing.data_preperation.schema import create_ORM
...
create_ORM(bayesian_ab_testing.db_path)
cnxn = sqlite3.connect(bayesian_ab_testing.db_path)
