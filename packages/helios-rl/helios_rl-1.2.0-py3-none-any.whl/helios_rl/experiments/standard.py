...
class Experiment:
    ...
    """
    def __init__(self, Config:dict, Environment, save_dir:str, show_figures:str, window_size:float):
        ...
        try:
            self.setup_info = self.ExperimentConfig['data']
        except:
            self.setup_info = self.ExperimentConfig
