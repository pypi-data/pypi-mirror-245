...
def compound_inchi_conversion(*compound_inchis, record_type='record'):
    """
    Convert compound InChIs to PubChem URLs with a specified record type.
...
# Example usage:
operation_urls = protein_domain_operation('accession', 'summary', 'P00533', 'P01422')
print(operation_urls)
