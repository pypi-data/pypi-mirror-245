...
from genflow.interface.custom.component import Component
from genflow.interface.custom.directory_reader import DirectoryReader
from genflow.services.getters import get_db_service
...
from genflow.services.database.models.flow import Flow
...
class CustomComponent(Component, extra=Extra.allow):
    ...
    def load_flow(self, flow_id: str, tweaks: Optional[dict] = None) -> Any:
        from genflow.processing.process import build_sorted_vertices
        from genflow.processing.process import process_tweaks
