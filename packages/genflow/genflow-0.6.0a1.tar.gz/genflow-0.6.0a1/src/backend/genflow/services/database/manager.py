...
from genflow.services.base import Service
from genflow.services.database import models  # noqa
from genflow.services.database.models.user.crud import get_user_by_username
from genflow.services.database.utils import Result, TableResults
from genflow.services.getters import get_settings_service
from genflow.services.utils import teardown_superuser
...
class DatabaseService(Service):
    ...
    def __init__(self, database_url: str):
        ...
        # This file is in genflow.services.database.manager.py
        # the ini is in genflow
        genflow_dir = Path(__file__).parent.parent.parent
        self.script_location = genflow_dir / "alembic"
        self.alembic_cfg_path = genflow_dir / "alembic.ini"
