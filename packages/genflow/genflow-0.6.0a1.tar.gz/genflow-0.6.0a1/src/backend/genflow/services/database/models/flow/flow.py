# Path: src/backend/genflow/database/models/flow.py

from genflow.services.database.models.base import SQLModelSerializable
...
if TYPE_CHECKING:
    from genflow.services.database.models.user import User
