...
from genflow.custom.customs import get_custom_nodes
from genflow.interface.base import LangChainTypeCreator
from genflow.interface.importing.utils import import_class
from genflow.services.getters import get_settings_service

from genflow.template.frontend_node.chains import ChainFrontendNode
from loguru import logger
from genflow.utils.util import build_template_from_class, build_template_from_method
...
class ChainCreator(LangChainTypeCreator):
    ...
    def type_to_loader_dict(self) -> Dict:
        if self.type_dict is None:
            ...
            from genflow.interface.chains.custom import CUSTOM_CHAINS
