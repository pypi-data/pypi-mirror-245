...
from genflow.template.frontend_node.prompts import PromptFrontendNode
from loguru import logger
from genflow.utils.util import build_template_from_class
...
class PromptCreator(LangChainTypeCreator):
    ...
    def type_to_loader_dict(self) -> Dict:
        ...
        if self.type_dict is None:
            ...
            from genflow.interface.prompts.custom import CUSTOM_PROMPTS
