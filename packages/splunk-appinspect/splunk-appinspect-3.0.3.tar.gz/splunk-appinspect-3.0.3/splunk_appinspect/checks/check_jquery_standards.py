...
@splunk_appinspect.tags(
    Tags.CLOUD, Tags.JQUERY, Tags.PRIVATE_APP, Tags.PRIVATE_VICTORIA, Tags.MIGRATION_VICTORIA, Tags.PRIVATE_CLASSIC
)
...
def check_hotlinking_splunk_web_libraries(app: "App", reporter: "Reporter") -> None:
    ...
    html_dashboard_files = list(app.get_filepaths_of_files(basedir="default/data/ui/html", types=[".html"]))
