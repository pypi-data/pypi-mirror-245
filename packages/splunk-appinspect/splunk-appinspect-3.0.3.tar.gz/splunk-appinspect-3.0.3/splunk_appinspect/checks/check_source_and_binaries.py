...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.APPAPPROVAL, Tags.CLOUD, Tags.PRIVATE_APP, Tags.PRIVATE_CLASSIC)
...
def check_for_bin_files(app: "App", reporter: "Reporter") -> None:
    ...
    permissions.
    Splunk Cloud is a Linux-based platform, Splunk recommends 644 for all app files outside of the `bin/` directory, 644 for
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.APPAPPROVAL, Tags.MANUAL, Tags.CLOUD)
@splunk_appinspect.cert_version(min="1.0.0")
