...
def check_for_insecure_http_request_in_javascript(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL)
@splunk_appinspect.cert_version(min="1.6.0")
def check_for_iframe_in_javascript(app: "App", reporter: "Reporter") -> None:
    """Check if the app contains possible iframe in JavaScript files, templates or html pages."""
    javascript_files = list(
        app.iterate_files(skip_compiled_binaries=True)
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL)
@splunk_appinspect.cert_version(min="1.6.0")
def check_for_console_log_injection_in_javascript(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL)
@splunk_appinspect.cert_version(min="1.6.0")
def check_for_remote_code_execution_in_javascript(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL)
@splunk_appinspect.cert_version(min="1.6.0")
def check_for_reflected_xss_in_javascript(app: "App", reporter: "Reporter") -> None:
