...
static void (*make_lookup)(double, int, int, int *, double *, double **) = make_lookup_poly;
static void (*make_lookup_grad)(double, int, int, int *, double *, double *, double **) = make_lookup_poly_grad;

/* Zero order hold resampling - nearest neighbour */
void RESAMPLE_0(int m, IMAGE_DTYPE *vol[], double out[], double x[], double y[], double z[], int xdim, int ydim, int zdim, int background, double scale[], double offset[])
{
    int i;
    for (i=0; i<m; i++)
    {
...
void RESAMPLE_1(int m, IMAGE_DTYPE *vol[], double out[], double x[], double y[], double z[], int xdim, int ydim, int zdim, int background, double scale[], double offset[])
{
    int i;
    for (i=0; i<m; i++)
    {
...
///* First order hold resampling - trilinear interpolation */
//void RESAMPLE_D_1(int m, IMAGE_DTYPE *vol[], double out[], double gradx[], double grady[], double gradz[], double x[], double y[], double z[], int xdim, int ydim, int zdim, double background, double scale[], double offset[])
//{
//    int i;
//    for (i=0; i<m; i++)
//    {
...
//
/* Sinc resampling */
void RESAMPLE_POLY(int m, IMAGE_DTYPE *vol[], double out[], double x[], double y[], double z[], int xdim, int ydim, int zdim, int q, double background, double scale[], double offset[])
{
    int i;
    int dx1, dy1, dz1;
...
///* Sinc resampling */
//void RESAMPLE_D_POLY(int m, IMAGE_DTYPE *vol[],double out[], double gradx[],double grady[], double gradz[], double x[], double y[], double z[], int xdim, int ydim, int zdim, int q, double background,  double scale[], double offset[])
//{
//    int i;
//    int dx1, dy1, dz1;
//    static double  tablex[255],  tabley[255],  tablez[255];
...
//
/* Zero order hold resampling - nearest neighbour */
int SLICE_0(double mat[16], double image[], int xdim1, int ydim1, IMAGE_DTYPE *vol[], int xdim2, int ydim2, int zdim2, double background, double scale[], double offset[])
{
...
/* First order hold resampling - trilinear interpolation */
int SLICE_1(double mat[16], double image[], int xdim1, int ydim1, IMAGE_DTYPE *vol[], int xdim2, int ydim2, int zdim2, double background, double scale[], double offset[])
{
    double y, x2, y2, z2, s2, dx3=mat[0], dy3=mat[1], dz3=mat[2], ds3=mat[3];
    int t = 0;
...
/* Sinc resampling */
int SLICE_POLY(double mat[], double image[], int xdim1, int ydim1, IMAGE_DTYPE *vol[], int xdim2, int ydim2, int zdim2, int q, double background, double scale[], double offset[])
{
    int dx1, dy1, dz1;
    static double tablex[255], tabley[255], tablez[255];
    double y, x2, y2, z2, s2, dx3=mat[0], dy3=mat[1], dz3=mat[2], ds3=mat[3];
...
void PLANE(int p, double image[], IMAGE_DTYPE *vol[], int xdim, int ydim, double scale[], double offset[])
{
    int n = xdim*ydim, i;
...
int SLICE(double* mat, double* image, int xdim1, int ydim1, IMAGE_DTYPE** vol, int xdim2, int ydim2, int zdim2, int hold, double background, double* scale, double* offset)
{
    double t = 1e-10;
...
/* Resample image */
void RESAMPLE(int m, IMAGE_DTYPE **vol,double *out, double *x, double *y, double *z, int xdim, int ydim, int zdim, int hold, double background, double *scale, double *offset)
{
    if (hold<0)
    {
        hold=abs(hold);
