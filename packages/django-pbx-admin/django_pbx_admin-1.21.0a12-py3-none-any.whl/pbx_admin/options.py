...
from typing import Any, Optional, Sequence, Tuple, TypedDict, TypeVar, Union, cast
...
class RenderField:
    ...
    def get_value(self, obj: _ModelT):
    ...
    def get_label(self, form: _BaseFormT | None = None) -> StrOrPromise:
    ...
    def get_tooltip(self, obj: _ModelT) -> StrOrPromise | None:
