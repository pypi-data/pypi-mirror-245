...
class SettingsProvidersTests(BaseTestCase):
    ...
    def test_SettingsManagerJSON_Template_LoadsAndSavesCorrectly(self):
        ...
        settingsManager.Settings.testInt = 15
        self.assertEqual(settingsManager.Settings.testInt,  15)
        self.assertEqual(settingsManager.Settings['testInt'],  15)
        ...
        settingsManager.Settings.testString = "new test string"
        settingsManager.SaveSettings()
        settingsManager = SettingsManager_JSON[CustomTemplate_JSON](self.testSettingsPath, CustomTemplate_JSON)
        ...
        self.assertEqual(settingsManager.Settings.testString, "new test string") #should be saved as new string
