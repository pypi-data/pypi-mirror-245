...
class _ColumnList(_MutableSequence[_T], _Generic[_T]):
        ...
        def __getattr__(self, __name: str):
            index = self._ResolveIndex(__name) #already raises AttributeError
            try:
                return self._list[index]
            except Exception as ex:
                raise AttributeError(str(ex)) #specifically __getattr__ excepts to recieve this type of exception
