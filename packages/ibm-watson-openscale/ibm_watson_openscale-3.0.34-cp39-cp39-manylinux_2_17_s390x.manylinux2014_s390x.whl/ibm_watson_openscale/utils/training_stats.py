    ...
    def __get_explainability_configuration(self):
        ...
        try:
            ...
            numeric_columns = list(
                set(self.feature_columns) ^ set(self.categorical_columns) ^ set(self.text_columns))
            ...
            # numeric columns index as per feature columns
            numeric_column_index = [self.feature_columns.index(
                x) for x in numeric_columns]

            # text columns index as per feature columns
            text_column_index = [self.feature_columns.index(
                x) for x in self.text_columns]
            ...
            descritizer = QuartileDiscretizer(
                ...
                labels=class_labels, random_state=random_state, text_features=text_column_index)
            ...
            for feature in cat_features:
                if feature in text_column_index:
                    continue
        ...
        data_stats["text_columns"] = self.text_columns
