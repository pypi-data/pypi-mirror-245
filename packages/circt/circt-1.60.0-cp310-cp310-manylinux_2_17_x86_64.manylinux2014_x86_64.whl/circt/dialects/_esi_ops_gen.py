...
def service_req_to_client(to_client, service_port, app_id, *, loc=None, ip=None) -> _SubClassValueT:
...
def service_impl_req(outputs, app_id, impl_type, inputs, *, service_symbol=None, impl_opts=None, loc=None, ip=None) -> _SubClassValueT:
