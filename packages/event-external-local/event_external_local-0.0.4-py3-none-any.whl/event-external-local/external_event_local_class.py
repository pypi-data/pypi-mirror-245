...
from src.external_event_constants import ExternalEventLocalConstants  # noqa
from src.external_event import EventExternal  # noqa
...
class ExternalEventsLocal(GenericCRUD):
    ...
    def insert(self, system_id: int, subsystem_id: int, url: str,
               external_event_identifier: str, environment_id: int) -> int:
