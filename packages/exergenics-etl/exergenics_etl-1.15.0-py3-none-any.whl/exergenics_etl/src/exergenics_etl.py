...
def set_data_selection_outputs(jobId: Union[int, str], environment: str, jobType: str) -> bool:
    """
...
def set_header_mapping_outputs(jobId: Union[int, str], environment: str, jobType: str) -> bool:
    """
