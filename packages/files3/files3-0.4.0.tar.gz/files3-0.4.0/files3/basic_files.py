...
class pyfile_basic_files(object, metaclass=BasicMeta):
    ...
    @staticmethod
    def new(info, key: str, pyobject: object) -> PfBool:
        """
    ...
    @staticmethod
    def delete(info, key: str) -> PfBool:
        """
    ...
    @staticmethod
    def modify(info, key: str, pyobject: object) -> PfBool:
        """
