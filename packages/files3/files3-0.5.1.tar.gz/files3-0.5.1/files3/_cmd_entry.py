...
import time
import winreg
from files3._ipackage import PF_DTYPE, InfoPackage
...
def _read_inst(_dir, _fname, _type):
    ...
    if isinstance(_, PfBool):
        print("File not exists or can't be a Files3File -For got the 'pfFalse'.")
        return
...
if __name__ == '__main__':
    sys.argv = ['f3test', r"C:\Users\22290\Desktop\test.inst"]
    _cmd_open()
