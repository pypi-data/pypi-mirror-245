...
from typing import Any, Callable, Final, Iterable, Iterator, Mapping, Optional, Sequence, TypedDict, Unpack
    ...
    def download(
        ...
        if hasattr(local_path_or_file, "write"):
            ...
            if overwrite_or_ignore is None:
                ...
                mode = "wb"
                if not overwrite_or_ignore and os_path.lexists(local_path):
                    return
            if local_path:
