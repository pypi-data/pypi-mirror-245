...
class NimoModem:
    ...
    def __init__(self, serial_port: str, **kwargs) -> None:
        ...
        try:
            ...
            raise ModemError('Unable to connect to modem') from exc
    ...
    def get_last_error_code(self) -> int:
        ...
        try:
            ...
            raise ModemError(AtErrorCode.ERROR.name) from exc
    ...
    def get_event_mask(self) -> int:
        ...
        if self._mfr != Manufacturer.ORBCOMM:
            raise ValueError('Operation not supported by this modem')
        cmd = 'ATS88?'
