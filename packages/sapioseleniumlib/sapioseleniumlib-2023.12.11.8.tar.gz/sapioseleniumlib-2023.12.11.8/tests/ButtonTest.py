...
def test_get_button_with_text_with_new_line(p: BasePage):
...
test_get_button_with_text_with_new_line(eln_toolbar)
test_get_button_with_text_element(ad_hoc_experiment.main_element)
test_get_button_with_text_with_new_line(ad_hoc_experiment)
test_get_button_with_nothing()
sapio_driver.wait(3)
