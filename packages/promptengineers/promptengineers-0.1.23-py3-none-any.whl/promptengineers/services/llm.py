...
from promptengineers.config.functions import FUNCTIONS
from promptengineers.factories.function import FunctionFactory
from promptengineers.utils import match_strings
...
def openai_chat_functions_model(
    ...
    if response_message.get("function_call"):
        ...
        function_response = FunctionFactory().get_result(
			function_name,
			response_message,
		)
