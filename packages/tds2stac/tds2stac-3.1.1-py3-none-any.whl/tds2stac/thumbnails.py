...
class Thumbnails(object):
    ...
    def collection(
        ...
        Args:
            ...
            collection_link (str): The link of thumbnail image for STAC-Collections when `collection_thumbnail` or `collection_overview` set as `link`.
