...
class Functional:
    ...
    def filter_indexed(self, function):
        filtered = filter(lambda item: function(*item if self._is_dict() else (item[0], item[1])), enumerate(self._dict_or_iterable()))
    ...
    def filter_indexed_not_none(self, function=None):
        return self.filter_not_none().filter_indexed(function).filter_not_none()
    ...
    def first_indexed_not_none(self, function=None):
        return self.filter_not_none().first_indexed(function)
    ...
    def last_indexed_not_none(self, function=None):
        return self.filter_not_none().last_indexed(function)
