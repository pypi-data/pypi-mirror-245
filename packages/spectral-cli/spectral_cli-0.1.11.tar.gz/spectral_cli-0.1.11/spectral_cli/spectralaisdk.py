...
def commit(config_manager, model_path, input_json_path, challenge_id):
    ...
    if modeler_contract.functions.modelers(multisig_wallet_address).call()[0] == '':
        ...
        confirmation_string = click.prompt(
            "You already commited to a model. Proceeding will replace your current commitment and will trigger creating a new testing dataset. Type REPLACE to proceed or anything else to cancel.", default="", show_default=False)
