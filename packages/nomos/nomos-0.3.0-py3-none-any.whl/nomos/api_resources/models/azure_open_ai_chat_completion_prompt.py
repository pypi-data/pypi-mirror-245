...
class AzureOpenAIChatCompletionPrompt(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AzureOpenAIChatCompletionPrompt from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AzureOpenAIChatCompletionPrompt from a dict"""
        if obj is None:
            return None
