...
class OpenAICompletionPrompt(BaseModel):
    """
    ...
    def provider_function_validate_enum(cls, value):
        ...
        # https://github.com/getnomos/nomos-postman/pull/27
        # https://github.com/OpenAPITools/openapi-generator/pull/17096
        if value not in set(["completion"]):
            raise ValueError("must be one of enum values ('completion')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OpenAICompletionPrompt from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OpenAICompletionPrompt from a dict"""
        if obj is None:
            return None
