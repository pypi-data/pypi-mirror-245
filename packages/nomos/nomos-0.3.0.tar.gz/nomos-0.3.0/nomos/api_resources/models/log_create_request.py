...
class LogCreateRequest(BaseModel):
    ...
    log_id: StrictStr = Field(
        description="The ID of the log entry. This ID should be generated by the client when using the log/create endpoint so that it can be used for log chaining and for adding feedback."
    )
    ...
    variables: Optional[Dict[str, StrictStr]] = Field(
        default=None, description="A record of variables and their values."
    )
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LogCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of LogCreateRequest from a dict"""
        if obj is None:
            return None
