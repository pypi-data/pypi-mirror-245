...
class DataGenerator:
    ...
    def __create_dirs(self, dataset_path, dataset_type : DatasetType, img_class : str):
    ...
    def generate(self, video_path : str, img_class : str, dataset_type : DatasetType, dataset_path = "dataset/") -> None:
        ...
        if os.path.exists(video_path):
            ...
            PATH_CLASS = self.__create_dirs(dataset_path, dataset_type, img_class)
