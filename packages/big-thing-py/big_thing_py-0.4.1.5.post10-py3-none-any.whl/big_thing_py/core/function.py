...
class MXFunction(MXService):
    ...
    def generate_execute_result_message(self, scenario: str, error: MXErrorCode, request_ID: str) -> MXExecuteResultMessage:
        execute_result_msg = MXExecuteResultMessage(function=self, scenario=scenario, request_ID=request_ID, error=error)
