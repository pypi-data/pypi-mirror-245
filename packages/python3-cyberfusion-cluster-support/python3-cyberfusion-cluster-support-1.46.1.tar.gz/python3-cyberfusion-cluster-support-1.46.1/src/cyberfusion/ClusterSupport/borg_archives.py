...
class BorgArchive(APIObjectInterface):
    ...
    Create returns task collection instead of created object. Therefore, create
    does not add new object to list of objects, and attributes are not set on model.
    """
