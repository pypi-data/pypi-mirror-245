...
def pytest_terminal_summary(terminalreporter, exitstatus, config) -> None:
    # This check ensures that the following code only runs in the main process
    # when tests are being run in parallel using pytest-xdist.
    if hasattr(config, 'workerinput'):
        return
    ...
    if aggregated_results:
        ...
        # Remove the individual report files now that they have been aggregated.
