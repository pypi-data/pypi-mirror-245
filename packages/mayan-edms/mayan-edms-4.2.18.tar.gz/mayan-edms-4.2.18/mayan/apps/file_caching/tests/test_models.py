...
class CacheModelTestCase(CacheTestMixin, BaseTestCase):
    ...
    def test_cache_create(self):
        ...
        self.assertEqual(events[0].actor, self.test_cache)
        self.assertEqual(events[0].target, self.test_cache)
    ...
    def test_cache_partition_file_hits(self):
        ...
        self.assertEqual(
            self.test_cache_partition_file.hits,
    ...
    def test_purge_on_error(self):
        ...
        test_cache_partition_file_count = self.test_cache_partition.files.count()
...
class CachePartitionModelTestCase(CacheTestMixin, BaseTestCase):
    def test_cache_create(self):
        ...
        self.test_cache_partition.delete()
    ...
    def test_purge_on_error(self):
        ...
        with mock.patch('mayan.apps.file_caching.models.CachePartitionFile.delete', fake_method_delete):
            self.test_cache_partition.purge()
