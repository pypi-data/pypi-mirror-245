...
def ImageGeneration_DALLE2(prompt, llm_kwargs, plugin_kwargs, chatbot, history, system_prompt, web_port):
    ...
    chatbot.append(("You are calling the `Image Generation` plugin. ", "[Local Message] Generate image, Please switch the model to gpt-* or api2d-* first. If the Chinese prompt is not effective, Try English Prompt. Processing ....."))
