...
if __name__ == "__main__":
    ...
    plugin_test(plugin='crazy_functions.OutputPDFFromLatex->TranslateChineseToEnglishInLatexAndRecompilePDF', main_input="G:/SEAFILE_LOCAL/50503047/My Library/Degree/paperlatex/aaai/Fu_8368_with_appendix")
