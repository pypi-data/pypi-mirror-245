...
collaboration. This GitHub site provides a space for you to contribute to 
the project by posting discussions, raising issues, opening pull requests,
commenting on the development, and more. It is important to note that anything
posted to this repository by any user does not imply that it has been endorsed,
vetted or reviewed by Jacobs or anyone else in the community. 

Code that is merged into the main branch for the API will have been tested and 
reviewed by Jacobs and is subject to the terms laid out in the licence.
