...
def pickle2X(options):
    ...
    df = df.with_columns(pl.lit(test_cod).cast(pl.Categorical).alias("TEST_COD"),
                         ...
                         pl.lit(tst_temp).cast(pl.UInt32).alias("tst_temp"),
                         pl.lit(node_nam).cast(pl.UInt32).alias("node_nam"),
                         pl.lit(job_nam).cast(pl.UInt32).alias("job_nam"),
                         pl.lit(sblot_id).cast(pl.UInt32).alias("sblot_id"),
                         pl.lit(floor_id).cast(pl.UInt32).alias("floor_id"),
