...
def verify(function, args, meta_data, config_dir=None, add_data_type=None, custom_checker=None, logger=None):
    ...
    logger.info(
        "Checking parameter values for {module}.{function}".format(function=function_name, module=module_name))
