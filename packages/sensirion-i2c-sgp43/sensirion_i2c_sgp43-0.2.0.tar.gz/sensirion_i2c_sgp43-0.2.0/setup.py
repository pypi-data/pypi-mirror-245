...
version_line = open("sensirion_i2c_sgp43/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_sgp43',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion SGP43 sensor family',
    license='BSD',
    keywords="""Sensirion SGP43
        I2C
        SGP43""",
    project_urls={
