...
# TODO reaction_local_python_code_logger_object
object_to_insert = {
...
class Reaction:
    ...
    # TODO reaction_data -> reaction_dict
    ...
    def insert(self, reaction_data: Dict[str, any], profile_id: int, lang_code: str) -> int:
        ...
        # TODO change all SELECT to use _view instead of _table
        ...
        if not reaction_type_id:
            ...
            # TODO Can we use cursor.lastrowid or connection.insert_id(), instead of SELECT LAST_INSERT_ID()?
        ...
        logger.end(INSERT_REACTION_METHOD_NAME+" reaction_id="+str(reaction_id), object= { 'reaction_id': reaction_id} )
        return reaction_id

     # TODO reaction_data -> reaction_json
