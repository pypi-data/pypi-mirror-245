...
"""import house_price_prediction.train as train"""
...
def score():
    ...
    (housing_prepared, housing_labels, strat_test_set, imputer) = training_data(
        args.data_path
    )
    ...
    logger.info("Grid Search_scores")
