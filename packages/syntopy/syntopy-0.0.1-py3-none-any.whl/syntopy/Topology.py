...
import syntopy
import topologic
from syntopy.Aperture import Aperture
...
class Topology():
    ...
    def AddApertures(topology, apertures, exclusive=False, subTopologyType=None, tolerance=0.0001):
        ...
        """
        from syntopy.Vertex import Vertex
        from syntopy.Cluster import Cluster
        from syntopy.Aperture import Aperture
    ...
    def AddDictionary(topology, dictionary):
        ...
        from syntopy.Dictionary import Dictionary
        if not isinstance(topology, topologic.Topology):
    ...
    def BoundingBox(topology, optimize=0, axes="xyz", tolerance=0.0001):
        ...
        """
        from syntopy.Wire import Wire
        from syntopy.Face import Face
        from syntopy.Cell import Cell
        from syntopy.Cluster import Cluster
        from syntopy.Dictionary import Dictionary
        def bb(topology):
            vertices = []
    ...
    def ByGeometry(vertices=[], edges=[], faces=[], color=[1.0,1.0,1.0,1.0], id=None, name=None, lengthUnit="METERS", outputMode="default", tolerance=0.0001):
        ...
        def edgesByVertices(vertices, topVerts):
            ...
            return edges
        from syntopy.Vertex import Vertex
        from syntopy.Edge import Edge
        from syntopy.Wire import Wire
        from syntopy.Face import Face
        from syntopy.Shell import Shell
        from syntopy.Cell import Cell
        from syntopy.CellComplex import CellComplex
        from syntopy.Cluster import Cluster
        from syntopy.Dictionary import Dictionary
        import uuid
        returnTopology = None
    ...
    def ByXYZFile(file, frameIdKey="id", vertexIdKey="id"):
        """
        Imports the topology from an XYZ file path. This is a very experimental method. While variants of the format exist, syntopy reads XYZ files that conform to the following:
    ...
    def Explode(topology, origin=None, scale=1.25, typeFilter=None, axes="xyz"):
        ...
        """
        from syntopy.Cluster import Cluster
        from syntopy.Graph import Graph
    ...
    def OBJString(topology, transposeAxes=True):
        ...
        """
        from syntopy.Helper import Helper
        from syntopy.Vertex import Vertex
        from syntopy.Face import Face
    ...
    def Flatten(topology, origin=None, vector=[0,0,1]):
        ...
        """
        from syntopy.Vertex import Vertex
        from syntopy.Topology import Topology
        if not isinstance(topology, topologic.Topology):
    ...
    def Show(topology,
        ...
        """
        from syntopy.Plotly import Plotly
        if not isinstance(topology, topologic.Topology):
    ...
    def TranslateByDirectionDistance(topology, direction=[0,0,0], distance=0):
        ...
        """
        from syntopy.Vector import Vector
        if not isinstance(topology, topologic.Topology):
