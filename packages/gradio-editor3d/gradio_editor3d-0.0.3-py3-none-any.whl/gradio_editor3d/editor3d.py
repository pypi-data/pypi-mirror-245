...
def b64_to_pil_image(b64: str) -> Image:
    """
...
class Editor3D(FormComponent):
    ...
    def preprocess(self, x: str | None) -> Image.Image | None:
        """
        ...
        Returns:
            text
        """
        return None if x is None else b64_to_pil_image(x)
