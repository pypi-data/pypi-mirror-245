...
from smart_generator.descriptor.column import ColumnDescriptorDate
from smart_generator.descriptor.enums import ColumnVisibilityType, DatePrecisionType


class TestColumnDescriptorDate:
    def test_load_increment(self):
        ...
        obj = marshmallow_dataclass.class_schema(ColumnDescriptorDate)().load(data)

        assert obj.descriptor_type == "COL_DATE"
        assert obj.id == "1"
        assert obj.seed == 1
        assert obj.name == "column1"
        assert obj.visibility_type == ColumnVisibilityType.VISIBLE
        assert obj.na_prob == 0.5
        assert obj.precision == DatePrecisionType.DAY
    ...
    def test_get_descriptor_type_increment(self):
        ...
        assert obj.get_descriptor_type() == "COL_DATE.INCREMENT"
    ...
    def test_get_descriptor_type_uniform_distribution(self):
        ...
        assert obj.get_descriptor_type() == "COL_DATE.UNIFORM_DISTRIBUTION"
    ...
    def test_get_descriptor_type_weights_table(self):
        ...
        assert obj.get_descriptor_type() == "COL_DATE.WEIGHTS_TABLE"
    ...
    def test_get_descriptor_type_template_label(self):
        ...
        assert obj.get_descriptor_type() == "COL_DATE.TEMPLATE_LABEL.LABEL"
    ...
    def test_get_descriptor_type_template_timestamp(self):
        ...
        assert obj.get_descriptor_type() == "COL_DATE.TEMPLATE_TIMESTAMP.TIMESTAMP"
