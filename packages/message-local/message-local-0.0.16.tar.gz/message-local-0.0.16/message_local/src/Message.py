...
class Message(Item, ABC):
    ...
    __message_after_text_template = None
    __message_after_html_template = None
    __message_after_text_template_length = None
    __message_after_html_template_length = None


    def __init__(self, original_body: str, importance: MessageImportance, is_direct_api: bool, api_type_id:int, endpoint:str, original_subject: str = None, headers: dict = DEFAULT_HEADERS, external_user_id: int = None ) -> None:
    ...
    def set_to_recipients(self, recipients: list) -> None:
        """set method"""
        logger.start()
    ...
    @abstractmethod
    def _can_send(self, sender_user_id: int = None, api_data: dict = None, outgoing_body: dict = None ) -> bool:
        if self._is_direct_api:
            self._can_send_direct(external_user_id=self.__external_user_id, api_data=api_data)
        else:
            self._can_send_indirect(external_user_id=self.__external_user_id, outgoing_body=outgoing_body)

    def _can_send_direct(self, sender_user_id: int = None, api_data: dict = None) -> bool:
        try:
    ...
    def _can_send_indirect(self, outgoing_body: dict, sender_user_id:int = None):
        try:
    ...
    @abstractmethod
    def _after_send_attempt(self, sender_user_id:int = None, outgoing_body:dict = None, incoming_message:str = None, http_status_code:int = None, response_body:str = None) -> None:
        if self._is_direct_api:
    ...
    def after_indirect_send(self, sender_user_id:int, outgoing_body:dict, incoming_message:str, http_status_code:int, response_body:str):
...
# get_message_after_html_template()
# __get_message_after_text_template_length()
# __get_message_after_html_template_length()
# __get_number_of_attachment()
# __get_type_of_attachments()
