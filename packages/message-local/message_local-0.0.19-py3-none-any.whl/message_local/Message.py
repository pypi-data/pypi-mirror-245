...
class Message(Item, ABC):
    ...
    def __init__(self, original_body: str,  is_http_api: bool, api_type_id:int, endpoint:str,
                 importance: MessageImportance = MessageImportance.MEDIUM, original_subject: str = None, headers: dict = DEFAULT_HEADERS, external_user_id: int = None ) -> None:
    ...
    def _set_recipients(self, to_recipients: list, cc_recipients: list(Recipient)) -> None:
        """set method"""
        logger.start()
    ...
    def _get_body_after_text_template_length(self) -> int:
        return self.__body_after_text_template_length

    def _get_message_after_html_template_length(self) -> int:
        return self.__body_after_html_template_length
    ...
    def _get_subject_after_text_template_length(self) -> int:
        return self.__subject_after_text_template_length
