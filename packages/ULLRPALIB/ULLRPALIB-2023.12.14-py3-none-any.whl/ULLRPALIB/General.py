...
def Send_Mail(from_email, destinations_email, subject, body, credentials):
    # domain = "+glpiadmin@ull.edu.es"
...
def Send_Mail_Attach(from_email, destinations_email, subject, body, credentials, attachs_list):
    # domain = "+glpiadmin@ull.edu.es"
    credential_email = get_generic_credential(credentials)
...
def main():
    ...
    if result:
        ...
        print('No matching credentials found')
    Send_Mail_Attach("rparobi@ull.edu.es", ["jgonzal@ull.edu.es"], "Asunto prueba", 
