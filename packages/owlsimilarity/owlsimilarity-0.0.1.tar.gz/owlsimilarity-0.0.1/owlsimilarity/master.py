...
from .funcoes_aux import numeroDeConceitos, num_folhas_classe
from .funcoes_similarity import profundidadeMax
from .funcoes_relatedness import faz_dicionario_is_a, faz_dicionario_obj_prop, dict_union
