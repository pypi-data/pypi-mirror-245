...
def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  ...
  t120 = lax_cond(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (t43 * (0.1e1 / t71 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t56 - 0.5e1 / 0.9e1 * (0.14554132 * t76 + t79 + 0.11867481666666666667e-1 * t55) * t44 * t48) / t86) + (0.1e1 - t43) * t114))
  t122 = lax_cond(t10, t15, -t17)
  t123 = lax_cond(t14, t11, t122)
  t124 = 0.1e1 + t123
  t126 = jnp.cbrt(t124)
  t128 = lax_cond(t124 <= p.zeta_threshold, t23, t126 * t124)
  t134 = s2 / r1 / tau1 / 0.8e1
  t136 = lax_cond(t134 < 0.1e1, t134, 0.1e1)
  t137 = t136 ** 2
  t138 = t137 * t136
  t142 = (0.1e1 + t138) ** 2
  ...
  t209 = lax_cond(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t128 * t27 * (t144 * (0.1e1 / t162 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t151 - 0.5e1 / 0.9e1 * (0.14554132 * t167 + t79 + 0.11867481666666666667e-1 * t150) * t44 * t48) / t175) + (0.1e1 - t144) * t203))
  res = t120 + t209
  return res
...
def unpol(p, r, s=None, l=None, tau=None):
  ...
  t115 = lax_cond(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * (t35 * (0.1e1 / t66 + 0.7e1 / 0.9e1 * (0.1e1 + 0.63943327777777777778e-1 * t50 - 0.5e1 / 0.9e1 * (0.14554132 * t72 + 0.256337604 * t52 * t39 + 0.11867481666666666667e-1 * t49) * t36 * t40) / t82) + (0.1e1 - t35) * t109))
  res = 0.2e1 * t115
  return res
