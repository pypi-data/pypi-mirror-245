...
def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  ...
  t47 = lax_cond(t45 < 0.2e3, t45, 200)
  t49 = jnp.cosh(params.a * t47)
  t51 = t36 ** 2
  t53 = t33 / t51
  t54 = r0 ** 2
  t55 = t40 ** 2
  t65 = lax_cond(r0 <= p.dens_threshold, 0, 0.3e1 / 0.2e2 * t6 * t29 * t31 * (0.1e1 / t49 + 0.5e1 / 0.72e2 * t53 * s0 / t55 / t54))
  t67 = lax_cond(t11, t16, -t18)
  t68 = lax_cond(t15, t12, t67)
  t69 = 0.1e1 + t68
  t71 = jnp.cbrt(t69)
  t72 = t71 ** 2
  t74 = lax_cond(t69 <= p.zeta_threshold, t25, t72 * t69)
  t76 = jnp.sqrt(s2)
  t77 = jnp.cbrt(r1)
  t82 = t38 * t76 / t77 / r1 / 0.12e2
  t84 = lax_cond(t82 < 0.2e3, t82, 200)
  t86 = jnp.cosh(params.a * t84)
  t88 = r1 ** 2
  t89 = t77 ** 2
  t99 = lax_cond(r1 <= p.dens_threshold, 0, 0.3e1 / 0.2e2 * t6 * t74 * t31 * (0.1e1 / t86 + 0.5e1 / 0.72e2 * t53 * s2 / t89 / t88))
  res = t65 + t99
  return res
...
def unpol(p, r, s=None, l=None, tau=None):
  ...
  t40 = lax_cond(t38 < 0.2e3, t38, 200)
  t42 = jnp.cosh(params.a * t40)
  t44 = t28 ** 2
  t47 = t32 ** 2
  t49 = r0 ** 2
  t59 = lax_cond(r0 / 0.2e1 <= p.dens_threshold, 0, 0.3e1 / 0.2e2 * t4 * t5 * jnp.pi * t21 * t23 * (0.1e1 / t42 + 0.5e1 / 0.72e2 * t25 / t44 * s0 * t47 / t23 / t49))
  res = 0.2e1 * t59
  return res
