...
def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  ...
  t81 = lax_cond(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * ((0.1e1 + 0.39310185185185185185e-2 * t41) / (0.1e1 + t53) + 0.9453125e-5 * t48 * t51 * t70 / (0.115e1 + t53)))
  ...
  t131 = lax_cond(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t89 * t27 * ((0.1e1 + 0.39310185185185185185e-2 * t97) / (0.1e1 + t107) + 0.9453125e-5 * t102 * t105 * t120 / (0.115e1 + t107)))
  res = t81 + t131
  return res
...
def unpol(p, r, s=None, l=None, tau=None):
  ...
  t76 = lax_cond(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * ((0.1e1 + 0.39310185185185185185e-2 * t35) / (0.1e1 + t47) + 0.378125e-4 * t42 * t45 * t65 / (0.115e1 + t47)))
  res = 0.2e1 * t76
  return res
