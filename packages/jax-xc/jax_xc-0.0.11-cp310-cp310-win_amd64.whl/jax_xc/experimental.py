...
def mgga_x_scanl(
  ...
  *,
  ...
  Mixing of the following functionals:
    ...
    mgga_k_pc07_opt (coefficient: 1.19822100196e-311)
  Parameters
  ----------
  rho: the density function
  _c1 : Optional[float], default: 0.667
...
def mgga_c_scanl(
  ...
  *,
  ...
  Mixing of the following functionals:
    mgga_c_scan (coefficient: 1.198166730295e-311)
    mgga_k_pc07_opt (coefficient: 1.1981667323505e-311)
  Parameters
  ----------
  rho: the density function
  _a : Optional[float], default: 1.78472
