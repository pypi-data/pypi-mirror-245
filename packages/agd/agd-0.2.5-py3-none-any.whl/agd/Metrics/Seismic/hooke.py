...
class Hooke(ImplicitBase):
	...
	def _vdim(hdim):
		...
		if Hooke._hdim(vdim)!=hdim:
			raise ValueError("Hooke tensor has inconsistent dimensions.")
		return vdim
	...
	def from_VTI_2(cls,Vp,Vs,eps,delta):
		...
		return cls.from_hexagonal(c11,None,c13,c33,c44,vdim=2)
	...
	def from_hexagonal(cls,c11,c12,c13,c33,c44,vdim=3):
		if vdim==2:
			z = 0*c11
			return cls(ad.asarray( [ [c11,c13,z], [c13,c33,z], [z,z,c44] ] ))
		c66 = (c11-c12)/2.
