...
color:        str = 'Please use: notepads.download("color")'
try:
    from .color import NotepadsColor
    color = NotepadsColor()
...
def note(name: str, content: str, *, author: str=None, **kwargs) -> Note:
    new_note = NotepadsNote(name, content, author=author)
    for key, value in kwargs.items():
        try: setattr(new_note, key, value)
        except: pass
