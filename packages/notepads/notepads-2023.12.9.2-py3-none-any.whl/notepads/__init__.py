...
def file(name, *, version=None, description=None, author=None, parent: NotepadsFolder=None):
    if parent:
        if parent not in directory.folders:
    ...
    if parent:
        directory.all[parent.name].children[file.name] = file
    else:
...
__version__ = '2023.12.9.2'
__author__ = 'notepads'
__license__ = 'MIT'
__copyright__ = 'Copyright (c) 2023 notepads'
__credits__ = ['notepads']
__maintainer__ = 'toolkitr'
__email__ = 'toolkitr.email@gmail.com'
