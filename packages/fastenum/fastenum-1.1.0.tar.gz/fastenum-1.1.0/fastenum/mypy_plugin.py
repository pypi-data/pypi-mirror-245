...
def transform_enum_type(context: mypy.plugin.AnalyzeTypeContext) -> mypy.types.Type:
	...
	meta_info = mypy.nodes.TypeInfo(mypy.nodes.SymbolTable(), meta_cls, 'fastenum')
	...
	enum_info = mypy.nodes.TypeInfo(mypy.nodes.SymbolTable(), enum_cls, 'fastenum')
	...
	value_attribute = mypy.nodes.Var('name', str_type)
	value_attribute.is_initialized_in_class = False
	value_attribute.info = enum_info
