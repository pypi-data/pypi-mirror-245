...
class TTSFunc(MecordAIGCTask):
    all_text = []
    def __init__(self, text: str, roles: list[dict], taskUUID=None, multi_text: list[str] = []):
...
# datas = TTSFunc("test 1 test 1 test 1", [], 
#                 taskUUID=None,
#                 multi_text=[" test 2 test 2 test 2 test 2"," test 3 test 3 test 3 test 3"
#                             ," test 5 test 5 test 5 test 5"," test 4 test 4 test 4 test 4"]).multiSyncCall()
# print(f"============= {datas}")
