 ...
 */
UTBOOST_EXPORT int UTB_ParseLibsvm(const char* filename,
                                     int32_t label_idx,
 ...
 */
UTBOOST_EXPORT int UTB_MoveLibsvm(ParserHandle handle,
                                    int32_t max_idx,
                                    void* features,
                                    void* labels,
                                    void* treatments);
 ...
 */
UTBOOST_EXPORT int UTB_FreeParser(ParserHandle handle);
 ...
 */
UTBOOST_EXPORT int UTB_DatasetSetMeta(DatasetHandle handle,
                                        const char* name,
                                        const void* data1d,
                                        data_size_t num_row,
                                        const char* params);
 ...
 */
UTBOOST_EXPORT int UTB_CreateDataset(const void* data2d,
                                       data_size_t num_row,
                                       int32_t num_col,
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_DatasetDumpMapper(DatasetHandle handle,
                                           const char* filename);
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_DatasetFree(DatasetHandle handle);
 ...
 * \return An integer indicating the success or failure of the operation.
 */
UTBOOST_EXPORT int UTB_CreateBooster(DatasetHandle train_data,
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterFree(BoosterHandle handle);
 ...
 * \return An integer indicating the success or failure of the operation.
 */
UTBOOST_EXPORT int UTB_BoosterUpdateOneIter(BoosterHandle handle, int* is_finished);
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterRollbackOneIter(BoosterHandle handle);
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterGetEval(BoosterHandle handle,
                                        int data_idx,
                                        int* out_len,
                                        double* out_results);
 ...
 * \return An integer indicating the success or failure of the operation.
 */
UTBOOST_EXPORT int UTB_BoosterPredictForMat(BoosterHandle handle,
                                              const void* data2d,
                                              int32_t nrow,
                                              int32_t ncol,
                                              int start_iteration,
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterSaveModel(BoosterHandle handle,
                                          int start_iteration,
                                          int num_iteration,
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterDumpModel(BoosterHandle handle,
                                          int start_iteration,
                                          int num_iteration,
                                          int64_t buffer_len,
                                          int64_t* out_len,
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterDumpModelToFile(BoosterHandle handle,
                                                int start_iteration,
                                                int num_iteration,
                                                const char* filename);
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterCreateFromModelfile(const char* filename,
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterAddValidData(BoosterHandle handle,
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterFeatureImportance(BoosterHandle handle,
                                                  int num_iteration,
                                                  int importance_type,
                                                  double* out_results);
 ...
 * \return 0 when succeed, -1 when failure happens
 */
UTBOOST_EXPORT int UTB_BoosterGetNumFeature(BoosterHandle handle, int* out_len);

/*!
 * \brief Get string message of the last error.
 * \return Error information
 */
UTBOOST_EXPORT const char* UTB_GetLastError();
