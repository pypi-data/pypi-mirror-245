...
from ...packer.chart.FinancialGraphParamDataPacker import FinancialGraphParamDataPacker


class FinancialGraphParamData(IData):
    def __init__(self, id: str = '', name: str = '', style: int = 0,
                 asccolor: str = 'red', ascbrush: str = 'black', desccolor: str = 'cyan',
                 descbrush: str = 'cyan', plotindex: int = 0, valueaxisid: int = -1,
                 pricetick: float = -1.0, tickvalidmul: float = -1.0, showlegend: bool = True,
                 legendformat: str = '', legendcolor: str = 'white', bindinsid: str = '', bindrange: str = '', joinvalueaxis=True,
        ...
        self._AscColor: str = asccolor
        self._AscBrush: str = ascbrush
        self._DescColor: str = desccolor
        self._DescBrush: str = descbrush
