...
class Route(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audience_id", b"audience_id", "environment_id", b"environment_id", "model_id", b"model_id", "shadow", b"shadow", "variation_name", b"variation_name", "weight", b"weight"]) -> None: ...
