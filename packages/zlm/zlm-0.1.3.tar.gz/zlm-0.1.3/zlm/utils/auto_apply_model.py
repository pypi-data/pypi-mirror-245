...
class AutoApplyModel:
    ...
    def get_resume_to_json(self, pdf_path):
        system_prompt = self.get_system_prompt("zlm/prompts/resume-extractor.txt")
    ...
    def job_details_extraction(self, url: str):
        ...
        system_prompt = self.get_system_prompt("zlm/prompts/persona-job-llm.txt") + \
                        self.get_system_prompt("zlm/prompts/extract-job-detail.txt")
    ...
    def resume_builder(self, job_details: dict, user_data: dict):
        system_prompt = self.get_system_prompt("zlm/prompts/persona-job-llm.txt") + \
                        self.get_system_prompt("zlm/prompts/generate-resume-details.txt")
    ...
    def cover_letter_generator(self, job_details: dict, user_data: dict):
        system_prompt = self.get_system_prompt("zlm/prompts/persona-job-llm.txt") + \
                        self.get_system_prompt("zlm/prompts/generate-cover-letter.txt")
