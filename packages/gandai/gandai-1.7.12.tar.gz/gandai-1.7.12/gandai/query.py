...
def important_targets_from_event(event: ts.models.Event):
                ...
                if stage_dict.get(domain) is not None:
                    comment = ts.models.Event(
                        ...
                        data={
                            ...
                            "comment": f"imported {domain}. Was in stage: {stage_dict.get(domain, 'Unknown')}",
                        },
                    )
