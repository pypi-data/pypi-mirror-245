...
class ROISelector():
    ...
    :param Tuple[int, int, int] clr: BGR color tuple for visualizing the ROI.
...
#img_selector = ROISelector(path='/Users/simon/Desktop/envs/troubleshooting/ARES_data/Termite Test 1/Termite Test 1.mp4', clr=(0, 255, 0), thickness=2)
#img_selector.run()
