...
from typing_validation.validation import (_pseudotypes, _pseudotypes_dict,
...
_all_types = _basic_types + list(
    _pseudotypes
)  # TODO: make this deterministic by picking a fixed order for pseudotypes
...
_union_cases = (
    ...
    (
        ...
        [
            ...
            typing.Union[int, str],
            typing.Optional[str],
            typing.Union[int, Literal["hello"]],
        ],
    ),
)
