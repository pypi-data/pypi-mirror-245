...
from ..detection.pytorch_models import torch_cnn_model
...
class UiWindow(QWidget):
    ...
    def initialize_gui(self) -> None:
        ...
        normalised_trace_toggle_label = QLabel("Show normalized trace")
        settingsrow.addWidget(normalised_trace_toggle_label)
        self.normalized_trace_toggle = AnimatedToggle(
            checked_color="#d8e2dc", pulse_checked_color="#f4acb7"
        )
