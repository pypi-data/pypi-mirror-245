...
class ModelZoo:
    ...
    def __init__(self, modelzoo_path: str):
        ...
        self.github_api_url = f"https://api.github.com/repos/s-weissbach/synapse_selector_modelzoo/contents/{self.models_folder}"
        # find all downloaded models
        self.available_models = {}

        os.makedirs(os.path.dirname(self.modelzoo_path), exist_ok=True)
