...
class ui_window(QWidget):
    def __init__(self, settings):
        ...
        model_weight_path = self.get_model_weight_path()
        self.model = torch_cnn_model(model_weight_path)
        # layout
    ...
    def get_model_weight_path(self) -> str:
        model_weight_path = ""
        first_run = True
        while True:
            if model_weight_path.endswith(".pth") or model_weight_path.endswith(".pt"):
                return model_weight_path
            # give option to abort execution
            elif not first_run:
                response = QMessageBox.question(
                ...
                if response == QMessageBox.StandardButton.No:
                    ...
                    sys.exit()
            model_weight_path = QFileDialog.getOpenFileName(
