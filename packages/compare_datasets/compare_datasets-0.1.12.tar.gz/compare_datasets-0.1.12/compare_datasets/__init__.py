...
class Compare:
    ...
    def __init__ (self, tested, expected, key=None, verbose=False, low_memory=False, strict_schema=False):
        ...
        self.data = PrepareForComparison(tested, expected, key, verbose=verbose, progress_bar=self.progress_bar, low_memory=low_memory, strict_schema=strict_schema)       
