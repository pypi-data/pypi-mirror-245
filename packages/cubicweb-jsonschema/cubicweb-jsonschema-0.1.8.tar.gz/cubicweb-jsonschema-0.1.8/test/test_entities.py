...
class IJSONSchemaETypeAdapterTC(WebCWTC):
...
class IJSONSchemaRelationTargetETypeAdapterTC(WebCWTC):
...
class IJSONSchemaEntityAdapterTC(WebCWTC):
...
class IJSONSchemaRelatedEntityAdapterTC(WebCWTC):
