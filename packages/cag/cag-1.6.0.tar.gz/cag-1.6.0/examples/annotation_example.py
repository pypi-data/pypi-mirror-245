...
class SamplePipeline(Pipeline):
    ...
    def init_and_run(self):
        ...
        self.add_annotation_pipe(
            name="NamedEntityAnnotator", save_output=True, is_spacy=True
        )
        self.add_annotation_pipe(
            name="EmpathAnnotator", save_output=True, is_spacy=True
        )
        self.add_annotation_pipe(
            name="DummyDefaultAnnotator", save_output=False, is_spacy=False
        )
