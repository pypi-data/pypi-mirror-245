...
class MediaType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "subtype", "parameters", "qualityValue", "wildcardType", "wildcardSubtype", "subtypeSuffix", "charset", "concrete", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "subtype", "parameters", "qualityValue", "wildcardType", "wildcardSubtype", "subtypeSuffix", "charset", "concrete", ], str]):
        return super().get_item_oapg(name)
