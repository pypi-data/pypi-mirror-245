...
from arthurai.common.exceptions import UnexpectedValueError, UserValueError, arthur_excepted, MethodNotApplicableError
...
class ThresholdMitigation(object):
    ...
    def _continuous_to_str(self, res: Dict[str, Any]):
        ...
        if start == '(-inf,' and end == 'inf)':
            raise UnexpectedValueError("This continuous sensitive attribute only has a single bucket?")
