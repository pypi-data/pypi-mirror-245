...
PG_KEYWORD("fortress", FORTRESS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("login", LOGIN, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("merge", MERGE_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("nologin", NOLOGIN, TYPE_FUNC_NAME_KEYWORD)
PG_KEYWORD("none", NONE, COL_NAME_KEYWORD)
PG_KEYWORD("nosuperuser", NOSUPERUSER, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("push", PUSH_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("remote", REMOTE, UNRESERVED_KEYWORD)
PG_KEYWORD("remote_merge_path", REMOTE_MERGE_PATH, UNRESERVED_KEYWORD)
...
PG_KEYWORD("superuser", SUPERUSER, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("tag", TAG, UNRESERVED_KEYWORD)
