...
private:
	...
	unique_ptr<CatalogEntry> AddTag(ClientContext &context, AddColumnTagInfo &info);
	unique_ptr<CatalogEntry> RemoveTag(ClientContext &context, RemoveColumnTagInfo &info);
	unique_ptr<CatalogEntry> ModifyPartionKeys(ClientContext &context, AlterPartitionKeyInfo &info);
