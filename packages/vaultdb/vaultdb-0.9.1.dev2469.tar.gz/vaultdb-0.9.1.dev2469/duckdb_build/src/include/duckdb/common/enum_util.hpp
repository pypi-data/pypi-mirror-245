...
enum class AlterFortressType : uint8_t; //!vaultDB

enum class AlterRoleType : uint8_t; //!vaultDB
...
template<>
const char* EnumUtil::ToChars<AlterRoleType>(AlterRoleType value);

template<>
const char* EnumUtil::ToChars<AlterFortressType>(AlterFortressType value);
...
template<>
AlterFortressType EnumUtil::FromString<AlterFortressType>(const char *value);

template<>
AlterRoleType EnumUtil::FromString<AlterRoleType>(const char *value);
