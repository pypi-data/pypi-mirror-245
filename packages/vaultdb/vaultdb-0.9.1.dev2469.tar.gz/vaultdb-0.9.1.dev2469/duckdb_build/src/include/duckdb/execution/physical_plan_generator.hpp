...
protected:
	...
	unique_ptr<PhysicalOperator> CreatePlan(LogicalMerge &op); //! vaultDB
...
private:
	...
	unique_ptr<TableFilterSet> CreateTableFilterSet(TableFilterSet &table_filters,
	                                                vector<column_t> &column_ids); //! vaultDB
