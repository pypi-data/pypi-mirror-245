...
private:
	explicit AddColumnInfo(ColumnDefinition new_column_p);
};

//===--------------------------------------------------------------------===//
// AlterPartitionKeyInfo
//===--------------------------------------------------------------------===//
struct AlterPartitionKeyInfo : public AlterTableInfo {
	AlterPartitionKeyInfo(AlterEntryData data, vector<string> partition_key_columns);
	~AlterPartitionKeyInfo() override;
...
private:
	explicit AlterPartitionKeyInfo();
};

//===--------------------------------------------------------------------===//
// AddColumnTagInfo
//===--------------------------------------------------------------------===//
struct AddColumnTagInfo : public AlterTableInfo {
	AddColumnTagInfo(AlterEntryData data, string column_name, string tag_name);
	~AddColumnTagInfo() override;
...
private:
	explicit AddColumnTagInfo();
};

//===--------------------------------------------------------------------===//
// RemoveColumnTagInfo
//===--------------------------------------------------------------------===//
struct RemoveColumnTagInfo : public AlterTableInfo {
	RemoveColumnTagInfo(AlterEntryData data, string column_name, string tag_name);
	~RemoveColumnTagInfo() override;
