...
public:
	...
	explicit Transformer(ClientContext &context, ParserOptions &options);
	explicit Transformer(ClientContext &context, Transformer &parent);
	~Transformer();
...
private:
	...
	static unique_ptr<ParsedExpression> ComplementWhereClause(ParsedExpression &expr);
...
private:
	...
	//! Transform a Postgres duckdb_libpgquery::T_PGCreateRoleStmt node into CreateStatement
	unique_ptr<CreateStatement> TransformCreateRole(duckdb_libpgquery::PGCreateRoleStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGCreateTagStmt node into CreateStatement
	unique_ptr<CreateStatement> TransformCreateTag(duckdb_libpgquery::PGCreateTagStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGCreateConfigStmt node into CreateStatement
	unique_ptr<CreateStatement> TransformCreateConfig(duckdb_libpgquery::PGCreateConfigStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGCreateFortressStmt node into CreateStatement
	unique_ptr<CreateStatement> TransformCreateFortress(duckdb_libpgquery::PGCreateFortressStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGAlterFortressStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformAlterFortress(duckdb_libpgquery::PGAlterFortressStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGLockFortressStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformLockFortress(duckdb_libpgquery::PGLockFortressStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGUnLockFortressStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformUnlockFortress(duckdb_libpgquery::PGUnLockFortressStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGGrantStmt or T_PGRevokeStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformPrivilege(AlterRoleType type, duckdb_libpgquery::PGGrantStmt &stmt);
	//! Transform a Postgres duckdb_libpgquery::T_PGAlterRoleStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformAlterRole(duckdb_libpgquery::PGAlterRoleStmt &stmt);
...
private:
	...
	duckdb_libpgquery::PGNodeTag current_statement_type;
