...
struct CurrentRoleFun {
	static constexpr const char *Name = "vaultdb_role";
	static constexpr const char *Parameters = "";
	static constexpr const char *Description = "Return the logged on role name.";
	static constexpr const char *Example = "vaultdb_role()";
