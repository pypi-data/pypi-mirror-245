...
public:
	...
	DUCKDB_API static string SanitizeIdentifier(const string &str);
	...
	DUCKDB_API static string ReplaceIgnoreCase(string source, const string &from, const string &to);
