...
struct CreateFortressInfo;
struct CreateTagInfo;
struct CreateConfigInfo;
...
public:
	...
	//! Creates a role in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateRole(CatalogTransaction transaction, CreateRoleInfo &info);
	DUCKDB_API optional_ptr<CatalogEntry> CreateRole(ClientContext &context, CreateRoleInfo &info);
	//! Creates a Tag in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateTag(CatalogTransaction transaction, CreateTagInfo &info);
	DUCKDB_API optional_ptr<CatalogEntry> CreateTag(ClientContext &context, CreateTagInfo &info);
	//! Creates a Config in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateConfig(CatalogTransaction transaction, CreateConfigInfo &info);
	DUCKDB_API optional_ptr<CatalogEntry> CreateConfig(ClientContext &context, CreateConfigInfo &info);
	//! Creates a Fortress in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateFortress(CatalogTransaction transaction, CreateFortressInfo &info);
	DUCKDB_API optional_ptr<CatalogEntry> CreateFortress(ClientContext &context, CreateFortressInfo &info);
	...
	//! Creates a role in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateRole(CatalogTransaction transaction, SchemaCatalogEntry &schema,
	                                                 CreateRoleInfo &info);
	//! Creates a Tag in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateTag(CatalogTransaction transaction, SchemaCatalogEntry &schema,
	                                                CreateTagInfo &info);
	//! Creates a Config in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateConfig(CatalogTransaction transaction, SchemaCatalogEntry &schema,
	                                                CreateConfigInfo &info);
	//! Creates a Fortress in the catalog.
	DUCKDB_API optional_ptr<CatalogEntry> CreateFortress(CatalogTransaction transaction, SchemaCatalogEntry &schema,
