...
private:
	...
	//! The catalog set holding the roles
	CatalogSet roles;
	//! The catalog set holding the tags
	CatalogSet tags;
	//! The catalog set holding the configs
	CatalogSet configs;
	//! The catalog set holding the fortresses
	CatalogSet fortresses;
...
public:
	...
	//!vaultdb
	optional_ptr<CatalogEntry> CreateRole(CatalogTransaction transaction, CreateRoleInfo &info) override;
	optional_ptr<CatalogEntry> CreateTag(CatalogTransaction transaction, CreateTagInfo &info) override;
	optional_ptr<CatalogEntry> CreateConfig(CatalogTransaction transaction, CreateConfigInfo &info) override;
	optional_ptr<CatalogEntry> CreateFortress(CatalogTransaction transaction, CreateFortressInfo &info) override;
