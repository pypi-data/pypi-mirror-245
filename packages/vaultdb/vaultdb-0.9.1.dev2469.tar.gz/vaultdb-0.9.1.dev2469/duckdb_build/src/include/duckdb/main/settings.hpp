...
struct RemoteDataPathSetting {
	static constexpr const char *Name = "remote";
	static constexpr const char *Description = "remote data path to inherit data from (e.g. /efs/parquet)";
	static constexpr const LogicalTypeId InputType = LogicalTypeId::VARCHAR;
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(ClientContext &context);
...
struct DataBranchNameSetting {
	static constexpr const char *Name = "branch";
	static constexpr const char *Description = "Data Branch or Session name";
	static constexpr const LogicalTypeId InputType = LogicalTypeId::VARCHAR;
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(ClientContext &context);
...
struct RemoteDataMergePathSetting {
	static constexpr const char *Name = "remote_merge_path";
	static constexpr const char *Description = "remote data merge queue path to merge data with centralized remote location";
	static constexpr const LogicalTypeId InputType = LogicalTypeId::VARCHAR;
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(ClientContext &context);
...
struct RoleSetting {
	...
	static constexpr const char *Description =
	    "Sets the default role. Equivalent to setting role to a single value.";
	static constexpr const LogicalTypeId InputType = LogicalTypeId::VARCHAR;
	static void SetLocal(ClientContext &context, const Value &parameter);
	static void ResetLocal(ClientContext &context);
	static Value GetSetting(ClientContext &context);
