...
protected:
	...
	virtual void WriteRole(RoleCatalogEntry &table, Serializer &serializer);
	virtual void WriteTag(TagCatalogEntry &table, Serializer &serializer);
	virtual void WriteConfig(ConfigCatalogEntry &table, Serializer &serializer);
	virtual void WriteFortress(FortressCatalogEntry &table, Serializer &serializer);
...
protected:
	...
	virtual void ReadRole(ClientContext &context, Deserializer &deserializer);
	virtual void ReadTag(ClientContext &context, Deserializer &deserializer);
	virtual void ReadConfig(ClientContext &context, Deserializer &deserializer);
	virtual void ReadFortress(ClientContext &context, Deserializer &deserializer);
