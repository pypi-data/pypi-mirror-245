...
protected:
	...
	void ReplayCreateRole(BinaryDeserializer &deserializer);
	void ReplayDropRole(BinaryDeserializer &deserializer);
	void ReplayCreateTag(BinaryDeserializer &deserializer);
	void ReplayDropTag(BinaryDeserializer &deserializer);
	void ReplayCreateConfig(BinaryDeserializer &deserializer);
	void ReplayCreateFortress(BinaryDeserializer &deserializer);
	void ReplayDropFortress(BinaryDeserializer &deserializer);
};
...
public:
	...
	//!Vaultdb
	void WriteCreateRole(const RoleCatalogEntry &entry);
	void WriteDropRole(const RoleCatalogEntry &entry);

	void WriteCreateTag(const TagCatalogEntry &entry);
	void WriteCreateConfig(const ConfigCatalogEntry &entry);
	void WriteDropTag(const TagCatalogEntry &entry);

	void WriteCreateFortress(const FortressCatalogEntry &entry);
	void WriteDropFortress(const FortressCatalogEntry &entry);
	//!Vaultdb --END
