...
public:
	...
	//! VaultDB
	//#####################################################################################################
	//! Creates a role with the given name in the schema
	virtual optional_ptr<CatalogEntry> CreateRole(CatalogTransaction transaction, CreateRoleInfo &info) {
		throw NotImplementedException("CreateRole not implemented in this");
	}
	//! Creates a tag with the given name in the schema
	virtual optional_ptr<CatalogEntry> CreateTag(CatalogTransaction transaction, CreateTagInfo &info) {
		throw NotImplementedException("CreateTag not implemented in this");
	}
	//! Creates a config with the given name in the schema
	virtual optional_ptr<CatalogEntry> CreateConfig(CatalogTransaction transaction, CreateConfigInfo &info) {
		throw NotImplementedException("CreateConfig not implemented in this");
	}
	//! Creates a Fortress with the given name in the schema
	virtual optional_ptr<CatalogEntry> CreateFortress(CatalogTransaction transaction, CreateFortressInfo &info) {
		throw NotImplementedException("CreateFortress not implemented in this");
	}
	//#####################################################################################################
	//! VaultDB -- End
	//#####################################################################################################
