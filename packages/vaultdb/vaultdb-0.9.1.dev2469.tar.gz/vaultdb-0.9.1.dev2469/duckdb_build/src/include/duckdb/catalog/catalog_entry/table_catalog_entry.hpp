...
struct AddColumnTagInfo;
struct RemoveColumnTagInfo;
struct SetDefaultInfo;
struct ChangeColumnTypeInfo;
struct AlterForeignKeyInfo;
struct AlterPartitionKeyInfo;
...
public:
	...
	vector<unique_ptr<BoundConstraint>> fortress_constraints;
...
public:
	...
	//! VAULTDB: Get remote Path
	virtual string GetRemotePath(ClientContext &context, bool filename = false);

	//! get Primary Keys column indexes
	vector<column_t> GetPrimaryKeyColumnIndex();
