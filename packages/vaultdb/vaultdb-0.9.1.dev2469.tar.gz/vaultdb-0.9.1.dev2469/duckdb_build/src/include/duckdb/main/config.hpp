...
struct DBConfigOptions {	
	...
	string data_inheritance_path = string();
	//! Data Push Path for eventual merge into centralized source
	string data_merge_queue_path = string();
	//! Data Push Path for eventual merge into centralized source
	string branch_name = "master";
	//! External Data files Path
	string push_folder = "merge_queue";
