...
void BuiltinFunctions::RegisterSQLiteFunctions() {
	...
	VaultDBTagsFun::RegisterFunction(*this);
	VaultDBConfigsFun::RegisterFunction(*this);
	VaultDBFortsFun::RegisterFunction(*this);
	VaultDBRolesFun::RegisterFunction(*this);
	VaultDBPrivilegesFun::RegisterFunction(*this);
