...
unique_ptr<AlterInfo> AlterTableInfo::Deserialize(Deserializer &deserializer) {
	...
	case AlterTableType::ALTER_PARTITION_KEY:
		result = AlterPartitionKeyInfo::Deserialize(deserializer);
		break;
	case AlterTableType::ADD_TAG:
		result = AddColumnTagInfo::Deserialize(deserializer);
		break;
	case AlterTableType::REMOVE_TAG:
		result = RemoveColumnTagInfo::Deserialize(deserializer);
		break;
...
//!vaultDB
void AlterPartitionKeyInfo::Serialize(Serializer &serializer) const {
	AlterTableInfo::Serialize(serializer);
	serializer.WriteProperty(400, "partition_key_columns", partition_key_columns);
}

unique_ptr<AlterTableInfo> AlterPartitionKeyInfo::Deserialize(Deserializer &deserializer) {
	auto result = duckdb::unique_ptr<AlterPartitionKeyInfo>(new AlterPartitionKeyInfo());
	deserializer.ReadProperty(400, "partition_key_columns", result->partition_key_columns);
	return std::move(result);
}

void AddColumnTagInfo::Serialize(Serializer &serializer) const {
	AlterTableInfo::Serialize(serializer);
	serializer.WriteProperty(400, "column_name", column_name);
	serializer.WriteProperty(401, "tag_name", tag_name);
}

unique_ptr<AlterTableInfo> AddColumnTagInfo::Deserialize(Deserializer &deserializer) {
	auto result = duckdb::unique_ptr<AddColumnTagInfo>(new AddColumnTagInfo());
	deserializer.ReadProperty(400, "column_name", result->column_name);
	deserializer.ReadProperty(400, "tag_name", result->tag_name);
	return std::move(result);
}

void RemoveColumnTagInfo::Serialize(Serializer &serializer) const {
	AlterTableInfo::Serialize(serializer);
	serializer.WriteProperty(400, "column_name", column_name);
	serializer.WriteProperty(401, "tag_name", tag_name);
}

unique_ptr<AlterTableInfo> RemoveColumnTagInfo::Deserialize(Deserializer &deserializer) {
	auto result = duckdb::unique_ptr<RemoveColumnTagInfo>(new RemoveColumnTagInfo());
	deserializer.ReadProperty(400, "column_name", result->column_name);
	deserializer.ReadProperty(400, "tag_name", result->tag_name);
	return std::move(result);
}
...
void AlterRoleInfo::Serialize(Serializer &serializer) const {
	AlterInfo::Serialize(serializer);
	serializer.WriteProperty(300, "alter_role_type", alter_role_type);
}

unique_ptr<AlterRoleInfo> AlterRoleInfo::Deserialize(Deserializer &deserializer) {
	auto alter_role_type = deserializer.ReadProperty<AlterRoleType>(300, "alter_role_type");
	unique_ptr<AlterRoleInfo> result;
	switch (alter_role_type) {
	case AlterRoleType::LOGIN_CHANGE:
	case AlterRoleType::SUPERUSER_CHANGE:
		result = ModifyRoleFlagInfo::Deserialize(deserializer, alter_role_type);
		break;
	case AlterRoleType::GRANT_PRIVILEGES:
	case AlterRoleType::REVOKE_PRIVILEGES:
		result = ModifyRolePrivilegeInfo::Deserialize(deserializer, alter_role_type);
		break;
	default:
		throw SerializationException("Unsupported type for deserialization of AlterRoleInfo!");
	}
	return result;
}

void ModifyRoleFlagInfo::Serialize(Serializer &serializer) const {
	AlterRoleInfo::Serialize(serializer);
	serializer.WriteProperty(400, "flag", flag);
}

unique_ptr<AlterRoleInfo> ModifyRoleFlagInfo::Deserialize(Deserializer &deserializer, AlterRoleType alter_role_type) {
	auto result = duckdb::unique_ptr<ModifyRoleFlagInfo>(new ModifyRoleFlagInfo(alter_role_type));
	deserializer.ReadProperty(400, "flag", result->flag);
	return std::move(result);
}

void ModifyRolePrivilegeInfo::Serialize(Serializer &serializer) const {
	AlterRoleInfo::Serialize(serializer);
	serializer.WriteProperty(400, "resourcetype", resourcetype);
	serializer.WriteProperty(401, "resourcename", resourcename);
	serializer.WriteProperty(402, "privileges", privileges);
	serializer.WriteProperty(403, "modifygrantOption", modifygrantOption);
}

unique_ptr<AlterRoleInfo> ModifyRolePrivilegeInfo::Deserialize(Deserializer &deserializer, AlterRoleType alter_role_type) {
	auto result = duckdb::unique_ptr<ModifyRolePrivilegeInfo>(new ModifyRolePrivilegeInfo(alter_role_type));
	deserializer.ReadProperty(400, "resourcetype", result->resourcetype);
	deserializer.ReadProperty(401, "resourcename", result->resourcename);
	deserializer.ReadProperty(402, "privileges", result->privileges);
	deserializer.ReadProperty(403, "modifygrantOption", result->modifygrantOption);
	return std::move(result);
}

void AlterFortressInfo::Serialize(Serializer &serializer) const {
	AlterInfo::Serialize(serializer);
	serializer.WriteProperty(300, "alter_fortress_type", alter_fortress_type);
}

unique_ptr<AlterFortressInfo> AlterFortressInfo::Deserialize(Deserializer &deserializer) {
	auto alter_fortress_type = deserializer.ReadProperty<AlterFortressType>(300, "alter_fortress_type");
	unique_ptr<AlterFortressInfo> result;
	switch (alter_fortress_type) {
	case AlterFortressType::FORTRESS_CHANGE:
		result = ModifyFortressInfo::Deserialize(deserializer);
		break;
	case AlterFortressType::LOCK_CHANGE:
		result = LockFortressInfo::Deserialize(deserializer);
		break;
	case AlterFortressType::UNLOCK_CHANGE:
		result = UnlockFortressInfo::Deserialize(deserializer);
		break;
	default:
		throw SerializationException("Unsupported type for deserialization of alter_fortress_type!");
	}
	return result;
}

void ModifyFortressInfo::Serialize(Serializer &serializer) const {
	AlterFortressInfo::Serialize(serializer);
	serializer.WriteProperty(400, "table", table);
	serializer.WriteProperty(401, "expression", expression);
	serializer.WriteProperty(402, "complement_expression", complement_expression);
}

unique_ptr<AlterFortressInfo> ModifyFortressInfo::Deserialize(Deserializer &deserializer) {
	auto result = duckdb::unique_ptr<ModifyFortressInfo>(new ModifyFortressInfo());
	deserializer.ReadProperty(400, "table", result->table);
	deserializer.ReadProperty(401, "expression", result->expression);
	deserializer.ReadProperty(402, "complement_expression", result->complement_expression);
	return std::move(result);
}

void LockFortressInfo::Serialize(Serializer &serializer) const {
	AlterFortressInfo::Serialize(serializer);
	serializer.WriteProperty(400, "start_date", start_date);
	serializer.WriteProperty(401, "end_date", end_date);
}

unique_ptr<AlterFortressInfo> LockFortressInfo::Deserialize(Deserializer &deserializer) {
	auto result = duckdb::unique_ptr<LockFortressInfo>(new LockFortressInfo());
	deserializer.ReadProperty(400, "start_date", result->start_date);
	deserializer.ReadProperty(400, "end_date", result->end_date);
	return std::move(result);
}

void UnlockFortressInfo::Serialize(Serializer &serializer) const {
	AlterFortressInfo::Serialize(serializer);
	serializer.WriteProperty(400, "for_role", for_role);
}

unique_ptr<AlterFortressInfo> UnlockFortressInfo::Deserialize(Deserializer &deserializer) {
	auto result = duckdb::unique_ptr<UnlockFortressInfo>(new UnlockFortressInfo());
	deserializer.ReadProperty(400, "for_role", result->for_role);
	return std::move(result);
}
//!VaultDB -- End
