...
//===--------------------------------------------------------------------===//
// AlterPartitionKeyInfo
//===--------------------------------------------------------------------===//
AlterPartitionKeyInfo::AlterPartitionKeyInfo() : AlterTableInfo(AlterTableType::ALTER_PARTITION_KEY) {
}

AlterPartitionKeyInfo::AlterPartitionKeyInfo(AlterEntryData data, vector<string> partition_key_columns)
    : AlterTableInfo(AlterTableType::ALTER_PARTITION_KEY, std::move(data)), partition_key_columns(std::move(partition_key_columns)){
}

AlterPartitionKeyInfo::~AlterPartitionKeyInfo() {
}

unique_ptr<AlterInfo> AlterPartitionKeyInfo::Copy() const {
	vector<string> copied_vect;
	for (auto item : partition_key_columns)
        copied_vect.push_back(item);
	return make_uniq_base<AlterInfo, AlterPartitionKeyInfo>(GetAlterEntryData(), copied_vect);
}

//===--------------------------------------------------------------------===//
// AddColumnTagInfo
//===--------------------------------------------------------------------===//
AddColumnTagInfo::AddColumnTagInfo() : AlterTableInfo(AlterTableType::ADD_TAG) {
}

AddColumnTagInfo::AddColumnTagInfo(AlterEntryData data, string column_name, string tag_name)
    : AlterTableInfo(AlterTableType::ADD_TAG, std::move(data)), column_name(std::move(column_name)), tag_name(std::move(tag_name)){
}
AddColumnTagInfo::~AddColumnTagInfo() {
}

unique_ptr<AlterInfo> AddColumnTagInfo::Copy() const {
	return make_uniq_base<AlterInfo, AddColumnTagInfo>(GetAlterEntryData(), column_name, tag_name);
}

//===--------------------------------------------------------------------===//
// RemoveColumnTagInfo
//===--------------------------------------------------------------------===//
RemoveColumnTagInfo::RemoveColumnTagInfo() : AlterTableInfo(AlterTableType::REMOVE_TAG) {
}

RemoveColumnTagInfo::RemoveColumnTagInfo(AlterEntryData data, string column_name, string tag_name)
    : AlterTableInfo(AlterTableType::REMOVE_TAG, std::move(data)), column_name(std::move(column_name)), tag_name(std::move(tag_name)){
}
RemoveColumnTagInfo::~RemoveColumnTagInfo() {
}

unique_ptr<AlterInfo> RemoveColumnTagInfo::Copy() const {
	return make_uniq_base<AlterInfo, RemoveColumnTagInfo>(GetAlterEntryData(), column_name, tag_name);
}
