...
Parser::Parser(ParserOptions options_p) : context(nullptr), options(options_p) {
}

Parser::Parser(ClientContext &context) : context(&context), options(context.GetParserOptions()) {
}

Parser::Parser(ClientContext &context, ParserOptions options_p) : context(&context), options(options_p) {
}
...
void Parser::ParseQuery(const string &query) {
	...
	if(context)
		transformer = make_uniq<Transformer>(*context, options);
	else
		transformer = make_uniq<Transformer>(options);
