...
void CommitState::WriteCatalogEntry(CatalogEntry &entry, data_ptr_t dataptr) {
	...
	case CatalogType::ROLE_ENTRY:
		log->WriteCreateRole(parent->Cast<RoleCatalogEntry>());
		break;
	case CatalogType::TAG_ENTRY:
		log->WriteCreateTag(parent->Cast<TagCatalogEntry>());
		break;
	case CatalogType::CONFIG_ENTRY:
		log->WriteCreateConfig(parent->Cast<ConfigCatalogEntry>());
		break;
	case CatalogType::FORTRESS_ENTRY:
		log->WriteCreateFortress(parent->Cast<FortressCatalogEntry>());
		break;
	...
	case CatalogType::DELETED_ENTRY:
		...
		case CatalogType::SEQUENCE_ENTRY:
			...
			break;
		case CatalogType::ROLE_ENTRY:
			log->WriteDropRole(entry.Cast<RoleCatalogEntry>());
			break;
		case CatalogType::TAG_ENTRY:
			log->WriteDropTag(entry.Cast<TagCatalogEntry>());
			break;
		case CatalogType::FORTRESS_ENTRY:
			log->WriteDropFortress(entry.Cast<FortressCatalogEntry>());
			break;
		case CatalogType::MACRO_ENTRY:
