...
static DefaultView internal_views[] = {
    //!VaultDB
    {DEFAULT_SCHEMA, "vaultdb_roles", "SELECT * FROM vaultdb_roles()"},
    {DEFAULT_SCHEMA, "vaultdb_privileges", "SELECT * FROM vaultdb_privileges()"},
    {DEFAULT_SCHEMA, "vaultdb_tags", "SELECT * FROM vaultdb_tags()"},
    {DEFAULT_SCHEMA, "vaultdb_configs", "SELECT * FROM vaultdb_configs()"},
    {DEFAULT_SCHEMA, "vaultdb_forts", "SELECT * FROM vaultdb_forts()"},
    //!VaultDB
