...
static DefaultMacro internal_macros[] = {
    {DEFAULT_SCHEMA, "current_role", {nullptr}, "vaultdb_role()"},                // user name of current execution context
    {DEFAULT_SCHEMA, "current_user", {nullptr}, "vaultdb_role()"},                // user name of current execution context
	...
	{DEFAULT_SCHEMA, "session_user", {nullptr}, "vaultdb_role()"},                // session user name
