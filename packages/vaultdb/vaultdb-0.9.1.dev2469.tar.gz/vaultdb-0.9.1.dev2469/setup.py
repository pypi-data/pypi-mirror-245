...
setup(
    ...
    keywords = 'VaultDB Database SQL OLAP AI',
    url="http://www.vaultdb.ai",
    long_description = 'See here for an introduction: https://docs.vaultdb.ai/getting-started/gettingstarted',
    license='MIT',
    ...
    maintainer = "vaultdb.ai",
    maintainer_email = "support@vaultdb.ai",
    cmdclass={"build_ext": build_ext},
    project_urls={
        "Documentation": "https://docs.vaultdb.ai",
        "Source": "https://github.com/vaultdbai/vaultdb/blob/master/tools/pythonpkg",
        "Issues": "https://github.com/vaultdbai/vaultdb/issues",
        "Changelog": "https://github.com/vaultdbai/vaultdb/releases",
    },
)
