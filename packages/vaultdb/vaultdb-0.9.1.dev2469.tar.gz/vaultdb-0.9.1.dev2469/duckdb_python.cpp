...
PYBIND11_MODULE(DUCKDB_PYTHON_LIB_NAME, m) { // NOLINT
	...
	m.doc() = "VaultDB is an embeddable SQL OLAP Database Management System";
	m.attr("__package__") = "vaultdb";
	...
	m.def("connect", &DuckDBPyConnection::Connect,
	      ...
	      py::arg("database") = ":memory:", py::arg("read_only") = false, py::arg("role") = "vaultdb",
