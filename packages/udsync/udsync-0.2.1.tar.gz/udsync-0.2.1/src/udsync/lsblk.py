...
class Mounter:
	...
	def is_valid_path(self, path: typing.Union[str, Path], password_entry_context: typing.ContextManager[None]) -> bool:
		try:
...
class Lsblk:
	...
	device_paths_to_be_ignored: typing.ClassVar = Config('devices-to-be-ignored', ['/dev/sda'],
