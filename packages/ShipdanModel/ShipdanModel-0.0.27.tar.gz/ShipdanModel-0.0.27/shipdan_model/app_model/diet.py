...
class DietPlan(models.Model):
    first_day_diet_id = models.IntegerField(help_text='백필용 필드. 배포 후 삭제될 예정', null=True, default=None)
...
class DietPlanFoodEvent(models.Model):
    ...
    backfill_id = models.IntegerField(null=True, default=None, help_text='배포 백필 후 삭제')
