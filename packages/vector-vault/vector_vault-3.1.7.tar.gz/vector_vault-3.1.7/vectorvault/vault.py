                ...
                try:
                    ...
                    if summary and not get_context:
                        ...
                        if include_context_meta:
                            ...
                            input_ = str(context)
                        elif smart_history_search:
                            custom_entry = f"Using the current message, with the message history, summarize the history and current message into a single message that focses on the information the user is focused on. \nCurrent message: {text}. \n\nPrevious Messages: {history}."
