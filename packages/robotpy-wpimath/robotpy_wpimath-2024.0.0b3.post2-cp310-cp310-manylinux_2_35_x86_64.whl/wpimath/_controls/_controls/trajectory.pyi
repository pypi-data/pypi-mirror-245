...
__all__ = ['Trajectory', 'TrajectoryConfig', 'TrajectoryGenerator', 'TrajectoryParameterizer', 'TrajectoryUtil', 'TrapezoidProfile', 'TrapezoidProfileRadians']
class Trajectory:
    """
...
class TrapezoidProfile:
    ...
    def calculate(self, t: wpimath.units.seconds) -> TrapezoidProfile.State:
        ...
        """
    @typing.overload
    def calculate(self, t: wpimath.units.seconds, goal: TrapezoidProfile.State, current: TrapezoidProfile.State) -> TrapezoidProfile.State:
        """
        Calculate the correct position and velocity for the profile at a time t
        where the beginning of the profile was at time t = 0.
...
class TrapezoidProfileRadians:
    ...
    def calculate(self, t: wpimath.units.seconds) -> TrapezoidProfileRadians.State:
        ...
        """
    @typing.overload
    def calculate(self, t: wpimath.units.seconds, goal: TrapezoidProfileRadians.State, current: TrapezoidProfileRadians.State) -> TrapezoidProfileRadians.State:
        """
        Calculate the correct position and velocity for the profile at a time t
        where the beginning of the profile was at time t = 0.
