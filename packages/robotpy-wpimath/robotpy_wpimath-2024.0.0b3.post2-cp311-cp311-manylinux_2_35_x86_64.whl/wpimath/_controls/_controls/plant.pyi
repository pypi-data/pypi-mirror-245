...
class LinearSystemId:
    @staticmethod
    @typing.overload
    def DCMotorSystem(motor: DCMotor, J: wpimath.units.kilogram_square_meters, G: float) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        """
    ...
    def DCMotorSystemRadians(kV: wpimath.units.volt_seconds_per_radian, kA: wpimath.units.volt_seconds_squared_per_radian) -> wpimath._controls._controls.system.LinearSystem_2_1_2:
        ...
    @staticmethod
    def drivetrainVelocitySystem(motor: DCMotor, mass: wpimath.units.kilograms, r: wpimath.units.meters, rb: wpimath.units.meters, J: wpimath.units.kilogram_square_meters, G: float) -> wpimath._controls._controls.system.LinearSystem_2_2_2:
        """
        ...
        """
    @staticmethod
    def elevatorSystem(motor: DCMotor, mass: wpimath.units.kilograms, radius: wpimath.units.meters, G: float) -> wpimath._controls._controls.system.LinearSystem_2_1_1:
        """
        ...
        """
    @staticmethod
    def flywheelSystem(motor: DCMotor, J: wpimath.units.kilogram_square_meters, G: float) -> wpimath._controls._controls.system.LinearSystem_1_1_1:
        """
    ...
    def identifyVelocitySystemRadians(kV: wpimath.units.volt_seconds_per_radian, kA: wpimath.units.volt_seconds_squared_per_radian) -> wpimath._controls._controls.system.LinearSystem_1_1_1:
        ...
    @staticmethod
    def singleJointedArmSystem(motor: DCMotor, J: wpimath.units.kilogram_square_meters, G: float) -> wpimath._controls._controls.system.LinearSystem_2_1_1:
        """
